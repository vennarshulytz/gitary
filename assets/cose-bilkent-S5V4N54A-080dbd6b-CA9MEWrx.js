...
import { $n as require_markdown_it_task_lists, Qn as require_pinyin, er as require_markdown_it_multimd_table, et as R, h as Dv, qt as gt, rt as Rv, un as m, wi as require_classnames } from "./app-DQCpdmdF.js";
		...
		(function(O, T) {
			...
			return function(A) {
				...
				function T(o) {
					...
					return A[o].call(e.exports, e, e.exports, T), e.l = !0, e.exports;
				}
				...
				function(A, O, T) {
					...
					n.prototype.getEdges = function() {
						...
						if (r.add(this), this.child != null) for (var p = this.child.getNodes(), v = 0; v < p.length; v++) h = p[v], a = h.withChildren(), a.forEach(function(m$1) {
							r.add(m$1);
						});
						return r;
						...
						else for (var a = this.child.getNodes(), p = 0; p < a.length; p++) h = a[p], r += h.getNoOfChildren();
						return r == 0 && (r = 1), r;
						...
						var v = -i.INITIAL_WORLD_BOUNDARY, m$1 = i.INITIAL_WORLD_BOUNDARY;
						h = i.WORLD_CENTER_Y + l.nextDouble() * (m$1 - v) + v, this.rect.x = r, this.rect.y = h;
				...
				function(A, O, T) {
					...
					function h(p, v, m$1) {
						o.call(this, m$1), this.estimatedSize = e.MIN_VALUE, this.margin = t.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = !1, this.parent = p, v != null && v instanceof i ? this.graphManager = v : v != null && v instanceof Layout && (this.graphManager = v.graphManager);
					}
					...
					h.prototype.getNodes = function() {
					...
					}, h.prototype.add = function(p, v, m$1) {
						if (v == null && m$1 == null) {
							var u = p;
							...
							var E = p;
							if (!(this.getNodes().indexOf(v) > -1 && this.getNodes().indexOf(m$1) > -1)) throw "Source or target not in graph!";
							if (!(v.owner == m$1.owner && v.owner == this)) throw "Both owners must be this graph!";
							return v.owner != m$1.owner ? null : (E.source = v, E.target = m$1, E.isInterGraph = !1, this.getEdges().push(E), v.edges.push(E), m$1 != v && m$1.edges.push(E), E);
						}
						...
						if (p instanceof l) {
							...
							for (var m$1 = v.edges.slice(), u, E = m$1.length, y = 0; y < E; y++) u = m$1[y], u.isInterGraph ? this.graphManager.remove(u) : u.source.owner.remove(u);
							...
							if (!(u.source.owner != null && u.target.owner != null && u.source.owner == this && u.target.owner == this)) throw "Source and/or target owner is invalid!";
						...
						for (var p = e.MAX_VALUE, v = e.MAX_VALUE, m$1, u, E, y = this.getNodes(), N = y.length, s = 0; s < N; s++) {
							var f = y[s];
							m$1 = f.getTop(), u = f.getLeft(), p > m$1 && (p = m$1), v > u && (v = u);
						}
						...
						for (var v = e.MAX_VALUE, m$1 = -e.MAX_VALUE, u = e.MAX_VALUE, E = -e.MAX_VALUE, y, N, s, f, c, L = this.nodes, D = L.length, I = 0; I < D; I++) {
							var R$1 = L[I];
							p && R$1.child != null && R$1.updateBounds(), y = R$1.getLeft(), N = R$1.getRight(), s = R$1.getTop(), f = R$1.getBottom(), v > y && (v = y), m$1 < N && (m$1 = N), u > s && (u = s), E < f && (E = f);
						}
						var C = new n(v, u, m$1 - v, E - u);
						...
						for (var v = e.MAX_VALUE, m$1 = -e.MAX_VALUE, u = e.MAX_VALUE, E = -e.MAX_VALUE, y, N, s, f, c = p.length, L = 0; L < c; L++) {
							var D = p[L];
							y = D.getLeft(), N = D.getRight(), s = D.getTop(), f = D.getBottom(), v > y && (v = y), m$1 < N && (m$1 = N), u > s && (u = s), E < f && (E = f);
						}
						return new n(v, u, m$1 - v, E - u);
						...
						for (var p = 0, v = this.nodes, m$1 = v.length, u = 0; u < m$1; u++) {
							var E = v[u];
						...
						var v = new r(), m$1 = /* @__PURE__ */ new Set(), u = this.nodes[0], E, y;
						for (u.withChildren().forEach(function(I) {
							v.push(I), m$1.add(I);
						}); v.length !== 0;) {
							u = v.shift(), E = u.getEdges();
							for (var s = E.length, f = 0; f < s; f++) if (y = E[f].getOtherEndInGraph(u, this), y != null && !m$1.has(y)) y.withChildren().forEach(function(I) {
								v.push(I), m$1.add(I);
							});
						}
						if (this.isConnected = !1, m$1.size >= this.nodes.length) {
							var D = 0;
							m$1.forEach(function(I) {
								I.owner == p && D++;
				...
				function(A, O, T) {
					...
					t.prototype.addRoot = function() {
						...
						if (g == null && n == null && d == null) {
							...
							if (g.isInterGraph = !0, g.source = n, g.target = d, this.edges.indexOf(g) > -1) throw "Edge already in inter-graph edge list!";
							if (this.edges.push(g), !(g.source != null && g.target != null)) throw "Edge source and/or target is null!";
							if (!(g.source.edges.indexOf(g) == -1 && g.target.edges.indexOf(g) == -1)) throw "Edge already in source and/or target incidency list!";
						...
						if (i instanceof o) {
							...
							if (!(n.source.edges.indexOf(n) != -1 && n.target.edges.indexOf(n) != -1)) throw "Source and/or target doesn't know this edge!";
							var p = n.source.edges.indexOf(n);
							if (n.source.edges.splice(p, 1), p = n.target.edges.indexOf(n), n.target.edges.splice(p, 1), !(n.source.owner != null && n.source.owner.getGraphManager() != null)) throw "Edge owner graph or owner graph manager is null!";
							if (n.source.owner.getGraphManager().edges.indexOf(n) == -1) throw "Not in owner graph manager's edge list!";
						...
						if (this.allNodes == null) {
							for (var i = [], l = this.getGraphs(), g = l.length, n = 0; n < g; n++) i = i.concat(l[n].getNodes());
							this.allNodes = i;
						}
						...
						for (var i, l, g, n, d, r = this.getAllEdges(), h = r.length, a = 0; a < h; a++) {
							...
							for (n = l.getOwner(); i.lca == null;) {
								...
								i.lca ?? (i.sourceInLca = n.getParent(), n = i.sourceInLca.getOwner());
							}
							if (i.lca == null) throw "assert failed";
						}
						...
						for (var g, n = i.getNodes(), d = n.length, r = 0; r < d; r++) g = n[r], g.inclusionTreeDepth = l, g.child != null && this.calcInclusionTreeDepths(g.child, l + 1);
					}, t.prototype.includesInvalidEdge = function() {
						for (var i, l = this.edges.length, g = 0; g < l; g++) if (i = this.edges[g], this.isOneAncestorOfOther(i.source, i.target)) return !0;
						return !1;
					}, A.exports = t;
				},
				function(A, O, T) {
				...
				function(A, O, T) {
					...
					e.calcSeparationAmount = function(t, i, l, g) {
						...
						var h = t.getX(), a = t.getY(), p = t.getRight(), v = t.getX(), m$1 = t.getBottom(), u = t.getRight(), E = t.getWidthHalf(), y = t.getHeightHalf(), N = i.getX(), s = i.getY(), f = i.getRight(), c = i.getX(), L = i.getBottom(), D = i.getRight(), I = i.getWidthHalf(), R$1 = i.getHeightHalf(), C = !1, M = !1;
						if (g === d) {
							if (n > r) return l[0] = g, l[1] = a, l[2] = d, l[3] = L, !1;
							if (n < r) return l[0] = g, l[1] = m$1, l[2] = d, l[3] = s, !1;
						} else if (n === r) {
							if (g > d) return l[0] = h, l[1] = n, l[2] = f, l[3] = r, !1;
							if (g < d) return l[0] = p, l[1] = n, l[2] = N, l[3] = r, !1;
						} else {
							var S = t.height / t.width, Y = i.height / i.width, w = (r - n) / (d - g), x = void 0, F = void 0, U = void 0, P = void 0, _ = void 0, X = void 0;
							if (-S === w ? g > d ? (l[0] = v, l[1] = m$1, C = !0) : (l[0] = p, l[1] = a, C = !0) : S === w && (g > d ? (l[0] = h, l[1] = a, C = !0) : (l[0] = u, l[1] = m$1, C = !0)), -Y === w ? d > g ? (l[2] = c, l[3] = L, M = !0) : (l[2] = f, l[3] = s, M = !0) : Y === w && (d > g ? (l[2] = N, l[3] = s, M = !0) : (l[2] = D, l[3] = L, M = !0)), C && M) return !1;
							if (g > d ? n > r ? (x = this.getCardinalDirection(S, w, 4), F = this.getCardinalDirection(Y, w, 2)) : (x = this.getCardinalDirection(-S, w, 3), F = this.getCardinalDirection(-Y, w, 1)) : n > r ? (x = this.getCardinalDirection(-S, w, 1), F = this.getCardinalDirection(-Y, w, 3)) : (x = this.getCardinalDirection(S, w, 2), F = this.getCardinalDirection(Y, w, 4)), !C) switch (x) {
								case 1:
							...
							if (!M) switch (F) {
								case 1:
									X = s, _ = d + -R$1 / w, l[2] = _, l[3] = X;
									break;
								case 2:
									_ = D, X = r + I * w, l[2] = _, l[3] = X;
									break;
								case 3:
									X = L, _ = d + R$1 / w, l[2] = _, l[3] = X;
									break;
								case 4:
						...
						var n = t.x, d = t.y, r = i.x, h = i.y, a = l.x, p = l.y, v = g.x, m$1 = g.y, u = void 0, E = void 0, y = void 0, N = void 0, s = void 0, f = void 0, c = void 0, L = void 0, D = void 0;
						return y = h - d, s = n - r, c = r * d - n * h, N = m$1 - p, f = a - v, L = v * p - a * m$1, D = y * f - N * s, D === 0 ? null : (u = (s * L - f * c) / D, E = (N * c - y * L) / D, new o(u, E));
						...
						var n = t.x, d = t.y, r = i.x, h = i.y, a = l.x, p = l.y, v = g.x, m$1 = g.y, u = (r - n) * (m$1 - p) - (v - a) * (h - d);
						if (u === 0) return !1;
						var E = ((m$1 - p) * (v - n) + (a - v) * (m$1 - d)) / u, y = ((d - h) * (v - n) + (r - n) * (m$1 - d)) / u;
						return 0 < E && E < 1 && 0 < y && y < 1;
					}, e.HALF_PI = .5 * Math.PI, e.ONE_AND_HALF_PI = 1.5 * Math.PI, e.TWO_PI = 2 * Math.PI, e.THREE_PI = 3 * Math.PI, A.exports = e;
				},
				function(A, O, T) {
					function o() {}
					o.sign = function(e) {
				...
				function(A, O, T) {
					...
					o.prototype.getX = function() {
						...
						e.constructor.name == "Point" && t == null && i == null ? (i = e, this.setLocation(i.x, i.y)) : typeof e == "number" && typeof t == "number" && i == null && (parseInt(e) == e && parseInt(t) == t ? this.move(e, t) : (this.x = Math.floor(e + .5), this.y = Math.floor(t + .5)));
				...
				function(A, O, T) {
					...
					h.RANDOM_SEED = 1, h.prototype = Object.create(r.prototype), h.prototype.getGraphManager = function() {
						...
						if (a == null) this.update2();
							...
							var p = a;
							if (p.getChild() != null) for (var v = p.getChild().getNodes(), m$1 = 0; m$1 < v.length; m$1++) update(v[m$1]);
							if (p.vGraphObject != null) p.vGraphObject.update(p);
						} else if (a instanceof l) {
							var E = a;
							if (E.vGraphObject != null) E.vGraphObject.update(E);
						} else if (a instanceof g) {
							var N = a;
							if (N.vGraphObject != null) N.vGraphObject.update(N);
						}
						...
						if (a == null) this.transform(new n(0, 0));
							...
							if (v != null) {
								...
								for (var m$1 = this.getAllNodes(), u, E = 0; E < m$1.length; E++) u = m$1[E], u.transform(p);
							}
						}
					}, h.prototype.positionNodesRandomly = function(a) {
						if (a == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(!0);
						else for (var p, v, m$1 = a.getNodes(), u = 0; u < m$1.length; u++) p = m$1[u], v = p.getChild(), v == null || v.getNodes().length == 0 ? p.scatter() : (this.positionNodesRandomly(v), p.updateBounds());
					}, h.prototype.getFlatForest = function() {
						for (var a = [], p = !0, v = this.graphManager.getRoot().getNodes(), m$1 = !0, u = 0; u < v.length; u++) v[u].getChild() != null && (m$1 = !1);
						if (!m$1) return a;
						...
						for (s = s.concat(v); s.length > 0 && p;) {
							for (y.push(s[0]); y.length > 0 && p;) {
								...
								for (var c = f.getEdges(), u = 0; u < c.length; u++) {
									...
									if (N.get(f) != L) if (!E.has(L)) y.push(L), N.set(L, f);
									else {
										p = !1;
										break;
									}
							...
							if (!p) a = [];
								...
								for (var u = 0; u < D.length; u++) {
									var I = D[u], R$1 = s.indexOf(I);
									R$1 > -1 && s.splice(R$1, 1);
								}
						...
						for (var p = [], v = a.source, m$1 = this.graphManager.calcLowestCommonAncestor(a.source, a.target), u = 0; u < a.bendpoints.length; u++) {
							var E = this.newNode(null);
							E.setRect(new Point(0, 0), new Dimension(1, 1)), m$1.add(E);
							var y = this.newEdge(null);
							this.graphManager.add(y, v, E), p.add(E), v = E;
						}
						var y = this.newEdge(null);
						return this.graphManager.add(y, v, a.target), this.edgeToDummyNodes.set(a, p), a.isInterGraph() ? this.graphManager.remove(a) : m$1.remove(a), p;
						...
						for (var p = 0; p < a.length; p++) {
							...
							if (v.bendpoints.length > 0) {
								for (var m$1 = this.edgeToDummyNodes.get(v), u = 0; u < m$1.length; u++) {
									var E = m$1[u], y = new n(E.getCenterX(), E.getCenterY()), N = v.bendpoints.get(u);
									N.x = y.x, N.y = y.y, E.getOwner().remove(E);
								}
								this.graphManager.add(v, v.source, v.target);
							}
						}
					}, h.transform = function(a, p, v, m$1) {
						if (v != null && m$1 != null) {
							var u = p;
							if (a <= 50) {
								var E = p / v;
						...
						var p = [];
						p = p.concat(a);
						var v = [], m$1 = /* @__PURE__ */ new Map(), u = !1, E = null;
						(p.length == 1 || p.length == 2) && (u = !0, E = p[0]);
						for (var y = 0; y < p.length; y++) {
							var N = p[y], s = N.getNeighborsList().size;
							m$1.set(N, N.getNeighborsList().size), s == 1 && v.push(N);
						}
						var f = [];
						for (f = f.concat(v); !u;) {
							var c = [];
							...
							for (var y = 0; y < p.length; y++) {
								...
								L >= 0 && p.splice(L, 1);
								N.getNeighborsList().forEach(function(C) {
									if (v.indexOf(C) < 0) {
										var S = m$1.get(C) - 1;
										S == 1 && f.push(C), m$1.set(C, S);
									}
								});
							}
				...
				function(A, O, T) {
					...
					e.prototype.getWorldOrgX = function() {
						...
						return new o(this.inverseTransformX(t.x), this.inverseTransformY(t.y));
					}, A.exports = e;
				},
				function(A, O, T) {
					function o(r) {
					...
					n.prototype.initParameters = function() {
						...
						for (var r, h, a, p, v, m$1, u = this.getGraphManager().getAllEdges(), E = 0; E < u.length; E++) r = u[E], r.idealLength = this.idealEdgeLength, r.isInterGraph && (a = r.getSource(), p = r.getTarget(), v = r.getSourceInLca().getEstimatedSize(), m$1 = r.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (r.idealLength += v + m$1 - 2 * i.SIMPLE_NODE_SIZE), h = r.getLca().getInclusionTreeDepth(), r.idealLength += t.DEFAULT_EDGE_LENGTH * t.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (a.getInclusionTreeDepth() + p.getInclusionTreeDepth() - 2 * h));
						...
						for (var r = this.getAllEdges(), h, a = 0; a < r.length; a++) h = r[a], this.calcSpringForce(h, h.idealLength);
					}, n.prototype.calcRepulsionForces = function() {
						var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, a, p, v, m$1, u = this.getAllNodes(), E;
						if (this.useFRGridVariant) for (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && r && this.updateGrid(), E = /* @__PURE__ */ new Set(), a = 0; a < u.length; a++) v = u[a], this.calculateRepulsionForceOfANode(v, E, r, h), E.add(v);
						else for (a = 0; a < u.length; a++) for (v = u[a], p = a + 1; p < u.length; p++) m$1 = u[p], v.getOwner() == m$1.getOwner() && this.calcRepulsionForce(v, m$1);
					}, n.prototype.calcGravitationalForces = function() {
						for (var r, h = this.getAllNodesToApplyGravitation(), a = 0; a < h.length; a++) r = h[a], this.calcGravitationalForce(r);
						...
						var a = r.getSource(), p = r.getTarget(), v, m$1, u, E;
						...
						v = r.getLength(), v != 0 && (m$1 = this.springConstant * (v - h), u = m$1 * (r.lengthX / v), E = m$1 * (r.lengthY / v), a.springForceX += u, a.springForceY += E, p.springForceX -= u, p.springForceY -= E);
					}, n.prototype.calcRepulsionForce = function(r, h) {
						var a = r.getRect(), p = h.getRect(), v = new Array(2), m$1 = new Array(4), u, E, y, N, s, f, c;
						if (a.intersects(p)) {
						...
						} else this.uniformLeafNodeSizes && r.getChild() == null && h.getChild() == null ? (u = p.getCenterX() - a.getCenterX(), E = p.getCenterY() - a.getCenterY()) : (l.getIntersection(a, p, m$1), u = m$1[2] - m$1[0], E = m$1[3] - m$1[1]), Math.abs(u) < t.MIN_REPULSION_DIST && (u = g.sign(u) * t.MIN_REPULSION_DIST), Math.abs(E) < t.MIN_REPULSION_DIST && (E = g.sign(E) * t.MIN_REPULSION_DIST), y = u * u + E * E, N = Math.sqrt(y), s = this.repulsionConstant * r.noOfChildren * h.noOfChildren / y, f = s * u / N, c = s * E / N, r.repulsionForceX -= f, r.repulsionForceY -= c, h.repulsionForceX += f, h.repulsionForceY += c;
					}, n.prototype.calcGravitationalForce = function(r) {
						var h = r.getOwner(), a = (h.getRight() + h.getLeft()) / 2, p = (h.getTop() + h.getBottom()) / 2, v = r.getCenterX() - a, m$1 = r.getCenterY() - p, u = Math.abs(v) + r.getWidth() / 2, E = Math.abs(m$1) + r.getHeight() / 2, y;
						r.getOwner() == this.graphManager.getRoot() ? (y = h.getEstimatedSize() * this.gravityRangeFactor, (u > y || E > y) && (r.gravitationForceX = -this.gravityConstant * v, r.gravitationForceY = -this.gravityConstant * m$1)) : (y = h.getEstimatedSize() * this.compoundGravityRangeFactor, (u > y || E > y) && (r.gravitationForceX = -this.gravityConstant * v * this.compoundGravityConstant, r.gravitationForceY = -this.gravityConstant * m$1 * this.compoundGravityConstant));
						...
						for (var r, h = this.graphManager.getAllNodes(), a = 0; a < h.length; a++) r = h[a], r.noOfChildren = r.getNoOfChildren();
						...
						for (var v = 0; v < h; v++) for (var m$1 = 0; m$1 < a; m$1++) p[v][m$1] = new Array();
						return p;
					}, n.prototype.addNodeToGrid = function(r, h, a) {
						var p = 0, v = 0, m$1 = 0, u = 0;
						p = parseInt(Math.floor((r.getRect().x - h) / this.repulsionRange)), v = parseInt(Math.floor((r.getRect().width + r.getRect().x - h) / this.repulsionRange)), m$1 = parseInt(Math.floor((r.getRect().y - a) / this.repulsionRange)), u = parseInt(Math.floor((r.getRect().height + r.getRect().y - a) / this.repulsionRange));
						for (var E = p; E <= v; E++) for (var y = m$1; y <= u; y++) this.grid[E][y].push(r), r.setGridCoordinates(p, v, m$1, u);
					}, n.prototype.updateGrid = function() {
						var r, h, a = this.getAllNodes();
						for (this.grid = this.calcGrid(this.graphManager.getRoot()), r = 0; r < a.length; r++) h = a[r], this.addNodeToGrid(h, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
						...
						if (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && a || p) {
							...
							for (var m$1, u = this.grid, E = r.startX - 1; E < r.finishX + 2; E++) for (var y = r.startY - 1; y < r.finishY + 2; y++) if (!(E < 0 || y < 0 || E >= u.length || y >= u[0].length)) {
								for (var N = 0; N < u[E][y].length; N++) if (m$1 = u[E][y][N], !(r.getOwner() != m$1.getOwner() || r == m$1) && !h.has(m$1) && !v.has(m$1)) {
									var s = Math.abs(r.getCenterX() - m$1.getCenterX()) - (r.getWidth() / 2 + m$1.getWidth() / 2), f = Math.abs(r.getCenterY() - m$1.getCenterY()) - (r.getHeight() / 2 + m$1.getHeight() / 2);
									s <= this.repulsionRange && f <= this.repulsionRange && v.add(m$1);
								}
							}
					...
					A.exports = function() {
						function i(l, g) {
							...
							for (var p = 0; p < this.iMax; p++) {
								...
								for (var v = 0; v < this.jMax; v++) this.tracebackGrid[p][v] = [
									null,
									null,
									null
								];
						...
						return o(i, [
							...
							},
							{
								key: "computeGrids",
								value: function() {
									for (var g = 1; g < this.jMax; g++) this.grid[0][g] = this.grid[0][g - 1] + this.gap_penalty, this.tracebackGrid[0][g] = [
										!1,
										!1,
										!0
									];
									for (var n = 1; n < this.iMax; n++) this.grid[n][0] = this.grid[n - 1][0] + this.gap_penalty, this.tracebackGrid[n][0] = [
										!1,
										!0,
										!1
									];
									for (var d = 1; d < this.iMax; d++) for (var r = 1; r < this.jMax; r++) {
										var h = void 0;
										this.sequence1[d - 1] === this.sequence2[r - 1] ? h = this.grid[d - 1][r - 1] + this.match_score : h = this.grid[d - 1][r - 1] + this.mismatch_penalty;
										var a = this.grid[d - 1][r] + this.gap_penalty, p = this.grid[d][r - 1] + this.gap_penalty, v = [
											h,
											a,
											p
										], m$1 = this.arrayAllMaxIndexes(v);
										this.grid[d][r] = v[m$1[0]], this.tracebackGrid[d][r] = [
											m$1.includes(0),
											m$1.includes(1),
											m$1.includes(2)
										];
		...
		(function(O, T) {
			...
			return function(O) {
				...
				function o(e) {
					...
					return O[e].call(t.exports, t, t.exports, o), t.l = !0, t.exports;
				}
				...
				function(O, T, o) {
					...
					t.DEFAULT_USE_MULTI_LEVEL_SCALING = !1, t.DEFAULT_RADIAL_SEPARATION = e.DEFAULT_EDGE_LENGTH, t.DEFAULT_COMPONENT_SEPERATION = 60, t.TILE = !0, t.TILING_PADDING_VERTICAL = 10, t.TILING_PADDING_HORIZONTAL = 10, t.TREE_REDUCTION_ON_INCREMENTAL = !1, O.exports = t;
				},
				function(O, T, o) {
				...
				function(O, T, o) {
					...
					i.prototype.move = function() {
						...
						for (var d = this.getChild().getNodes(), r, h = 0; h < d.length; h++) r = d[h], r.getChild() == null ? (r.moveBy(g, n), r.displacementX += g, r.displacementY += n) : r.propogateDisplacementToChildren(g, n);
				...
				function(O, T, o) {
					var e = o(0).FDLayout, t = o(4), i = o(3), l = o(5), g = o(2), n = o(1), d = o(0).FDLayoutConstants, r = o(0).LayoutConstants, h = o(0).Point, a = o(0).PointD, p = o(0).Layout, v = o(0).Integer, m$1 = o(0).IGeometry, u = o(0).LGraph, E = o(0).Transform;
					function y() {
					...
					y.prototype.newGraphManager = function() {
						...
						return r.DEFAULT_CREATE_BENDS_AS_NEEDED && (this.createBendpoints(), this.graphManager.resetAllEdges()), this.level = 0, this.classicLayout();
						...
						for (D = 0; D < L; D++) f = c[D], f.updateConnected(), f.isConnected || (s = s.concat(f.getNodes()));
						return s;
						...
						for (c = 0; c < s.length; c++) {
							...
							if (!f.has(L)) {
								...
								if (D == I) L.getBendpoints().push(new a()), L.getBendpoints().push(new a()), this.createDummyNodesForBendpoints(L), f.add(L);
								else {
									var R$1 = [];
									if (R$1 = R$1.concat(D.getEdgeListToNode(I)), R$1 = R$1.concat(I.getEdgeListToNode(D)), !f.has(R$1[0])) {
										if (R$1.length > 1) {
											var C;
											for (C = 0; C < R$1.length; C++) {
												var M = R$1[C];
						...
						for (var f = new h(0, 0), c = Math.ceil(Math.sqrt(s.length)), L = 0, D = 0, I = 0, R$1 = new a(0, 0), C = 0; C < s.length; C++) {
							C % c == 0 && (I = 0, D = L, C != 0 && (D += n.DEFAULT_COMPONENT_SEPERATION), L = 0);
							var M = s[C], S = p.findCenterOfTree(M);
							f.x = I, f.y = D, R$1 = y.radialLayout(M, S, f), R$1.y > L && (L = Math.floor(R$1.y)), I = Math.floor(R$1.x + n.DEFAULT_COMPONENT_SEPERATION);
						}
						this.transform(new a(r.WORLD_CENTER_X - R$1.x / 2, r.WORLD_CENTER_Y - R$1.y / 2));
						...
						for (var R$1 = 0; R$1 < s.length; R$1++) s[R$1].transform(I);
						var M = new a(D.getMaxX(), D.getMaxY());
						return I.inverseTransformPoint(M);
					}, y.branchRadialLayout = function(s, f, c, L, D, I) {
						var R$1 = (L - c + 1) / 2;
						R$1 < 0 && (R$1 += 180);
						var M = (R$1 + c) % 360 * m$1.TWO_PI / 360, S = D * Math.cos(M), Y = D * Math.sin(M);
						s.setCenter(S, Y);
						var w = [];
						...
						for (var c = [], L = this.graphManager.getAllNodes(), D = 0; D < L.length; D++) {
							var I = L[D], R$1 = I.getParent();
							this.getNodeDegreeWithChildren(I) === 0 && (R$1.id == null || !this.getToBeTiled(R$1)) && c.push(I);
						}
						...
						for (var c = 0; c < this.compoundOrder.length; c++) f[this.compoundOrder[c].id] = this.compoundOrder[c], s[this.compoundOrder[c].id] = [].concat(this.compoundOrder[c].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[c].getChild()), this.compoundOrder[c].child = null;
						...
						for (var L = c.getNodes(), D = 0; D < L.length; D++) {
							var I = L[D];
							if (this.getNodeDegree(I) > 0) return this.toBeTiled[f] = !1, !1;
							if (I.getChild() == null) {
								this.toBeTiled[I.id] = !1;
								continue;
							}
							if (!this.getToBeTiled(I)) return this.toBeTiled[f] = !1, !1;
						}
						...
						f += L, c += D;
						for (var I = f, R$1 = 0; R$1 < s.rows.length; R$1++) {
							var C = s.rows[R$1];
							f = I;
						...
						var D = {
							...
							width: 0,
							height: f,
							verticalPadding: n.TILING_PADDING_VERTICAL,
							horizontalPadding: n.TILING_PADDING_HORIZONTAL
						};
						s.sort(function(C, M) {
						...
						for (var I = 0; I < s.length; I++) {
							var R$1 = s[I];
							D.rows.length == 0 ? this.insertNodeToRow(D, R$1, 0, f) : this.canAddHorizontal(D, R$1.rect.width, R$1.rect.height) ? this.insertNodeToRow(D, R$1, this.getShortestRowIndex(D), f) : this.insertNodeToRow(D, R$1, D.rows.length, f), this.shiftToLastRow(D);
						}
						return D;
					}, y.prototype.insertNodeToRow = function(s, f, c, L) {
						var D = L;
						if (c == s.rows.length) s.rows.push([]), s.rowWidth.push(D), s.rowHeight.push(0);
						var R$1 = s.rowWidth[c] + f.rect.width;
						s.rows[c].length > 0 && (R$1 += s.horizontalPadding), s.rowWidth[c] = R$1, s.width < R$1 && (s.width = R$1);
						var C = f.rect.height;
						...
						for (var f = -1, c = Number.MAX_VALUE, L = 0; L < s.rows.length; L++) s.rowWidth[L] < c && (f = L, c = s.rowWidth[L]);
						return f;
					}, y.prototype.getLongestRowIndex = function(s) {
						for (var f = -1, c = Number.MIN_VALUE, L = 0; L < s.rows.length; L++) s.rowWidth[L] > c && (f = L, c = s.rowWidth[L]);
						return f;
					}, y.prototype.canAddHorizontal = function(s, f, c) {
						var L = this.getShortestRowIndex(s);
						if (L < 0) return !0;
						var D = s.rowWidth[L];
						if (D + s.horizontalPadding + f <= s.width) return !0;
						var I = 0;
						s.rowHeight[L] < c && L > 0 && (I = c + s.verticalPadding - s.rowHeight[L]);
						var R$1;
						s.width - D >= f + s.horizontalPadding ? R$1 = (s.height + I) / (D + f + s.horizontalPadding) : R$1 = (s.height + I) / s.width, I = c + s.verticalPadding;
						var C;
						return s.width < f ? C = (s.height + I) / f : C = (s.height + I) / s.width, C < 1 && (C = 1 / C), R$1 < 1 && (R$1 = 1 / R$1), R$1 < C;
						...
						if (s.width - s.rowWidth[c] > I && f != c) {
							...
							for (var R$1 = Number.MIN_VALUE, C = 0; C < L.length; C++) L[C].height > R$1 && (R$1 = L[C].height);
							f > 0 && (R$1 += s.verticalPadding);
							var M = s.rowHeight[f] + s.rowHeight[c];
							s.rowHeight[f] = R$1, s.rowHeight[c] < D.height + s.verticalPadding && (s.rowHeight[c] = D.height + s.verticalPadding);
						...
						for (var s = [], f = !0, c; f;) {
							...
							f = !1;
							for (var I = 0; I < L.length; I++) c = L[I], c.getEdges().length == 1 && !c.getEdges()[0].isInterGraph && c.getChild() == null && (D.push([
								c,
								c.getEdges()[0],
								c.getOwner()
							]), f = !0);
							if (f == !0) {
								for (var R$1 = [], C = 0; C < D.length; C++) D[C][0].getEdges().length == 1 && (R$1.push(D[C]), D[C][0].getOwner().remove(D[C][0]));
								s.push(R$1), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
							}
						}
						this.prunedNodesAll = s;
					}, y.prototype.growTree = function(s) {
						for (var c = s[s.length - 1], L, D = 0; D < c.length; D++) L = c[D], this.findPlaceforPrunedNode(L), L[2].add(L[0]), L[2].add(L[1], L[1].source, L[1].target);
						...
						var D = c.startX, I = c.finishX, R$1 = c.startY, C = c.finishY, x = [
							0,
							0,
							0,
							0
						];
						if (R$1 > 0) for (var F = D; F <= I; F++) x[0] += this.grid[F][R$1 - 1].length + this.grid[F][R$1].length - 1;
						if (I < this.grid.length - 1) for (var F = R$1; F <= C; F++) x[1] += this.grid[I + 1][F].length + this.grid[I][F].length - 1;
						if (C < this.grid[0].length - 1) for (var F = D; F <= I; F++) x[2] += this.grid[F][C + 1].length + this.grid[F][C].length - 1;
						if (D > 0) for (var F = R$1; F <= C; F++) x[3] += this.grid[D - 1][F].length + this.grid[D][F].length - 1;
						for (var U = v.MAX_VALUE, P, _, X = 0; X < x.length; X++) x[X] < U ? (U = x[X], P = 1, _ = X) : x[X] == U && P++;
						if (P == 3 && U == 0) x[0] == 0 && x[1] == 0 && x[2] == 0 ? f = 1 : x[0] == 0 && x[1] == 0 && x[3] == 0 ? f = 0 : x[0] == 0 && x[2] == 0 && x[3] == 0 ? f = 3 : x[1] == 0 && x[2] == 0 && x[3] == 0 && (f = 2);
						else if (P == 2 && U == 0) {
...
(function(G, b) {
	(function(O, T) {
		...
		return function(O) {
			...
			function h(m$1, u) {
				var E = {};
				for (var y in m$1) E[y] = m$1[y];
				for (var y in u) E[y] = u[y];
				return E;
			}
			function a(m$1) {
				this.options = h(r, m$1), p(this.options);
			}
			var p = function(u) {
			...
			a.prototype.run = function() {
				...
				for (var L = 0; L < c.length; L++) {
					var D = c[L], I = this.idToLNode[D.data("source")], R$1 = this.idToLNode[D.data("target")];
					if (I !== R$1 && I.getEdgesBetween(R$1).length == 0) {
						var C = s.add(y.newEdge(), I, R$1);
						C.id = D.id();
					}
				}
				var M = function(w, x) {
					...
					for (var w = function() {
						E.fit && E.cy.fit(E.eles, E.padding), m$1 || (m$1 = !0, N.cy.one("layoutready", E.ready), N.cy.trigger({
							type: "layoutready",
							layout: N
						}));
					}, x = N.options.refresh, F, U = 0; U < x && !F; U++) F = N.stopped || N.layout.tick();
					if (F) {
						y.checkLayoutSuccess() && !y.isSubLayout && y.doPostLayout(), y.tilingPostLayout && y.tilingPostLayout(), y.isLayoutFinished = !0, N.options.eles.nodes().positions(M), w(), N.cy.one("layoutstop", N.options.stop), N.cy.trigger({
							type: "layoutstop",
							layout: N
						}), u && cancelAnimationFrame(u), m$1 = !1;
						return;
					}
				...
				}), y.runLayout(), this.options.animate !== "during" && (N.options.eles.nodes().not(":parent").layoutPositions(N, N.options, M), m$1 = !1), this;
			}, a.prototype.getTopMostNodes = function(m$1) {
				for (var u = {}, E = 0; E < m$1.length; E++) u[m$1[E].id()] = !0;
				return m$1.filter(function(N, s) {
					typeof N == "number" && (N = s);
			...
			}, a.prototype.processChildrenList = function(m$1, u, E) {
				for (var y = u.length, N = 0; N < y; N++) {
					var s = u[N], f = s.children(), c, L = s.layoutDimensions({ nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels });
					if (s.outerWidth() != null && s.outerHeight() != null ? c = m$1.add(new g(E.graphManager, new n(s.position("x") - L.w / 2, s.position("y") - L.h / 2), new d(parseFloat(L.w), parseFloat(L.h)))) : c = m$1.add(new g(this.graphManager)), c.id = s.data("id"), c.paddingLeft = parseInt(s.css("padding")), c.paddingTop = parseInt(s.css("padding")), c.paddingRight = parseInt(s.css("padding")), c.paddingBottom = parseInt(s.css("padding")), this.options.nodeDimensionsIncludeLabels && s.isParent()) {
						var D = s.boundingBox({
							includeLabels: !0,
							includeNodes: !1
						}).w, I = s.boundingBox({
							includeLabels: !0,
							includeNodes: !1
						}).h, R$1 = s.css("text-halign");
						c.labelWidth = D, c.labelHeight = I, c.labelPos = R$1;
					}
					if (this.idToLNode[s.data("id")] = c, isNaN(c.rect.x) && (c.rect.x = 0), isNaN(c.rect.y) && (c.rect.y = 0), f != null && f.length > 0) {
						var C = E.getGraphManager().add(E.newGraph(), c);
						this.processChildrenList(C, f, E);
					}
				}
...
var Xe = /* @__PURE__ */ m(async (G, b, { insertCluster: A, insertEdge: O, insertEdgeLabel: T, insertMarkers: o, insertNode: e, log: t, positionEdgeLabel: i }, { algorithm: l }) => {
	...
	t.debug("Positioning nodes based on layout results"), m$1.nodes.forEach((u) => {
		const E = g[u.id];
		...
		if (E && y) {
			const N = m$1.edges.find((s) => s.id === u.id);
			if (N) {
				t.debug("APA01 positionedEdge", N);
				const s = { ...u };
				i(s, O(h, s, n, G.type, E, y, G.diagramId));
			} else {
				const s = {
					...u,
					points: [{
