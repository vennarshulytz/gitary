import { D as Jc, Tn as sM, X as Q9, pt as VE, yt as Zd } from "./app-DQCpdmdF.js";
import { a as Ft, d as Nt, f as O, k as mt, m as Rt, t as Dt, u as Mt, w as cr } from "./_baseUniq-214847ec-Dv4dD2EA.js";
var F = sM(function(o) {
	return Nt(cr(o, 1, VE, !0));
});
var M = "\0", a = "\0", O$1 = "";
var L = class {
	constructor(e = {}) {
	...
	removeNode(e) {
		if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
			...
			delete this._nodes[e], this._isCompound && (this._removeFromParentsChildList(e), delete this._parent[e], Mt(this.children(e), (s) => {
				this.setParent(s);
			}), delete this._children[e]), Mt(O(this._in[e]), t), delete this._in[e], delete this._preds[e], Mt(O(this._out[e]), t), delete this._out[e], delete this._sucs[e], --this._nodeCount;
		}
		return this;
	}
	setParent(e, t) {
		...
		if (Dt(t)) t = a;
			...
			t += "";
			for (var s = t; !Dt(s); s = this.parent(s)) if (s === e) throw new Error("Setting " + t + " as parent of " + e + " would create a cycle");
			this.setNode(t);
		}
	...
	neighbors(e) {
		...
		if (t) return F(t, this.successors(e));
	}
	isLeaf(e) {
		var t;
	...
	setEdge() {
		...
		typeof n == "object" && n !== null && "v" in n ? (e = n.v, t = n.w, s = n.name, arguments.length === 2 && (i = arguments[1], r = !0)) : (e = n, t = arguments[1], s = arguments[3], arguments.length > 2 && (i = arguments[2], r = !0)), e = "" + e, t = "" + t, Dt(s) || (s = "" + s);
		...
		if (!Dt(s) && !this._isMultigraph) throw new Error("Cannot set a named edge when isMultigraph = false");
