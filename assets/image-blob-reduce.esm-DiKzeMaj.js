var assign$1 = function assign$2(to) {
	var from;
...
var pica = createCommonjsModule(function(module, exports) {
	(function(f) {
		...
		return (function() {
			...
			2: [function(_dereq_, module$1, exports$1) {
				function clampTo8(i) {
			...
			3: [function(_dereq_, module$1, exports$1) {
				module$1.exports = "";
			}, {}],
			4: [function(_dereq_, module$1, exports$1) {
				module$1.exports = {
					name: "resize",
					fn: _dereq_("./resize"),
			...
			5: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = function resize(options) {
					var src = options.src;
			...
			6: [function(_dereq_, module$1, exports$1) {
				var FILTER_INFO = _dereq_("./resize_filter_info");
				var FIXED_FRAC_BITS = 14;
				function toFixedPoint(num) {
					return Math.round(num * ((1 << FIXED_FRAC_BITS) - 1));
				}
				module$1.exports = function resizeFilterGen(quality, srcSize, destSize, scale, offset) {
			...
			7: [function(_dereq_, module$1, exports$1) {
				module$1.exports = [
					{
						win: .5,
			...
			8: [function(_dereq_, module$1, exports$1) {
				var createFilters = _dereq_("./resize_filter_gen");
				function resetAlpha(dst, width, height) {
					var ptr = 3, len = width * height * 4 | 0;
					while (ptr < len) {
				...
				module$1.exports = function resize_wasm(options) {
					var src = options.src;
					var srcW = options.width;
					var srcH = options.height;
					var destW = options.toWidth;
			...
			9: [function(_dereq_, module$1, exports$1) {
				module$1.exports = {
					name: "unsharp_mask",
			...
			10: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = function unsharp(img, width, height, amount, radius, threshold) {
					var v1, v2, vmul;
					var diff, iTimes4;
			...
			11: [function(_dereq_, module$1, exports$1) {
				module$1.exports = function unsharp(img, width, height, amount, radius, threshold) {
					if (amount === 0 || radius < .5) return;
					if (radius > 2) radius = 2;
			...
			13: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = Pool;
			}, {}],
			14: [function(_dereq_, module$1, exports$1) {
				var MIN_INNER_TILE_SIZE = 2;
				module$1.exports = function createStages(fromWidth, fromHeight, toWidth, toHeight, srcTileSize, destTileBorder) {
			...
			15: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = function createRegions(options) {
			...
			16: [function(_dereq_, module$1, exports$1) {
				function objClass(obj) {
					return Object.prototype.toString.call(obj);
				}
				module$1.exports.isCanvas = function isCanvas(element) {
					var cname = objClass(element);
					return cname === "[object HTMLCanvasElement]" || cname === "[object OffscreenCanvas]" || cname === "[object Canvas]";
				};
				module$1.exports.isImage = function isImage(element) {
					return objClass(element) === "[object HTMLImageElement]";
				};
				module$1.exports.isImageBitmap = function isImageBitmap(element) {
					return objClass(element) === "[object ImageBitmap]";
				};
				module$1.exports.limiter = function limiter(concurrency) {
					var active = 0, queue = [];
					function roll() {
				...
				module$1.exports.cib_quality_name = function cib_quality_name(num) {
					switch (num) {
				...
				module$1.exports.cib_support = function cib_support(createCanvas) {
				...
				module$1.exports.worker_offscreen_canvas_support = function worker_offscreen_canvas_support() {
					return new Promise(function(resolve, reject) {
				...
				module$1.exports.can_use_canvas = function can_use_canvas(createCanvas) {
					var usable = false;
					try {
				...
				module$1.exports.cib_can_use_region = function cib_can_use_region() {
			...
			17: [function(_dereq_, module$1, exports$1) {
				module$1.exports = function() {
					var MathLib = _dereq_("./mathlib");
					var mathLib;
					onmessage = function onmessage$1(ev) {
			...
			18: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = blurMono16;
			}, {}],
			19: [function(_dereq_, module$1, exports$1) {
			...
			20: [function(_dereq_, module$1, exports$1) {
				var assign$2 = _dereq_("object-assign");
				...
				function MultiMath(options) {
					...
					var opts = assign$2({}, DEFAULT_OPTIONS, options || {});
					this.options = opts;
					this.__cache = {};
				...
				MultiMath.prototype.use = function(module$2) {
					this.__modules[module$2.name] = module$2;
					if (this.options.wasm && this.has_wasm() && module$2.wasm_fn) this[module$2.name] = module$2.wasm_fn;
					else this[module$2.name] = module$2.fn;
					return this;
				};
				...
				MultiMath.prototype.__instance = function instance(name, memsize, env_extra) {
					...
					if (!this.__wasm[name]) {
						var module$2 = this.__modules[name];
						this.__wasm[name] = new WebAssembly.Module(this.__base64decode(module$2.wasm_src));
					}
					if (!this.__cache[name]) {
						...
						this.__cache[name] = new WebAssembly.Instance(this.__wasm[name], { env: assign$2(env_base, env_extra || {}) });
					}
				...
				module$1.exports = MultiMath;
			}, {
				"./lib/base64decode": 21,
				"./lib/wa_detect": 22,
				"object-assign": 23
			}],
			21: [function(_dereq_, module$1, exports$1) {
				var BASE64_MAP = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
				module$1.exports = function base64decode(str) {
			...
			22: [function(_dereq_, module$1, exports$1) {
				var wa;
				module$1.exports = function hasWebAssembly() {
					...
					try {
						...
						var module$2 = new WebAssembly.Module(bin);
						if (new WebAssembly.Instance(module$2, {}).exports.test(4) !== 0) wa = true;
						return wa;
					} catch (__) {}
					return wa;
				};
			}, {}],
			23: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports = shouldUseNative() ? Object.assign : function(target, source) {
					var from;
			...
			24: [function(_dereq_, module$1, exports$1) {
				var bundleFn = arguments[3];
				var sources = arguments[4];
				var cache = arguments[5];
				var stringify = JSON.stringify;
				module$1.exports = function(fn, options) {
					var wkey;
					...
					var workerSources = {};
					resolveSources(skey);
					function resolveSources(key$1) {
						workerSources[key$1] = true;
						for (var depPath in sources[key$1][1]) {
							var depKey = sources[key$1][1][depPath];
							if (!workerSources[depKey]) resolveSources(depKey);
						}
					}
					var src = "(" + bundleFn + ")({" + Object.keys(workerSources).map(function(key$1) {
						return stringify(key$1) + ":[" + sources[key$1][0] + "," + stringify(sources[key$1][1]) + "]";
					}).join(",") + "},{},[" + stringify(skey) + "])";
			...
			"/index.js": [function(_dereq_, module$1, exports$1) {
				...
				function Pica(options) {
					...
					this.options = assign$2({}, DEFAULT_PICA_OPTS, options || {});
					var limiter_key = "lk_".concat(this.options.concurrency);
					this.__limit = singletones[limiter_key] || utils$1.limiter(this.options.concurrency);
				...
				Pica.prototype.init = function() {
					...
					if (typeof ImageBitmap !== "undefined") if (ImageBitmap.prototype && ImageBitmap.prototype.close) CAN_CREATE_IMAGE_BITMAP = true;
					...
					var initMath = this.__mathlib.init().then(function(mathlib) {
						assign$2(_this.features, mathlib.features);
					});
					var checkCibResize;
					if (!CAN_CREATE_IMAGE_BITMAP) checkCibResize = Promise.resolve(false);
					else checkCibResize = utils$1.cib_support(this.options.createCanvas).then(function(status) {
					...
					CAN_USE_CANVAS_GET_IMAGE_DATA = utils$1.can_use_canvas(this.options.createCanvas);
					var checkOffscreenCanvas;
					if (CAN_CREATE_IMAGE_BITMAP && CAN_NEW_IMAGE_DATA && features.indexOf("ww") !== -1) checkOffscreenCanvas = utils$1.worker_offscreen_canvas_support();
					else checkOffscreenCanvas = Promise.resolve(false);
					checkOffscreenCanvas = checkOffscreenCanvas.then(function(result) {
						CAN_USE_OFFSCREEN_CANVAS = result;
					});
					var checkCibRegion = utils$1.cib_can_use_region().then(function(result) {
				...
				Pica.prototype.__extractTileData = function(tile, from, opts, stageEnv, extractTo) {
					if (this.features.ww && CAN_USE_OFFSCREEN_CANVAS && (utils$1.isCanvas(from) || CAN_USE_CIB_REGION_FOR_IMAGE)) {
				...
				Pica.prototype.__tileAndResize = function(from, to, opts) {
					...
					var processTile = function processTile$1(tile) {
						return _this3.__limit(function() {
							...
							return Promise.resolve(tileOpts).then(function(tileOpts$1) {
								return _this3.__extractTileData(tile, from, opts, stageEnv, tileOpts$1);
							}).then(function(tileOpts$1) {
								_this3.debug("Invoke resize math");
								return _this3.__invokeResize(tileOpts$1, opts);
							}).then(function(result) {
								if (opts.canceled) return opts.cancelToken;
					...
					return Promise.resolve().then(function() {
						...
						if (utils$1.isCanvas(from)) return null;
						if (utils$1.isImageBitmap(from)) {
							stageEnv.srcImageBitmap = from;
							stageEnv.isImageBitmapReused = true;
							return null;
						}
						if (utils$1.isImage(from)) {
						...
						function cleanup(stageEnv$1) {
							if (stageEnv$1.srcImageBitmap) {
								if (!stageEnv$1.isImageBitmapReused) stageEnv$1.srcImageBitmap.close();
								stageEnv$1.srcImageBitmap = null;
							}
						}
				...
				Pica.prototype.__resizeViaCreateImageBitmap = function(from, to, opts) {
					...
					return createImageBitmap(from, {
						...
						resizeQuality: utils$1.cib_quality_name(opts.quality)
				...
				Pica.prototype.resize = function(from, to, options) {
					...
					var opts = assign$2({}, DEFAULT_RESIZE_OPTS);
					if (!isNaN(options)) opts = assign$2(opts, { quality: options });
					else if (options) opts = assign$2(opts, options);
				...
				Pica.prototype.resizeBuffer = function(options) {
					var _this7 = this;
					var opts = assign$2({}, DEFAULT_RESIZE_OPTS, options);
					return this.init().then(function() {
	...
	module.exports.jpeg_segments_each = function(jpeg_bin, on_segment) {
		...
		for (;;) {
			...
			if (byte1 === 255 && byte2 === 255) {
				...
				if (inside_scan) if (segment_code >= 208 && segment_code <= 215);
...
export { image_blob_reduce_esm_default as default };
