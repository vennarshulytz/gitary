import { H as m$1, K as R, O as yt, aK as iT, a1 as s$, W as Pb, a0 as Bz, bk as d5, ax as Mf, ag as _e, am as uA, an as cA, bl as Kn, bm as Y, bn as et } from "./app-32980687.js";
...
` + t);
  ...
  for (const b of w) {
    ...
    for (const e of a) {
      ...
      const l2 = (await Pb(C, e, { config: f })).node().getBBox();
      e.y = i + l2.height / 2, await Bz(e), i = e.y + l2.height / 2 + r / 2;
    }
