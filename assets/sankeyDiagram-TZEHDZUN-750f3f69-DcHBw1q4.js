...
import { $n as require_markdown_it_task_lists, Gn as yt, It as d5, Ln as w5, Ot as b5, Qn as require_pinyin, Qt as hz, Vn as x5, Wn as y5, Xn as zi, dn as m5, er as require_markdown_it_multimd_table, nn as k5, qt as gt, un as m, wi as require_classnames, xt as _5 } from "./app-DQCpdmdF.js";
...
var It = Nt("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
function ct(t, e) {
	let i;
	if (e === void 0) for (const a of t) a != null && (i < a || i === void 0 && a >= a) && (i = a);
	else {
		let a = -1;
		for (let h$1 of t) (h$1 = e(h$1, ++a, t)) != null && (i < h$1 || i === void 0 && h$1 >= h$1) && (i = h$1);
	}
	return i;
}
function gt$1(t, e) {
...
function nt(t, e) {
	...
	if (e === void 0) for (let a of t) (a = +a) && (i += a);
		...
		let a = -1;
		for (let h$1 of t) (h$1 = +e(h$1, ++a, t)) && (i += h$1);
	}
	return i;
}
function Pt(t) {
...
function Dt(t) {
	return t.targetLinks.length ? t.depth : t.sourceLinks.length ? gt$1(t.sourceLinks, Pt) - 1 : 0;
}
function q(t) {
	return function() {
		return t;
...
function pt({ nodes: t }) {
	for (const e of t) {
		let i = e.y0, a = i;
		for (const h$1 of e.sourceLinks) h$1.y0 = i + h$1.width / 2, i += h$1.width;
		for (const h$1 of e.targetLinks) h$1.y1 = a + h$1.width / 2, a += h$1.width;
	}
}
function Bt() {
	let t = 0, e = 0, i = 1, a = 1, h$1 = 24, y = 8, m$1, _ = $t, r = mt, o, l, x = jt, v = zt, p = 6;
	function b() {
		const n = {
	...
	b.update = function(n) {
		...
		return arguments.length ? (h$1 = +n, b) : h$1;
	}, b.nodePadding = function(n) {
		return arguments.length ? (y = m$1 = +n, b) : y;
	}, b.nodes = function(n) {
	...
	function M({ nodes: n, links: f }) {
		...
		if (l != null) for (const { sourceLinks: c, targetLinks: s } of n) c.sort(l), s.sort(l);
	}
	function T({ nodes: n }) {
		for (const f of n) f.value = f.fixedValue === void 0 ? Math.max(nt(f.sourceLinks, it), nt(f.targetLinks, it)) : f.fixedValue;
	}
	function N({ nodes: n }) {
		const f = n.length;
	...
	function O({ nodes: n }) {
		const f = ct(n, (s) => s.depth) + 1, u = (i - t - h$1) / (f - 1), c = new Array(f);
		for (const s of n) {
			const k = Math.max(0, Math.min(f - 1, Math.floor(r.call(null, s, f))));
			s.layer = k, s.x0 = t + k * u, s.x1 = s.x0 + h$1, c[k] ? c[k].push(s) : c[k] = [s];
		}
		if (o) for (const s of c) s.sort(o);
		return c;
	}
	function R(n) {
		const f = gt$1(n, (u) => (a - e - (u.length - 1) * m$1) / nt(u, it));
		for (const u of n) {
			let c = e;
			for (const s of u) {
				s.y0 = c, s.y1 = c + s.value * f, c = s.y1 + m$1;
				for (const k of s.sourceLinks) k.width = k.value * f;
			}
			c = (a - c + m$1) / (u.length + 1);
	...
	function S(n) {
		const f = O(n);
		m$1 = Math.min(y, (a - e) / (ct(f, (u) => u.length) - 1)), R(f);
		for (let u = 0; u < p; ++u) {
			const c = Math.pow(.99, u), s = Math.max(1 - c, (u + 1) / p);
			z(f, c, s), P(f, c, s);
		}
	}
	function P(n, f, u) {
	...
	function D(n, f) {
		...
		d(n, c.y0 - m$1, u - 1, f), $(n, c.y1 + m$1, u + 1, f), d(n, a, n.length - 1, f), $(n, e, 0, f);
	}
	function $(n, f, u, c) {
		for (; u < n.length; ++u) {
			const s = n[u], k = (f - s.y0) * c;
			k > 1e-6 && (s.y0 += k, s.y1 += k), f = s.y1 + m$1;
		}
	}
	function d(n, f, u, c) {
		for (; u >= 0; --u) {
			const s = n[u], k = (s.y1 - f) * c;
			k > 1e-6 && (s.y0 -= k, s.y1 -= k), f = s.y0 - m$1;
		}
	}
	function E({ sourceLinks: n, targetLinks: f }) {
		if (l === void 0) {
			for (const { source: { sourceLinks: u } } of f) u.sort(ht);
			for (const { target: { targetLinks: u } } of n) u.sort(ut);
		}
	}
	function A(n) {
	...
	function j(n, f) {
		let u = n.y0 - (n.sourceLinks.length - 1) * m$1 / 2;
	...
	function I(n, f) {
		let u = f.y0 - (f.targetLinks.length - 1) * m$1 / 2;
		for (const { source: c, width: s } of f.targetLinks) {
			if (c === n) break;
			u += s + m$1;
		}
...
ot.prototype = kt.prototype = {
	...
	bezierCurveTo: function(t, e, i, a, h$1, y) {
		this._ += "C" + +t + "," + +e + "," + +i + "," + +a + "," + (this._x1 = +h$1) + "," + (this._y1 = +y);
	},
	arcTo: function(t, e, i, a, h$1) {
		t = +t, e = +e, i = +i, a = +a, h$1 = +h$1;
		var y = this._x1, m$1 = this._y1, _ = i - t, r = a - e, o = y - t, l = m$1 - e, x = o * o + l * l;
		if (h$1 < 0) throw new Error("negative radius: " + h$1);
		if (this._x1 === null) this._ += "M" + (this._x1 = t) + "," + (this._y1 = e);
		else if (x > V) if (!(Math.abs(l * _ - r * o) > V) || !h$1) this._ += "L" + (this._x1 = t) + "," + (this._y1 = e);
		else {
			var v = i - y, p = a - m$1, b = _ * _ + r * r, M = v * v + p * p, T = Math.sqrt(b), N = Math.sqrt(x), C = h$1 * Math.tan((rt - Math.acos((b + x - M) / (2 * T * N))) / 2), O = C / N, R = C / T;
			Math.abs(O - 1) > V && (this._ += "L" + (t + O * o) + "," + (e + O * l)), this._ += "A" + h$1 + "," + h$1 + ",0,0," + +(l * v > o * p) + "," + (this._x1 = t + R * _) + "," + (this._y1 = e + R * r);
		}
	},
	arc: function(t, e, i, a, h$1, y) {
		t = +t, e = +e, i = +i, y = !!y;
		var m$1 = i * Math.cos(a), _ = i * Math.sin(a), r = t + m$1, o = e + _, l = 1 ^ y, x = y ? a - h$1 : h$1 - a;
		if (i < 0) throw new Error("negative radius: " + i);
		this._x1 === null ? this._ += "M" + r + "," + o : (Math.abs(this._x1 - r) > V || Math.abs(this._y1 - o) > V) && (this._ += "L" + r + "," + o), i && (x < 0 && (x = x % st + st), x > Rt ? this._ += "A" + i + "," + i + ",0,1," + l + "," + (t - m$1) + "," + (e - _) + "A" + i + "," + i + ",0,1," + l + "," + (this._x1 = r) + "," + (this._y1 = o) : x > V && (this._ += "A" + i + "," + i + ",0," + +(x >= rt) + "," + l + "," + (this._x1 = t + i * Math.cos(h$1)) + "," + (this._y1 = e + i * Math.sin(h$1))));
	},
...
function Yt(t) {
	var e = Ut, i = Gt, a = Ft, h$1 = Vt, y = null;
	function m$1() {
		var _, r = Wt.call(arguments), o = e.apply(this, r), l = i.apply(this, r);
		if (y || (y = _ = kt()), t(y, +a.apply(this, (r[0] = o, r)), +h$1.apply(this, r), +a.apply(this, (r[0] = l, r)), +h$1.apply(this, r)), _) return y = null, _ + "" || null;
	}
	return m$1.source = function(_) {
		return arguments.length ? (e = _, m$1) : e;
	}, m$1.target = function(_) {
		return arguments.length ? (i = _, m$1) : i;
	}, m$1.x = function(_) {
		return arguments.length ? (a = typeof _ == "function" ? _ : yt$1(+_), m$1) : a;
	}, m$1.y = function(_) {
		return arguments.length ? (h$1 = typeof _ == "function" ? _ : yt$1(+_), m$1) : h$1;
	}, m$1.context = function(_) {
		return arguments.length ? (y = _ ?? null, m$1) : y;
	}, m$1;
}
function Ht(t, e, i, a, h$1) {
	t.moveTo(e, i), t.bezierCurveTo(e = (e + a) / 2, i, e, h$1, a, h$1);
}
function Xt() {
	return Yt(Ht);
}
...
var at = function() {
	var t = /* @__PURE__ */ m(function(_, r, o, l) {
		...
		parse: /* @__PURE__ */ m(function(r) {
			...
			for (var z in this.yy) Object.prototype.hasOwnProperty.call(this.yy, z) && (P.yy[z] = this.yy[z]);
			...
			for (var A, j, I, n, f = {}, u, c, s, k;;) {
				if (j = l[l.length - 1], this.defaultActions[j] ? I = this.defaultActions[j] : ((A === null || typeof A > "u") && (A = E()), I = b[j] && b[j][A]), typeof I > "u" || !I.length || !I[0]) {
					var w = "";
					k = [];
					for (u in b[j]) this.terminals_[u] && u > C && k.push("'" + this.terminals_[u] + "'");
...
Expecting ` + k.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : w = "Parse error on line " + (T + 1) + ": Unexpected " + (A == O ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(w, {
				...
				if (I[0] instanceof Array && I.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + j + ", token: " + A);
				switch (I[0]) {
					case 1:
					...
					case 2:
						...
						}, $ && (f._$.range = [p[p.length - (c || 1)].range[0], p[p.length - 1].range[1]]), n = this.performAction.apply(f, [
							M,
							N,
							T,
							P.yy,
...
` + o + "^";
			...
			test_match: /* @__PURE__ */ m(function(r, o) {
				...
				}, this.yytext += r[0], this.match += r[0], this.matches = r, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(r[0].length), this.matched += r[0], l = this.performAction.call(this, this.yy, this, o, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), l) return l;
				if (this._backtrack) {
			...
			next: /* @__PURE__ */ m(function() {
				...
				for (var v = this._currentRules(), p = 0; p < v.length; p++) if (l = this._input.match(this.rules[v[p]]), l && (!o || l[0].length > o[0].length)) {
					if (o = l, x = p, this.options.backtrack_lexer) {
						if (r = this.test_match(l, v[p]), r !== !1) return r;
						if (this._backtrack) {
							o = !1;
							continue;
						} else return !1;
				...
				return o ? (r = this.test_match(o, v[x]), r !== !1 ? r : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
					text: "",
					token: null,
					line: this.yylineno
	...
	return m(m$1, "Parser"), m$1.prototype = h$1, h$1.Parser = m$1, new m$1();
}();
at.parser = at;
var K = at, J = [], tt = [], Z = /* @__PURE__ */ new Map(), Zt = /* @__PURE__ */ m(() => {
	...
	nodesMap: Z,
	getConfig: /* @__PURE__ */ m(() => yt().sankey, "getConfig"),
	getNodes: /* @__PURE__ */ m(() => tt, "getNodes"),
	getLinks: /* @__PURE__ */ m(() => J, "getLinks"),
	getGraph: /* @__PURE__ */ m(() => ({
	...
	center: Dt,
	justify: mt
}, ce = { draw: /* @__PURE__ */ m(function(t, e, i, a) {
	const { securityLevel: h$1, sankey: y } = yt(), m$1 = hz.sankey;
	let _;
	h$1 === "sandbox" && (_ = gt("#i" + e));
	const r = h$1 === "sandbox" ? gt(_.nodes()[0].contentDocument.body) : gt("body"), o = h$1 === "sandbox" ? r.select(`[id="${e}"]`) : gt(`[id="${e}"]`), l = (y == null ? void 0 : y.width) ?? m$1.width, x = (y == null ? void 0 : y.height) ?? m$1.width, v = (y == null ? void 0 : y.useMaxWidth) ?? m$1.useMaxWidth, p = (y == null ? void 0 : y.nodeAlignment) ?? m$1.nodeAlignment, b = (y == null ? void 0 : y.prefix) ?? m$1.prefix, M = (y == null ? void 0 : y.suffix) ?? m$1.suffix, T = (y == null ? void 0 : y.showValues) ?? m$1.showValues, N = a.db.getGraph(), C = ae[p];
	Bt().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (T ? 15 : 0)).nodeAlign(C).extent([[0, 0], [l, x]])(N);
	const S = h(It);
...
${b}${Math.round(E * 100) / 100}${M}` : d, "getText");
	...
	const z = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", .5).selectAll(".link").data(N.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), D = (y == null ? void 0 : y.linkColor) ?? "gradient";
	if (D === "gradient") {
...
}, "draw") }, ue = /* @__PURE__ */ m((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing"), fe = /* @__PURE__ */ m((t) => `.label {
      font-family: ${t.fontFamily};
    }`, "getStyles"), pe = K.parse.bind(K);
K.parse = (t) => pe(ue(t));
var Bn = {
	styles: fe,
	parser: K,
