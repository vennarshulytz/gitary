...
import { H as m, aw as Ov, K as R, O as yt, at as Rz, au as Dz, a6 as gt, aq as $e, a7 as b5, a8 as x5, aa as y5, a9 as k5, ak as w5, al as _5, ar as m5, ap as Cz, av as dn } from "./app-15aca6ee.js";
...
var Ht = /* @__PURE__ */ m(async function(i, s, h, p) {
  ...
  f.type = p.type, f.layoutAlgorithm = Rz(y), f.config.flowchart.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 140, f.config.flowchart.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 80, f.direction = p.db.getDirection(), f.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], f.diagramId = s, await Dz(f, E), f.layoutAlgorithm === "elk" && E.select(".edges").lower();
