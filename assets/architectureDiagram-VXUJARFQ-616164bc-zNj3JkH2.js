...
import { $n as require_markdown_it_task_lists, $t as iT, Ct as _e, Et as aa, Gn as yt, It as d5, Ln as w5, Ot as b5, Qn as require_pinyin, R as Mf, Vn as x5, Wn as y5, b as FL, cn as lu, dn as m5, er as require_markdown_it_multimd_table, et as R, f as DL, gt as Xt, h as Dv, l as Cz, nn as k5, o as Ar, qt as gt, rt as Rv, un as m, wi as require_classnames, xt as _5 } from "./app-BfwZs39Q.js";
...
import { t as ea } from "./cytoscape.esm-13077586-kT0UkmlJ.js";
require_jsx_runtime();
require_react();
require_client();
require_react_dom();
			...
			return function(A) {
				...
				function(A, P, N) {
					...
					i.prototype.getEdges = function() {
						...
						if (t.add(this), this.child != null) for (var c = this.child.getNodes(), l = 0; l < c.length; l++) o = c[l], s = o.withChildren(), s.forEach(function(T) {
							t.add(T);
						});
						return t;
						...
						else for (var s = this.child.getNodes(), c = 0; c < s.length; c++) o = s[c], t += o.getNoOfChildren();
						return t == 0 && (t = 1), t;
				...
				function(A, P, N) {
					...
					o.prototype.getNodes = function() {
						...
						if (l == null && T == null) {
							...
							var v = c;
							if (!(this.getNodes().indexOf(l) > -1 && this.getNodes().indexOf(T) > -1)) throw "Source or target not in graph!";
						...
						if (c instanceof e) {
							...
							for (var T = l.edges.slice(), d, v = T.length, L = 0; L < v; L++) d = T[L], d.isInterGraph ? this.graphManager.remove(d) : d.source.owner.remove(d);
						...
						var l = new t(), T = /* @__PURE__ */ new Set(), d = this.nodes[0], v, L;
						for (d.withChildren().forEach(function(O) {
							l.push(O), T.add(O);
						}); l.length !== 0;) {
							d = l.shift(), v = d.getEdges();
							for (var C = v.length, G = 0; G < C; G++) if (L = v[G].getOtherEndInGraph(d, this), L != null && !T.has(L)) L.withChildren().forEach(function(O) {
								l.push(O), T.add(O);
							});
						}
				...
				function(A, P, N) {
					...
					a.prototype.addRoot = function() {
						...
						if (f == null && i == null && g == null) {
							...
							if (f.isInterGraph = !0, f.source = i, f.target = g, this.edges.indexOf(f) > -1) throw "Edge already in inter-graph edge list!";
						...
						if (r instanceof u) {
							...
							if (!(i.source.edges.indexOf(i) != -1 && i.target.edges.indexOf(i) != -1)) throw "Source and/or target doesn't know this edge!";
							var c = i.source.edges.indexOf(i);
							if (i.source.edges.splice(c, 1), c = i.target.edges.indexOf(i), i.target.edges.splice(c, 1), !(i.source.owner != null && i.source.owner.getGraphManager() != null)) throw "Edge owner graph or owner graph manager is null!";
							if (i.source.owner.getGraphManager().edges.indexOf(i) == -1) throw "Not in owner graph manager's edge list!";
						...
						if (this.allNodes == null) {
							for (var r = [], e = this.getGraphs(), f = e.length, i = 0; i < f; i++) r = r.concat(e[i].getNodes());
							this.allNodes = r;
						}
						...
						for (var r, e, f, i, g, t = this.getAllEdges(), o = t.length, s = 0; s < o; s++) {
							...
							for (i = e.getOwner(); r.lca == null;) {
								...
								r.lca ?? (r.sourceInLca = i.getParent(), i = r.sourceInLca.getOwner());
							}
							if (r.lca == null) throw "assert failed";
						}
						...
						for (var f, i = r.getNodes(), g = i.length, t = 0; t < g; t++) f = i[t], f.inclusionTreeDepth = e, f.child != null && this.calcInclusionTreeDepths(f.child, e + 1);
					}, a.prototype.includesInvalidEdge = function() {
						for (var r, e = [], f = this.edges.length, i = 0; i < f; i++) r = this.edges[i], this.isOneAncestorOfOther(r.source, r.target) && e.push(r);
				...
				function(A, P, N) {
					...
					h.calcSeparationAmount = function(a, r, e, f) {
						...
						var o = a.getX(), s = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), d = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), S = r.getX(), C = r.getY(), G = r.getRight(), K = r.getX(), X = r.getBottom(), Q = r.getRight(), O = r.getWidthHalf(), rt = r.getHeightHalf(), n = !1, E = !1;
						if (f === g) {
							...
							var p = a.height / a.width, m$2 = r.height / r.width, y = (t - i) / (g - f), R$1 = void 0, M = void 0, F = void 0, W = void 0, x = void 0, Z = void 0;
							if (-p === y ? f > g ? (e[0] = l, e[1] = T, n = !0) : (e[0] = c, e[1] = s, n = !0) : p === y && (f > g ? (e[0] = o, e[1] = s, n = !0) : (e[0] = d, e[1] = T, n = !0)), -m$2 === y ? g > f ? (e[2] = K, e[3] = X, E = !0) : (e[2] = G, e[3] = C, E = !0) : m$2 === y && (g > f ? (e[2] = S, e[3] = C, E = !0) : (e[2] = Q, e[3] = X, E = !0)), n && E) return !1;
							if (f > g ? i > t ? (R$1 = this.getCardinalDirection(p, y, 4), M = this.getCardinalDirection(m$2, y, 2)) : (R$1 = this.getCardinalDirection(-p, y, 3), M = this.getCardinalDirection(-m$2, y, 1)) : i > t ? (R$1 = this.getCardinalDirection(-p, y, 1), M = this.getCardinalDirection(-m$2, y, 3)) : (R$1 = this.getCardinalDirection(p, y, 2), M = this.getCardinalDirection(m$2, y, 4)), !n) switch (R$1) {
								case 1:
						...
						var o = (e - a) * (e - a) + (f - r) * (f - r), s = 2 * ((a - i) * (e - a) + (r - g) * (f - r)), c = (a - i) * (a - i) + (r - g) * (r - g) - t * t;
						if (s * s - 4 * o * c >= 0) {
							var T = (-s + Math.sqrt(s * s - 4 * o * c)) / (2 * o), d = (-s - Math.sqrt(s * s - 4 * o * c)) / (2 * o);
							return T >= 0 && T <= 1 ? [T] : d >= 0 && d <= 1 ? [d] : null;
						} else return null;
					}, h.HALF_PI = .5 * Math.PI, h.ONE_AND_HALF_PI = 1.5 * Math.PI, h.TWO_PI = 2 * Math.PI, h.THREE_PI = 3 * Math.PI, A.exports = h;
				},
				function(A, P, N) {
					function u() {}
					u.sign = function(h) {
				...
				function(A, P, N) {
					...
					u.prototype.getX = function() {
						...
						h.constructor.name == "Point" && a == null && r == null ? (r = h, this.setLocation(r.x, r.y)) : typeof h == "number" && typeof a == "number" && r == null && (parseInt(h) == h && parseInt(a) == a ? this.move(h, a) : (this.x = Math.floor(h + .5), this.y = Math.floor(a + .5)));
				...
				function(A, P, N) {
					...
					o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
						...
						if (s == null) this.update2();
							...
							var c = s;
							if (c.getChild() != null) for (var l = c.getChild().getNodes(), T = 0; T < l.length; T++) update(l[T]);
							if (c.vGraphObject != null) c.vGraphObject.update(c);
						...
						if (s == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(!0);
						else for (var c, l, T = s.getNodes(), d = 0; d < T.length; d++) c = T[d], l = c.getChild(), l == null || l.getNodes().length == 0 ? c.scatter() : (this.positionNodesRandomly(l), c.updateBounds());
					}, o.prototype.getFlatForest = function() {
						for (var s = [], c = !0, l = this.graphManager.getRoot().getNodes(), T = !0, d = 0; d < l.length; d++) l[d].getChild() != null && (T = !1);
						if (!T) return s;
						...
						for (C = C.concat(l); C.length > 0 && c;) {
							for (L.push(C[0]); L.length > 0 && c;) {
								...
								for (var K = G.getEdges(), d = 0; d < K.length; d++) {
									...
									if (S.get(G) != X) if (!v.has(X)) L.push(X), S.set(X, G);
									else {
										c = !1;
										break;
									}
						...
						for (G = G.concat(l); !d;) {
							...
							for (var L = 0; L < c.length; L++) {
								...
								X >= 0 && c.splice(X, 1);
								S.getNeighborsList().forEach(function(n) {
									if (l.indexOf(n) < 0) {
										var p = T.get(n) - 1;
				...
				function(A, P, N) {
					...
					i.prototype.initParameters = function() {
						...
						for (var t = this.getAllEdges(), o, s = 0; s < t.length; s++) o = t[s], this.calcSpringForce(o, o.idealLength);
						...
						if (this.useFRGridVariant) for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), v = /* @__PURE__ */ new Set(), s = 0; s < d.length; s++) l = d[s], this.calculateRepulsionForceOfANode(l, v, t, o), v.add(l);
						else for (s = 0; s < d.length; s++) for (l = d[s], c = s + 1; c < d.length; c++) T = d[c], l.getOwner() == T.getOwner() && this.calcRepulsionForce(l, T);
					}, i.prototype.calcGravitationalForces = function() {
						for (var t, o = this.getAllNodesToApplyGravitation(), s = 0; s < o.length; s++) t = o[s], this.calcGravitationalForce(t);
						...
						for (var t, o = this.graphManager.getAllNodes(), s = 0; s < o.length; s++) t = o[s], t.noOfChildren = t.getNoOfChildren();
						...
						for (var v = c; v <= l; v++) for (var L = T; L <= d; L++) this.grid[v][L].push(t), t.setGridCoordinates(c, l, T, d);
					}, i.prototype.updateGrid = function() {
						var t, o, s = this.getAllNodes();
						for (this.grid = this.calcGrid(this.graphManager.getRoot()), t = 0; t < s.length; t++) o = s[t], this.addNodeToGrid(o, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
						...
						if (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && s || c) {
							...
							for (var T, d = this.grid, v = t.startX - 1; v < t.finishX + 2; v++) for (var L = t.startY - 1; L < t.finishY + 2; L++) if (!(v < 0 || L < 0 || v >= d.length || L >= d[0].length)) {
								for (var S = 0; S < d[v][L].length; S++) if (T = d[v][L][S], !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !l.has(T)) {
				...
				function(A, P, N) {
					...
					u.multMat = function(h, a) {
						...
						for (var e = [], f = [], i = [], g = 0; g < a[0].length; g++) {
							for (var t = 0, o = 0; o < a.length; o++) t += -.5 * a[o][g] * h[o];
							f[g] = t;
						}
				...
				function(A, P, N) {
					...
					u.svd = function(h) {
						...
						for (var r = function(Tt) {
							...
							if (function(Tt, Ct) {
								return Tt && Ct;
							}(f, t < i)) for (var v = t; v < this.m; v++) this.U[v][t] = h[v][t];
							if (t < g) {
								r[t] = 0;
								...
								if (r[t] = -r[t], function(Tt, Ct) {
									...
									for (var X = t + 1; X < this.n; X++) for (var Q = -r[X] / r[t + 1], O = t + 1; O < this.m; O++) h[O][X] += Q * e[O];
								}
						...
						for (var m$2 = i - 1; m$2 >= 0; m$2--) if (this.s[m$2] !== 0) {
							for (var y = m$2 + 1; y < a; y++) {
								for (var R$1 = 0, M = m$2; M < this.m; M++) R$1 += this.U[M][m$2] * this.U[M][y];
								R$1 = -R$1 / this.U[m$2][m$2];
								for (var F = m$2; F < this.m; F++) this.U[F][y] += R$1 * this.U[F][m$2];
							}
							for (var W = m$2; W < this.m; W++) this.U[W][m$2] = -this.U[W][m$2];
							this.U[m$2][m$2] = 1 + this.U[m$2][m$2];
							for (var x = 0; x < m$2 - 1; x++) this.U[x][m$2] = 0;
						} else {
							for (var Z = 0; Z < this.m; Z++) this.U[Z][m$2] = 0;
							this.U[m$2][m$2] = 1;
						}
						for (var V = this.n - 1; V >= 0; V--) {
							if (function(Tt, Ct) {
								return Tt && Ct;
							}(V < g, r[V] !== 0)) for (var Y = V + 1; Y < a; Y++) {
						...
						for (var B = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0;) {
							...
							for (q = n - 2; q >= -1 && q !== -1; q--) if (Math.abs(r[q]) <= ht + _ * (Math.abs(this.s[q]) + Math.abs(this.s[q + 1]))) {
								r[q] = 0;
								break;
							}
							if (q === n - 2) It = 4;
							...
							switch (q++, It) {
								case 1:
									var it = r[n - 2];
									r[n - 2] = 0;
									for (var gt$1 = n - 2; gt$1 >= q; gt$1--) {
										var Et = u.hypot(this.s[gt$1], it), At = this.s[gt$1] / Et, Ot = it / Et;
										this.s[gt$1] = Et, gt$1 !== q && (it = -Ot * r[gt$1 - 1], r[gt$1 - 1] = At * r[gt$1 - 1]);
										for (var mt = 0; mt < this.n; mt++) Et = At * this.V[mt][gt$1] + Ot * this.V[mt][n - 1], this.V[mt][n - 1] = -Ot * this.V[mt][gt$1] + At * this.V[mt][n - 1], this.V[mt][gt$1] = Et;
									}
									break;
								case 2:
									var Dt = r[q - 1];
									...
									for (var Rt = q; Rt < n; Rt++) {
										...
										for (var Ft = 0; Ft < this.m; Ft++) Ht = Ut * this.U[Ft][Rt] + Pt * this.U[Ft][q - 1], this.U[Ft][q - 1] = -Pt * this.U[Ft][Rt] + Ut * this.U[Ft][q - 1], this.U[Ft][Rt] = Ht;
									}
									break;
								case 3:
									...
									for (var nt = ($ + Vt) * ($ - Vt) + ct, tt = $ * J, j = q; j < n - 1; j++) {
										...
										for (var xt = 0; xt < this.n; xt++) ut = Mt * this.V[xt][j] + pt * this.V[xt][j + 1], this.V[xt][j + 1] = -pt * this.V[xt][j] + Mt * this.V[xt][j + 1], this.V[xt][j] = ut;
										if (ut = u.hypot(nt, tt), Mt = nt / ut, pt = tt / ut, this.s[j] = ut, nt = Mt * r[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * r[j] + Mt * this.s[j + 1], tt = pt * r[j + 1], r[j + 1] = Mt * r[j + 1], j < this.m - 1) for (var lt = 0; lt < this.m; lt++) ut = Mt * this.U[lt][j] + pt * this.U[lt][j + 1], this.U[lt][j + 1] = -pt * this.U[lt][j] + Mt * this.U[lt][j + 1], this.U[lt][j] = ut;
									}
									r[n - 2] = nt;
									break;
								case 4:
									...
									for (; q < B && !(this.s[q] >= this.s[q + 1]);) {
										var Lt = this.s[q];
										if (this.s[q] = this.s[q + 1], this.s[q + 1] = Lt, q < this.n - 1) for (var ft = 0; ft < this.n; ft++) Lt = this.V[ft][q + 1], this.V[ft][q + 1] = this.V[ft][q], this.V[ft][q] = Lt;
										if (q < this.m - 1) for (var st = 0; st < this.m; st++) Lt = this.U[st][q + 1], this.U[st][q + 1] = this.U[st][q], this.U[st][q] = Lt;
										q++;
									}
									n--;
									break;
					...
					A.exports = function() {
						function r(e, f) {
							...
							for (var c = 0; c < this.iMax; c++) {
								...
								for (var l = 0; l < this.jMax; l++) this.tracebackGrid[c][l] = [
									null,
									null,
									null
								];
						...
						return u(r, [
							...
							},
							{
								...
								value: function() {
									...
									for (var i = 1; i < this.iMax; i++) this.grid[i][0] = this.grid[i - 1][0] + this.gap_penalty, this.tracebackGrid[i][0] = [
										!1,
										!0,
										!1
									];
									for (var g = 1; g < this.iMax; g++) for (var t = 1; t < this.jMax; t++) {
										var o = void 0;
										this.sequence1[g - 1] === this.sequence2[t - 1] ? o = this.grid[g - 1][t - 1] + this.match_score : o = this.grid[g - 1][t - 1] + this.mismatch_penalty;
										var s = this.grid[g - 1][t] + this.gap_penalty, c = this.grid[g][t - 1] + this.gap_penalty, l = [
											o,
											s,
											c
										], T = this.arrayAllMaxIndexes(l);
										this.grid[g][t] = l[T[0]], this.tracebackGrid[g][t] = [
											T.includes(0),
											T.includes(1),
											T.includes(2)
										];
				...
				var P = {
					...
					765: ((a, r, e) => {
						...
						O.prototype.newGraphManager = function() {
							...
							f.prototype.initSpringEmbedder.call(this), this.coolingCycle = 0, this.maxCoolingCycle = this.maxIterations / l.CONVERGENCE_CHECK_PERIOD, this.finalTemperature = .04, this.coolingAdjuster = 1;
						}, O.prototype.layout = function() {
							return T.DEFAULT_CREATE_BENDS_AS_NEEDED && (this.createBendpoints(), this.graphManager.resetAllEdges()), this.level = 0, this.classicLayout();
							...
							if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
								if (s.TREE_REDUCTION_ON_INCREMENTAL) {
									...
									var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(R$1) {
										return E.has(R$1);
									});
								...
								if (n.length > 0) this.positionNodesRadially(n);
									...
									this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
									var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(m$2) {
										return E.has(m$2);
									});
							...
							var p = !this.isTreeGrowing && !this.isGrowthFinished, m$2 = this.growTreeIterations % 10 == 1 && this.isTreeGrowing || this.afterGrowthIterations % 10 == 1 && this.isGrowthFinished;
							return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(p, m$2), this.calcGravitationalForces(), this.moveNodes(), this.animate(), !1;
						}, O.prototype.getPositionsData = function() {
							for (var n = this.graphManager.getAllNodes(), E = {}, p = 0; p < n.length; p++) {
								var m$2 = n[p].rect, y = n[p].id;
								E[y] = {
									id: y,
									x: m$2.getCenterX(),
									y: m$2.getCenterY(),
							...
							for (var n = this.getAllNodes(), E, p = 0; p < n.length; p++) E = n[p], E.calculateDisplacement();
							...
							for (var E = this.graphManager.getAllNodes(), p = 0; p < E.length; p++) {
								var m$2 = E[p];
								this.idToNodeMap.set(m$2.id, m$2);
							}
							var y = function w(H) {
								for (var B = H.getChild().getNodes(), _, ht = 0, q = 0; q < B.length; q++) _ = B[q], _.getChild() == null ? n.fixedNodeSet.has(_.id) && (ht += 100) : ht += w(_);
								return ht;
							};
							if (this.constraints.fixedNodeConstraint) {
								...
								for (var E = this.graphManager.getAllNodes(), m$2, p = 0; p < E.length; p++) if (m$2 = E[p], m$2.getChild() != null) {
									var R$1 = y(m$2);
									R$1 > 0 && (m$2.fixedNodeWeight = R$1);
								}
							}
							if (this.constraints.relativePlacementConstraint) {
								...
								if (this.dummyToNodeForVerticalAlignment = /* @__PURE__ */ new Map(), this.dummyToNodeForHorizontalAlignment = /* @__PURE__ */ new Map(), this.fixedNodesOnHorizontal = /* @__PURE__ */ new Set(), this.fixedNodesOnVertical = /* @__PURE__ */ new Set(), this.fixedNodeSet.forEach(function(w) {
									...
									if (this.constraints.alignmentConstraint.vertical) for (var W = this.constraints.alignmentConstraint.vertical, p = 0; p < W.length; p++) this.dummyToNodeForVerticalAlignment.set("dummy" + p, []), W[p].forEach(function(H) {
									...
									if (this.constraints.alignmentConstraint.horizontal) for (var x = this.constraints.alignmentConstraint.horizontal, p = 0; p < x.length; p++) this.dummyToNodeForHorizontalAlignment.set("dummy" + p, []), x[p].forEach(function(H) {
								...
								if (s.RELAX_MOVEMENT_ON_CONSTRAINTS) this.shuffle = function(w) {
									var H, B, _;
									for (_ = w.length - 1; _ >= 2 * w.length / 3; _--) H = Math.floor(Math.random() * (_ + 1)), B = w[_], w[_] = w[H], w[H] = B;
									return w;
									...
									if (w.left) {
										...
										n.nodesInRelativeHorizontal.includes(H) || (n.nodesInRelativeHorizontal.push(H), n.nodeToRelativeConstraintMapHorizontal.set(H, []), n.dummyToNodeForVerticalAlignment.has(H) ? n.nodeToTempPositionMapHorizontal.set(H, n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get(H)[0]).getCenterX()) : n.nodeToTempPositionMapHorizontal.set(H, n.idToNodeMap.get(H).getCenterX())), n.nodesInRelativeHorizontal.includes(B) || (n.nodesInRelativeHorizontal.push(B), n.nodeToRelativeConstraintMapHorizontal.set(B, []), n.dummyToNodeForVerticalAlignment.has(B) ? n.nodeToTempPositionMapHorizontal.set(B, n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get(B)[0]).getCenterX()) : n.nodeToTempPositionMapHorizontal.set(B, n.idToNodeMap.get(B).getCenterX())), n.nodeToRelativeConstraintMapHorizontal.get(H).push({
											right: B,
											gap: w.gap
										}), n.nodeToRelativeConstraintMapHorizontal.get(B).push({
											left: H,
											gap: w.gap
										});
									} else {
										...
										n.nodesInRelativeVertical.includes(_) || (n.nodesInRelativeVertical.push(_), n.nodeToRelativeConstraintMapVertical.set(_, []), n.dummyToNodeForHorizontalAlignment.has(_) ? n.nodeToTempPositionMapVertical.set(_, n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(_)[0]).getCenterY()) : n.nodeToTempPositionMapVertical.set(_, n.idToNodeMap.get(_).getCenterY())), n.nodesInRelativeVertical.includes(ht) || (n.nodesInRelativeVertical.push(ht), n.nodeToRelativeConstraintMapVertical.set(ht, []), n.dummyToNodeForHorizontalAlignment.has(ht) ? n.nodeToTempPositionMapVertical.set(ht, n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(ht)[0]).getCenterY()) : n.nodeToTempPositionMapVertical.set(ht, n.idToNodeMap.get(ht).getCenterY())), n.nodeToRelativeConstraintMapVertical.get(_).push({
											bottom: ht,
											gap: w.gap
										}), n.nodeToRelativeConstraintMapVertical.get(ht).push({
											top: _,
											gap: w.gap
										});
									}
									...
									var Y = function(H, B) {
										...
										return H.forEach(function(vt, it) {
											if (!It.has(it)) {
												_[Nt] = [], ht[Nt] = !1;
												var gt$1 = it;
												for (q.push(gt$1), It.add(gt$1), _[Nt].push(gt$1); q.length != 0;) {
													gt$1 = q.shift(), B.has(gt$1) && (ht[Nt] = !0);
													H.get(gt$1).forEach(function(At) {
							...
							if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(z) {
								...
								if (this.constraints.alignmentConstraint.vertical) for (var E = this.constraints.alignmentConstraint.vertical, p = 0; p < E.length; p++) {
									for (var m$2 = 0, y = 0; y < E[p].length; y++) {
										if (this.fixedNodeSet.has(E[p][y])) {
											m$2 = 0;
											break;
										}
										m$2 += this.idToNodeMap.get(E[p][y]).displacementX;
									}
									for (var R$1 = m$2 / E[p].length, y = 0; y < E[p].length; y++) this.idToNodeMap.get(E[p][y]).displacementX = R$1;
								}
								if (this.constraints.alignmentConstraint.horizontal) for (var M = this.constraints.alignmentConstraint.horizontal, p = 0; p < M.length; p++) {
									...
									for (var W = F / M[p].length, y = 0; y < M[p].length; y++) this.idToNodeMap.get(M[p][y]).displacementY = W;
								}
							}
							if (this.constraints.relativePlacementConstraint) if (s.RELAX_MOVEMENT_ON_CONSTRAINTS) this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(z) {
								...
								for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
									...
									if (this.fixedComponentsOnHorizontal[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
										n.idToNodeMap.get(H).displacementX = 0;
									}) : this.idToNodeMap.get(x[y]).displacementX = 0;
									else {
										for (var Z = 0, V = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
											var Y = this.dummyToNodeForVerticalAlignment.get(x[y]);
											Z += Y.length * this.idToNodeMap.get(Y[0]).displacementX, V += Y.length;
										} else Z += this.idToNodeMap.get(x[y]).displacementX, V++;
										for (var et = Z / V, y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
								...
								for (var p = 0; p < this.componentsOnVertical.length; p++) {
									...
									if (this.fixedComponentsOnVertical[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(B) {
										n.idToNodeMap.get(B).displacementY = 0;
									}) : this.idToNodeMap.get(x[y]).displacementY = 0;
									else {
										for (var Z = 0, V = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
											var Y = this.dummyToNodeForHorizontalAlignment.get(x[y]);
											Z += Y.length * this.idToNodeMap.get(Y[0]).displacementY, V += Y.length;
										} else Z += this.idToNodeMap.get(x[y]).displacementY, V++;
										for (var et = Z / V, y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(q) {
							...
							var n = [], E, p = this.graphManager.getGraphs(), m$2 = p.length, y;
							for (y = 0; y < m$2; y++) E = p[y], E.updateConnected(), E.isConnected || (n = n.concat(E.getNodes()));
							return n;
							...
							for (p = 0; p < n.length; p++) {
								var m$2 = n[p];
								if (!E.has(m$2)) {
									var y = m$2.getSource(), R$1 = m$2.getTarget();
									if (y == R$1) m$2.getBendpoints().push(new v()), m$2.getBendpoints().push(new v()), this.createDummyNodesForBendpoints(m$2), E.add(m$2);
									else {
										var M = [];
										if (M = M.concat(y.getEdgeListToNode(R$1)), M = M.concat(R$1.getEdgeListToNode(y)), !E.has(M[0])) {
											if (M.length > 1) {
												var F;
							...
							for (var E = new d(0, 0), p = Math.ceil(Math.sqrt(n.length)), m$2 = 0, y = 0, R$1 = 0, M = new v(0, 0), F = 0; F < n.length; F++) {
								F % p == 0 && (R$1 = 0, y = m$2, F != 0 && (y += s.DEFAULT_COMPONENT_SEPERATION), m$2 = 0);
								var W = n[F], x = S.findCenterOfTree(W);
								E.x = R$1, E.y = y, M = O.radialLayout(W, x, E), M.y > m$2 && (m$2 = Math.floor(M.y)), R$1 = Math.floor(M.x + s.DEFAULT_COMPONENT_SEPERATION);
							}
							this.transform(new v(T.WORLD_CENTER_X - M.x / 2, T.WORLD_CENTER_Y - M.y / 2));
						}, O.radialLayout = function(n, E, p) {
							var m$2 = Math.max(this.maxDiagonalInTree(n), s.DEFAULT_RADIAL_SEPARATION);
							O.branchRadialLayout(E, null, 0, 359, 0, m$2);
							var y = K.calculateBounds(n), R$1 = new X();
							R$1.setDeviceOrgX(y.getMinX()), R$1.setDeviceOrgY(y.getMinY()), R$1.setWorldOrgX(p.x), R$1.setWorldOrgY(p.y);
							for (var M = 0; M < n.length; M++) n[M].transform(R$1);
							var W = new v(y.getMaxX(), y.getMaxY());
							return R$1.inverseTransformPoint(W);
						}, O.branchRadialLayout = function(n, E, p, m$2, y, R$1) {
							var M = (m$2 - p + 1) / 2;
							M < 0 && (M += 180);
							var W = (M + p) % 360 * G.TWO_PI / 360, x = y * Math.cos(W), Z = y * Math.sin(W);
							n.setCenter(x, Z);
							var V = [];
							...
							for (var p = [], m$2 = this.graphManager.getAllNodes(), y = 0; y < m$2.length; y++) {
								var R$1 = m$2[y], M = R$1.getParent();
								this.getNodeDegreeWithChildren(R$1) === 0 && (M.id == null || !this.getToBeTiled(M)) && p.push(R$1);
							}
							for (var y = 0; y < p.length; y++) {
								var R$1 = p[y], F = R$1.getParent().id;
								typeof E[F] > "u" && (E[F] = []), E[F] = E[F].concat(R$1);
							}
							...
							for (var p = 0; p < this.compoundOrder.length; p++) E[this.compoundOrder[p].id] = this.compoundOrder[p], n[this.compoundOrder[p].id] = [].concat(this.compoundOrder[p].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[p].getChild()), this.compoundOrder[p].child = null;
							...
							Object.keys(this.memberGroups).forEach(function(p) {
								var m$2 = n.idToDummyNode[p];
								if (E[p] = n.tileNodes(n.memberGroups[p], m$2.paddingLeft + m$2.paddingRight), m$2.rect.width = E[p].width, m$2.rect.height = E[p].height, m$2.setCenter(E[p].centerX, E[p].centerY), m$2.labelMarginLeft = 0, m$2.labelMarginTop = 0, s.NODE_DIMENSIONS_INCLUDE_LABELS) {
									var y = m$2.rect.width, R$1 = m$2.rect.height;
									m$2.labelWidth && (m$2.labelPosHorizontal == "left" ? (m$2.rect.x -= m$2.labelWidth, m$2.setWidth(y + m$2.labelWidth), m$2.labelMarginLeft = m$2.labelWidth) : m$2.labelPosHorizontal == "center" && m$2.labelWidth > y ? (m$2.rect.x -= (m$2.labelWidth - y) / 2, m$2.setWidth(m$2.labelWidth), m$2.labelMarginLeft = (m$2.labelWidth - y) / 2) : m$2.labelPosHorizontal == "right" && m$2.setWidth(y + m$2.labelWidth)), m$2.labelHeight && (m$2.labelPosVertical == "top" ? (m$2.rect.y -= m$2.labelHeight, m$2.setHeight(R$1 + m$2.labelHeight), m$2.labelMarginTop = m$2.labelHeight) : m$2.labelPosVertical == "center" && m$2.labelHeight > R$1 ? (m$2.rect.y -= (m$2.labelHeight - R$1) / 2, m$2.setHeight(m$2.labelHeight), m$2.labelMarginTop = (m$2.labelHeight - R$1) / 2) : m$2.labelPosVertical == "bottom" && m$2.setHeight(R$1 + m$2.labelHeight));
								}
							});
						}, O.prototype.repopulateCompounds = function() {
							for (var n = this.compoundOrder.length - 1; n >= 0; n--) {
								var E = this.compoundOrder[n], p = E.id, m$2 = E.paddingLeft, y = E.paddingTop, R$1 = E.labelMarginLeft, M = E.labelMarginTop;
								this.adjustLocations(this.tiledMemberPack[p], E.rect.x, E.rect.y, m$2, y, R$1, M);
							}
						}, O.prototype.repopulateZeroDegreeMembers = function() {
							var n = this, E = this.tiledZeroDegreePack;
							Object.keys(E).forEach(function(p) {
								var m$2 = n.idToDummyNode[p], y = m$2.paddingLeft, R$1 = m$2.paddingTop, M = m$2.labelMarginLeft, F = m$2.labelMarginTop;
								n.adjustLocations(E[p], m$2.rect.x, m$2.rect.y, y, R$1, M, F);
							});
							...
							for (var m$2 = p.getNodes(), y = 0; y < m$2.length; y++) {
								var R$1 = m$2[y];
								if (this.getNodeDegree(R$1) > 0) return this.toBeTiled[E] = !1, !1;
								if (R$1.getChild() == null) {
									this.toBeTiled[R$1.id] = !1;
									continue;
								}
								if (!this.getToBeTiled(R$1)) return this.toBeTiled[E] = !1, !1;
							}
							return this.toBeTiled[E] = !0, !0;
						}, O.prototype.getNodeDegree = function(n) {
							n.id;
							for (var E = n.getEdges(), p = 0, m$2 = 0; m$2 < E.length; m$2++) {
								var y = E[m$2];
							...
							for (var p = n.getChild().getNodes(), m$2 = 0; m$2 < p.length; m$2++) {
								var y = p[m$2];
						...
						}, O.prototype.adjustLocations = function(n, E, p, m$2, y, R$1, M) {
							E += m$2 + R$1, p += y + M;
							...
							var p = this;
							this.tiledMemberPack = [], Object.keys(n).forEach(function(m$2) {
								var y = E[m$2];
								if (p.tiledMemberPack[m$2] = p.tileNodes(n[m$2], y.paddingLeft + y.paddingRight), y.rect.width = p.tiledMemberPack[m$2].width, y.rect.height = p.tiledMemberPack[m$2].height, y.setCenter(p.tiledMemberPack[m$2].centerX, p.tiledMemberPack[m$2].centerY), y.labelMarginLeft = 0, y.labelMarginTop = 0, s.NODE_DIMENSIONS_INCLUDE_LABELS) {
									var R$1 = y.rect.width, M = y.rect.height;
									y.labelWidth && (y.labelPosHorizontal == "left" ? (y.rect.x -= y.labelWidth, y.setWidth(R$1 + y.labelWidth), y.labelMarginLeft = y.labelWidth) : y.labelPosHorizontal == "center" && y.labelWidth > R$1 ? (y.rect.x -= (y.labelWidth - R$1) / 2, y.setWidth(y.labelWidth), y.labelMarginLeft = (y.labelWidth - R$1) / 2) : y.labelPosHorizontal == "right" && y.setWidth(R$1 + y.labelWidth)), y.labelHeight && (y.labelPosVertical == "top" ? (y.rect.y -= y.labelHeight, y.setHeight(M + y.labelHeight), y.labelMarginTop = y.labelHeight) : y.labelPosVertical == "center" && y.labelHeight > M ? (y.rect.y -= (y.labelHeight - M) / 2, y.setHeight(y.labelHeight), y.labelMarginTop = (y.labelHeight - M) / 2) : y.labelPosVertical == "bottom" && y.setHeight(M + y.labelHeight));
								}
							});
						}, O.prototype.tileNodes = function(n, E) {
							var p = this.tileNodesByFavoringDim(n, E, !0), m$2 = this.tileNodesByFavoringDim(n, E, !1), y = this.getOrgRatio(p), R$1 = this.getOrgRatio(m$2), M;
							return R$1 < y ? M = m$2 : M = p, M;
						}, O.prototype.getOrgRatio = function(n) {
							var m$2 = n.width / n.height;
							return m$2 < 1 && (m$2 = 1 / m$2), m$2;
						}, O.prototype.calcIdealRowWidth = function(n, E) {
							var p = s.TILING_PADDING_VERTICAL, m$2 = s.TILING_PADDING_HORIZONTAL, y = n.length, R$1 = 0, M = 0, F = 0;
							n.forEach(function(z) {
								R$1 += z.getWidth(), M += z.getHeight(), z.getWidth() > F && (F = z.getWidth());
							});
							var W = R$1 / y, x = M / y, Z = Math.pow(p - m$2, 2) + 4 * (W + m$2) * (x + p) * y, V = (m$2 - p + Math.sqrt(Z)) / (2 * (W + m$2)), Y;
							E ? (Y = Math.ceil(V), Y == V && Y++) : Y = Math.floor(V);
							var et = Y * (W + m$2) - m$2;
							return F > et && (et = F), et += m$2 * 2, et;
						}, O.prototype.tileNodesByFavoringDim = function(n, E, p) {
							var m$2 = s.TILING_PADDING_VERTICAL, y = s.TILING_PADDING_HORIZONTAL, R$1 = s.TILING_COMPARE_BY, M = {
								rows: [],
								rowWidth: [],
								rowHeight: [],
								width: 0,
							...
							R$1 && (M.idealRowWidth = this.calcIdealRowWidth(n, p));
							var F = function(w) {
							...
							n.sort(function(z, w) {
								var H = W;
								return M.idealRowWidth ? (H = R$1, H(z.id, w.id)) : H(z, w);
							});
							...
							for (var V = 0; V < n.length; V++) {
								var Y = n[V];
								if (M.rows.length == 0) this.insertNodeToRow(M, Y, 0, E);
								...
								} else this.insertNodeToRow(M, Y, M.rows.length, E);
								this.shiftToLastRow(M);
							}
							return M;
						}, O.prototype.insertNodeToRow = function(n, E, p, m$2) {
							var y = m$2;
							if (p == n.rows.length) n.rows.push([]), n.rowWidth.push(y), n.rowHeight.push(0);
							...
							for (var E = -1, p = Number.MAX_VALUE, m$2 = 0; m$2 < n.rows.length; m$2++) n.rowWidth[m$2] < p && (E = m$2, p = n.rowWidth[m$2]);
							return E;
						}, O.prototype.getLongestRowIndex = function(n) {
							for (var E = -1, p = Number.MIN_VALUE, m$2 = 0; m$2 < n.rows.length; m$2++) n.rowWidth[m$2] > p && (E = m$2, p = n.rowWidth[m$2]);
							return E;
						}, O.prototype.canAddHorizontal = function(n, E, p) {
							if (n.idealRowWidth) {
								var m$2 = n.rows.length - 1;
								return n.rowWidth[m$2] + E + n.horizontalPadding <= n.idealRowWidth;
							}
							var R$1 = this.getShortestRowIndex(n);
							if (R$1 < 0) return !0;
							var M = n.rowWidth[R$1];
							if (M + n.horizontalPadding + E <= n.width) return !0;
							var F = 0;
							n.rowHeight[R$1] < p && R$1 > 0 && (F = p + n.verticalPadding - n.rowHeight[R$1]);
							var W;
							...
							var E = this.getLongestRowIndex(n), p = n.rowWidth.length - 1, m$2 = n.rows[E], y = m$2[m$2.length - 1], R$1 = y.width + n.horizontalPadding;
							if (n.width - n.rowWidth[p] > R$1 && E != p) {
								m$2.splice(-1, 1), n.rows[p].push(y), n.rowWidth[E] = n.rowWidth[E] - R$1, n.rowWidth[p] = n.rowWidth[p] + R$1, n.width = n.rowWidth[instance.getLongestRowIndex(n)];
								for (var M = Number.MIN_VALUE, F = 0; F < m$2.length; F++) m$2[F].height > M && (M = m$2[F].height);
							...
							for (var n = [], E = !0, p; E;) {
								var m$2 = this.graphManager.getAllNodes(), y = [];
								E = !1;
								for (var R$1 = 0; R$1 < m$2.length; R$1++) if (p = m$2[R$1], p.getEdges().length == 1 && !p.getEdges()[0].isInterGraph && p.getChild() == null) {
								...
								if (E == !0) {
									for (var W = [], x = 0; x < y.length; x++) y[x][0].getEdges().length == 1 && (W.push(y[x]), y[x][0].getOwner().remove(y[x][0]));
							...
							for (var p = n[n.length - 1], m$2, y = 0; y < p.length; y++) m$2 = p[y], this.findPlaceforPrunedNode(m$2), m$2[2].add(m$2[0]), m$2[2].add(m$2[1], m$2[1].source, m$2[1].target);
							...
							var E, p, m$2 = n[0];
							if (m$2 == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL) m$2.setCenter(p.getCenterX() + n[3].getWidth(), p.getCenterY() + n[3].getHeight());
							else {
								var y = p.startX, R$1 = p.finishX, M = p.startY, F = p.finishY, Y = [
									0,
									0,
									0,
									0
								];
								if (M > 0) for (var et = y; et <= R$1; et++) Y[0] += this.grid[et][M - 1].length + this.grid[et][M].length - 1;
								if (R$1 < this.grid.length - 1) for (var et = M; et <= F; et++) Y[1] += this.grid[R$1 + 1][et].length + this.grid[R$1][et].length - 1;
								if (F < this.grid[0].length - 1) for (var et = y; et <= R$1; et++) Y[2] += this.grid[et][F + 1].length + this.grid[et][F].length - 1;
								if (y > 0) for (var et = M; et <= F; et++) Y[3] += this.grid[y - 1][et].length + this.grid[y][et].length - 1;
								for (var z = C.MAX_VALUE, w, H, B = 0; B < Y.length; B++) Y[B] < z ? (z = Y[B], w = 1, H = B) : Y[B] == z && w++;
								if (w == 3 && z == 0) Y[0] == 0 && Y[1] == 0 && Y[2] == 0 ? E = 1 : Y[0] == 0 && Y[1] == 0 && Y[3] == 0 ? E = 0 : Y[0] == 0 && Y[2] == 0 && Y[3] == 0 ? E = 3 : Y[1] == 0 && Y[2] == 0 && Y[3] == 0 && (E = 2);
								else if (w == 2 && z == 0) {
								...
								E == 0 ? m$2.setCenter(p.getCenterX(), p.getCenterY() - p.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - m$2.getHeight() / 2) : E == 1 ? m$2.setCenter(p.getCenterX() + p.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + m$2.getWidth() / 2, p.getCenterY()) : E == 2 ? m$2.setCenter(p.getCenterX(), p.getCenterY() + p.getHeight() / 2 + l.DEFAULT_EDGE_LENGTH + m$2.getHeight() / 2) : m$2.setCenter(p.getCenterX() - p.getWidth() / 2 - l.DEFAULT_EDGE_LENGTH - m$2.getWidth() / 2, p.getCenterY());
							}
						}, a.exports = O;
					}),
					991: ((a, r, e) => {
						...
						g.prototype.calculateDisplacement = function() {
							...
							for (var c = this.getChild().getNodes(), l, T = 0; T < c.length; T++) l = c[T], l.getChild() == null ? (l.displacementX += o, l.displacementY += s) : l.propogateDisplacementToChildren(o, s);
					...
					902: ((a, r, e) => {
						...
						s.handleConstraints = function(c) {
							...
							for (var T = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), v = [], L = [], S = c.getAllNodes(), C = 0, G = 0; G < S.length; G++) {
								var K = S[G];
								K.getChild() ?? (d.set(K.id, C++), v.push(K.getCenterX()), L.push(K.getCenterY()), T.set(K.id, K));
							}
							...
							var X = function(U, $) {
								...
								function ct(lt, ot) {
									var Lt = new Set(lt), ft = !0, st = !1, Xt$1 = void 0;
									try {
								...
								for (var Mt = function() {
									var ot = ut.shift();
									U.get(ot).forEach(function(ft) {
										if (tt.get(ft.id) < tt.get(ot) + ft.gap) if (J && J.has(ft.id)) {
											var st = void 0;
											if ($ == "horizontal" ? st = d.has(ft.id) ? v[d.get(ft.id)] : k.get(ft.id) : st = d.has(ft.id) ? L[d.get(ft.id)] : k.get(ft.id), tt.set(ft.id, st), st < tt.get(ot) + ft.gap) {
												var Xt$1 = tt.get(ot) + ft.gap - st;
												j.get(ot).forEach(function(Tt) {
													tt.set(Tt, tt.get(Tt) - Xt$1);
												});
											}
								...
								if (J) {
									...
									j.forEach(function(lt, ot) {
										if (pt.has(ot)) {
											var Lt = !1, ft = !0, st = !1, Xt$1 = void 0;
											try {
										...
										var Lt = Number.POSITIVE_INFINITY, ft = Number.POSITIVE_INFINITY, st = Number.NEGATIVE_INFINITY, Xt$1 = Number.NEGATIVE_INFINITY, Tt = !0, Ct = !1, Bt = void 0;
										try {
											for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
												...
												var Kt = tt.get(St);
												kt < Lt && (Lt = kt), kt > st && (st = kt), Kt < ft && (ft = Kt), Kt > Xt$1 && (Xt$1 = Kt);
											}
										} catch (ee) {
											Ct = !0, Bt = ee;
										} finally {
										...
										var he = (Lt + st) / 2 - (ft + Xt$1) / 2, Qt = !0, jt = !1, _t = void 0;
										try {
								...
								}), $ > J && k > at) for (var ct = 0; ct < d.size; ct++) v[ct] = -1 * v[ct], L[ct] = -1 * L[ct];
								else if ($ > J) for (var nt = 0; nt < d.size; nt++) v[nt] = -1 * v[nt];
							...
							}, m$2 = [], y = [], R$1 = !1, M = !1, F = /* @__PURE__ */ new Set(), W = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), Z = [];
							if (l.fixedNodeConstraint && l.fixedNodeConstraint.forEach(function(b) {
								F.add(b.nodeId);
							}), l.relativePlacementConstraint && (l.relativePlacementConstraint.forEach(function(b) {
								b.left ? (W.has(b.left) ? W.get(b.left).push({
									id: b.right,
									gap: b.gap,
									...
									gap: b.gap,
									direction: "horizontal"
								}]), W.has(b.right) || W.set(b.right, [])) : (W.has(b.top) ? W.get(b.top).push({
									id: b.bottom,
									gap: b.gap,
									direction: "vertical"
								}) : W.set(b.top, [{
								...
								if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1) l.fixedNodeConstraint.forEach(function(b, U) {
									m$2[U] = [b.position.x, b.position.y], y[U] = [v[d.get(b.nodeId)], L[d.get(b.nodeId)]];
								}), R$1 = !0;
									...
									if (l.alignmentConstraint.vertical) {
										for (var U = l.alignmentConstraint.vertical, $ = function(tt) {
											...
											ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = Q(j).x, U[tt].forEach(function(pt) {
												m$2[b] = [Mt, L[d.get(pt)]], y[b] = [v[d.get(pt)], L[d.get(pt)]], b++;
											});
										}, J = 0; J < U.length; J++) $(J);
										R$1 = !0;
									}
									if (l.alignmentConstraint.horizontal) {
										for (var k = l.alignmentConstraint.horizontal, at = function(tt) {
											...
											ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = Q(j).y, k[tt].forEach(function(pt) {
												m$2[b] = [v[d.get(pt)], Mt], y[b] = [v[d.get(pt)], L[d.get(pt)]], b++;
											});
										}, ct = 0; ct < k.length; ct++) at(ct);
										R$1 = !0;
									}
									l.relativePlacementConstraint && (M = !0);
								})();
								else if (l.relativePlacementConstraint) {
									for (var V = 0, Y = 0, et = 0; et < Z.length; et++) Z[et].length > V && (V = Z[et].length, Y = et);
									if (V < x.size / 2) rt(l.relativePlacementConstraint), R$1 = !1, M = !1;
									else {
										var z = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), H = [];
										Z[Y].forEach(function(b) {
											W.get(b).forEach(function(U) {
												U.direction == "horizontal" ? (z.has(b) ? z.get(b).push(U) : z.set(b, [U]), z.has(U.id) || z.set(U.id, []), H.push({
													left: b,
													right: U.id
												})) : (w.has(b) ? w.get(b).push(U) : w.set(b, [U]), w.has(U.id) || w.set(U.id, []), H.push({
													top: b,
													bottom: U.id
												}));
											});
										...
										Z[Y].forEach(function(b, U) {
											y[U] = [v[d.get(b)], L[d.get(b)]], m$2[U] = [], B.has(b) ? m$2[U][0] = B.get(b) : m$2[U][0] = v[d.get(b)], _.has(b) ? m$2[U][1] = _.get(b) : m$2[U][1] = L[d.get(b)];
										}), R$1 = !0;
									}
								}
								if (R$1) {
									for (var ht = void 0, q = t.transpose(m$2), It = t.transpose(y), Nt = 0; Nt < q.length; Nt++) q[Nt] = t.multGamma(q[Nt]), It[Nt] = t.multGamma(It[Nt]);
									var vt = t.multMat(q, t.transpose(It)), it = o.svd(vt);
									ht = t.multMat(it.V, t.transpose(it.U));
									for (var gt$1 = 0; gt$1 < d.size; gt$1++) {
										var Et = [v[gt$1], L[gt$1]], At = [ht[0][0], ht[1][0]], Ot = [ht[0][1], ht[1][1]];
										v[gt$1] = t.dotProduct(Et, At), L[gt$1] = t.dotProduct(Et, Ot);
									}
							...
							if (i.ENFORCE_CONSTRAINTS) {
								...
								if (l.alignmentConstraint) {
									if (l.alignmentConstraint.vertical) for (var Dt = l.alignmentConstraint.vertical, Rt = function(U) {
									...
									}, Ht = 0; Ht < Dt.length; Ht++) Rt(Ht);
									if (l.alignmentConstraint.horizontal) for (var Ut = l.alignmentConstraint.horizontal, Pt = function(U) {
										var $ = /* @__PURE__ */ new Set();
								...
								l.relativePlacementConstraint && function() {
									...
									if (F.forEach(function(Gt) {
										...
										if (l.alignmentConstraint.vertical) for (var tt = l.alignmentConstraint.vertical, j = function(yt$1) {
											$.set("dummy" + yt$1, []), tt[yt$1].forEach(function(wt) {
												b.set(wt, "dummy" + yt$1), $.get("dummy" + yt$1).push(wt), F.has(wt) && ct.add("dummy" + yt$1);
											}), k.set("dummy" + yt$1, v[d.get(tt[yt$1][0])]);
										}, ut = 0; ut < tt.length; ut++) j(ut);
										if (l.alignmentConstraint.horizontal) for (var Mt = l.alignmentConstraint.horizontal, pt = function(yt$1) {
											J.set("dummy" + yt$1, []), Mt[yt$1].forEach(function(wt) {
												U.set(wt, "dummy" + yt$1), J.get("dummy" + yt$1).push(wt), F.has(wt) && nt.add("dummy" + yt$1);
											}), at.set("dummy" + yt$1, L[d.get(Mt[yt$1][0])]);
										}, xt = 0; xt < Mt.length; xt++) pt(xt);
									}
									var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt$1) {
										W.get(yt$1).forEach(function(wt) {
											var Zt = void 0, $t = void 0;
											wt.direction == "horizontal" ? (Zt = b.get(yt$1) ? b.get(yt$1) : yt$1, b.get(wt.id) ? $t = {
												id: b.get(wt.id),
												gap: wt.gap,
												direction: wt.direction
											} : $t = wt, lt.has(Zt) ? lt.get(Zt).push($t) : lt.set(Zt, [$t]), lt.has($t.id) || lt.set($t.id, [])) : (Zt = U.get(yt$1) ? U.get(yt$1) : yt$1, U.get(wt.id) ? $t = {
												id: U.get(wt.id),
												gap: wt.gap,
												direction: wt.direction
											} : $t = wt, ot.has(Zt) ? ot.get(Zt).push($t) : ot.set(Zt, [$t]), ot.has($t.id) || ot.set($t.id, []));
										});
									}, ft = !0, st = !1, Xt$1 = void 0;
									try {
									...
									St.forEach(function(Gt, yt$1) {
										Qt[yt$1] = [], Gt.forEach(function(wt) {
											Kt.get(wt).length == 0 && Qt[yt$1].push(wt);
										});
									}), kt.forEach(function(Gt, yt$1) {
										jt[yt$1] = [], Gt.forEach(function(wt) {
											he.get(wt).length == 0 && jt[yt$1].push(wt);
										});
									});
									var _t = O(lt, "horizontal", ct, k, Qt), Jt = O(ot, "vertical", nt, at, jt), oe = function(yt$1) {
										$.get(yt$1) ? $.get(yt$1).forEach(function(wt) {
											v[d.get(wt)] = _t.get(yt$1);
										}) : v[d.get(yt$1)] = _t.get(yt$1);
									}, te = !0, ee = !1, Ne = void 0;
									try {
									...
									var $e = function(yt$1) {
										J.get(yt$1) ? J.get(yt$1).forEach(function(wt) {
											L[d.get(wt)] = Jt.get(yt$1);
										}) : L[d.get(yt$1)] = Jt.get(yt$1);
									}, ce = !0, Ce = !1, Ae = void 0;
									try {
							...
							for (var Yt = 0; Yt < S.length; Yt++) {
								var Vt = S[Yt];
								Vt.getChild() ?? Vt.setCenter(v[d.get(Vt.id)], L[d.get(Vt.id)]);
							}
						}, a.exports = s;
					}),
					551: ((a) => {
			...
			var P = {
				658: ((a) => {
					a.exports = Object.assign != null ? Object.assign.bind(Object) : function(r) {
						for (var e = arguments.length, f = Array(e > 1 ? e - 1 : 0), i = 1; i < e; i++) f[i - 1] = arguments[i];
				...
				548: ((a, r, e) => {
					...
					g.getTopMostNodes = function(t) {
						...
						var l = new i(), T = /* @__PURE__ */ new Set(), d = [], v = void 0, L = void 0, S = void 0, C = !1, G = 1, K = [], X = [], Q = function() {
							...
							for (var p = function() {
								n = l.shift();
								var R$1 = t.collection();
								n.neighborhood().nodes().forEach(function(x) {
									o.intersection(n.edgesWith(x)).length > 0 && R$1.merge(x);
								});
								for (var M = 0; M < R$1.length; M++) {
									var F = R$1[M];
									if (v = s.intersection(F.union(F.ancestors())), v != null && !T.has(v[0])) v.union(v.descendants()).forEach(function(x) {
										l.push(x), T.add(x), rt.merge(x), s.has(x) && d.push(x);
									});
								}
							}; l.length != 0;) p();
							if (rt.forEach(function(y) {
								o.intersection(y.connectedEdges()).forEach(function(R$1) {
									rt.has(R$1.source()) && rt.has(R$1.target()) && rt.merge(R$1);
								});
								...
								var m$2 = t.collection();
								m$2.merge(d[0]), d.forEach(function(y) {
									m$2.merge(y);
								}), d = [], s = s.difference(m$2), G++;
							}
						};
						do
							Q();
							...
							if (s.quality == "draft") {
								...
								try {
									for (var C = o.nodeIndexes[Symbol.iterator](), G; !(v = (G = C.next()).done); v = !0) {
										...
										if (rt) {
											var n = rt.boundingBox(), E = o.xCoords[O] - n.w / 2, p = o.xCoords[O] + n.w / 2, m$2 = o.yCoords[O] - n.h / 2, y = o.yCoords[O] + n.h / 2;
											E < c && (c = E), p > l && (l = p), m$2 < T && (T = m$2), y > d && (d = y);
										}
									}
								} catch (x) {
									L = !0, S = x;
				...
				816: ((a, r, e) => {
					var f = e(548), i = e(140).CoSELayout, g = e(140).CoSENode, t = e(140).layoutBase.PointD, o = e(140).layoutBase.DimensionD, s = e(140).layoutBase.LayoutConstants, c = e(140).layoutBase.FDLayoutConstants, l = e(140).CoSEConstants, T = function(v, L) {
						...
						var n = function(x) {
							...
							return n(x) ? x(Z) : x;
						}, p = f.calcParentsWithoutChildren(S, C), m$2 = function W(x, Z, V, Y) {
							for (var et = Z.length, z = 0; z < et; z++) {
								var w = Z[z], H = null;
								w.intersection(p).length == 0 && (H = w.children());
								var B = void 0, _ = w.layoutDimensions({ nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels });
								if (w.outerWidth() != null && w.outerHeight() != null) if (Y.randomize) if (!w.isParent()) B = x.add(new g(V.graphManager, new t(Q[X.get(w.id())] - _.w / 2, O[X.get(w.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
								else {
								...
								else B = x.add(new g(V.graphManager, new t(w.position("x") - _.w / 2, w.position("y") - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
								else B = x.add(new g(this.graphManager));
								if (B.id = w.data("id"), B.nodeRepulsion = E(Y.nodeRepulsion, w), B.paddingLeft = parseInt(w.css("padding")), B.paddingTop = parseInt(w.css("padding")), B.paddingRight = parseInt(w.css("padding")), B.paddingBottom = parseInt(w.css("padding")), Y.nodeDimensionsIncludeLabels && (B.labelWidth = w.boundingBox({
									includeLabels: !0,
									includeNodes: !1,
									includeOverlays: !1
								}).w, B.labelHeight = w.boundingBox({
									includeLabels: !0,
									includeNodes: !1,
									includeOverlays: !1
								}).h, B.labelPosVertical = w.css("text-valign"), B.labelPosHorizontal = w.css("text-halign")), rt[w.data("id")] = B, isNaN(B.rect.x) && (B.rect.x = 0), isNaN(B.rect.y) && (B.rect.y = 0), H != null && H.length > 0) {
									var q = void 0;
						...
						return m$2(F.addRoot(), f.getTopMostNodes(G), M, v), y(M, F, K), R$1(M, v), M.runLayout(), rt;
					};
				...
				212: ((a, r, e) => {
					...
					var g = e(658), t = e(548), s = e(657).spectralLayout, l = e(816).coseLayout, T = Object.freeze({
						quality: "default",
						randomize: !0,
						animate: !0,
					...
					a.exports = function() {
						...
						return f(v, [{
							...
							value: function() {
								...
								(C.fixedNodeConstraint || C.alignmentConstraint || C.relativePlacementConstraint) && (C.tile = !1, C.packComponents = !1);
								var E = void 0, p = !1;
								if (G.layoutUtilities && C.packComponents && (E = G.layoutUtilities("get"), E || (E = G.layoutUtilities()), p = !0), K.nodes().length > 0) if (p) {
									var R$1 = t.getTopMostNodes(C.eles.nodes());
									if (O = t.connectComponents(G, C.eles, R$1), O.forEach(function(vt) {
										...
										var M = G.collection();
										if (C.tile) {
											var F = /* @__PURE__ */ new Map(), W = [], x = [], Z = 0, V = {
												nodeIndexes: F,
												xCoords: W,
												yCoords: x
											}, Y = [];
											if (O.forEach(function(vt, it) {
												vt.edges().length == 0 && (vt.nodes().forEach(function(gt$1, Et) {
													M.merge(vt.nodes()[Et]), gt$1.isParent() || (V.nodeIndexes.set(vt.nodes()[Et].id(), Z++), V.xCoords.push(vt.nodes()[0].position().x), V.yCoords.push(vt.nodes()[0].position().y));
												}), Y.push(it));
											}), M.length > 1) {
												...
												for (var z = Y.length - 1; z >= 0; z--) O.splice(Y[z], 1), X.splice(Y[z], 1), rt.splice(Y[z], 1);
											}
										}
										O.forEach(function(vt, it) {
											C.eles = vt, Q.push(l(C, X[it])), t.relocateComponent(rt[it], Q[it], C);
										});
									} else O.forEach(function(vt, it) {
									...
									if (O.length > 1) {
										...
										O.forEach(function(vt, it) {
											var gt$1 = void 0;
											if (C.quality == "draft" && (gt$1 = X[it].nodeIndexes), vt.nodes().not(B).length > 0) {
												var Et = {};
												Et.edges = [], Et.nodes = [];
												var At = void 0;
												vt.nodes().not(B).forEach(function(Ot) {
													if (C.quality == "draft") if (!Ot.isParent()) At = gt$1.get(Ot.id()), Et.nodes.push({
														...
														var mt = t.calcBoundingBox(Ot, X[it].xCoords, X[it].yCoords, gt$1);
														Et.nodes.push({
															x: mt.topLeftX,
															y: mt.topLeftY,
															width: mt.width,
													...
													if (mt.css("display") != "none" && Dt.css("display") != "none") if (C.quality == "draft") {
														var Rt = gt$1.get(mt.id()), Ht = gt$1.get(Dt.id()), Ut = [], Pt = [];
														if (mt.isParent()) {
															var Ft = t.calcBoundingBox(mt, X[it].xCoords, X[it].yCoords, gt$1);
															Ut.push(Ft.topLeftX + Ft.width / 2), Ut.push(Ft.topLeftY + Ft.height / 2);
														} else Ut.push(X[it].xCoords[Rt]), Ut.push(X[it].yCoords[Rt]);
														if (Dt.isParent()) {
															var Yt = t.calcBoundingBox(Dt, X[it].xCoords, X[it].yCoords, gt$1);
													...
													} else Q[it][mt.id()] && Q[it][Dt.id()] && Et.edges.push({
														startX: Q[it][mt.id()].getCenterX(),
														startY: Q[it][mt.id()].getCenterY(),
										...
										if (C.quality == "draft") X.forEach(function(vt, it) {
											var gt$1 = vt.xCoords.map(function(At) {
												return At + _[it].dx;
											}), Et = vt.yCoords.map(function(At) {
												return At + _[it].dy;
											});
											vt.xCoords = gt$1, vt.yCoords = Et;
										});
										else {
											var ht = 0;
											w.forEach(function(vt) {
												Object.keys(Q[vt]).forEach(function(it) {
													var gt$1 = Q[vt][it];
													gt$1.setCenter(gt$1.getCenterX() + _[ht].dx, gt$1.getCenterY() + _[ht].dy);
												}), ht++;
											});
										}
									}
								} else {
									var m$2 = C.eles.boundingBox();
									if (rt.push({
										x: m$2.x1 + m$2.w / 2,
										y: m$2.y1 + m$2.h / 2
									}), C.randomize) {
								...
								var q = function(it, gt$1) {
									if (C.quality == "default" || C.quality == "proof") {
										typeof it == "number" && (it = gt$1);
										...
										}), C.nodeDimensionsIncludeLabels && (At.labelWidth && (At.labelPosHorizontal == "left" ? Et.x += At.labelWidth / 2 : At.labelPosHorizontal == "right" && (Et.x -= At.labelWidth / 2)), At.labelHeight && (At.labelPosVertical == "top" ? Et.y += At.labelHeight / 2 : At.labelPosVertical == "bottom" && (Et.y -= At.labelHeight / 2))), Et ??= {
											x: it.position("x"),
											y: it.position("y")
										}, {
											x: Et.x,
				...
				657: ((a, r, e) => {
					var f = e(548), i = e(140).layoutBase.Matrix, g = e(140).layoutBase.SVD, t = function(s) {
						var c = s.cy, l = s.eles, T = l.nodes(), d = l.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), C = [], G = [], K = [], X = [], Q = [], O = [], rt = [], n = [], E = void 0, p = 1e8, m$2 = 1e-9, y = s.piTol, R$1 = s.samplingType, M = s.nodeSeparation, F = void 0, W = function() {
							for (var U = 0, $ = 0, J = !1; $ < F;) {
								U = Math.floor(Math.random() * E), J = !1;
								for (var k = 0; k < $; k++) if (X[k] == U) {
									J = !0;
									break;
								}
								if (!J) X[$] = U, $++;
							...
							for (var k = [], at = 0, ct = 0, nt = 0, tt = void 0, j = [], ut = 0, Mt = 1, pt = 0; pt < E; pt++) j[pt] = p;
							for (k[ct] = U, j[U] = 0; ct >= at;) {
								nt = k[at++];
								for (var xt = C[nt], lt = 0; lt < xt.length; lt++) tt = L.get(xt[lt]), j[tt] == p && (j[tt] = j[nt] + 1, k[++ct] = tt);
								O[nt][$] = j[nt] * M;
							}
							if (J) {
								for (var ot = 0; ot < E; ot++) O[ot][$] < Q[ot] && (Q[ot] = O[ot][$]);
								for (var Lt = 0; Lt < E; Lt++) Q[Lt] > ut && (ut = Q[Lt], Mt = Lt);
							}
							return Mt;
						}, Z = function(U) {
							var $ = void 0;
							if (U) {
								...
								for (var k = 0; k < E; k++) Q[k] = p;
								for (var at = 0; at < F; at++) X[at] = $, $ = x($, at, U);
							} else {
								W();
								for (var J = 0; J < F; J++) x(X[J], J, U);
							}
							for (var ct = 0; ct < E; ct++) for (var nt = 0; nt < F; nt++) O[ct][nt] *= O[ct][nt];
							...
							for (var U = g.svd(rt), $ = U.S, J = U.U, k = U.V, at = $[0] * $[0] * $[0], ct = [], nt = 0; nt < F; nt++) {
								ct[nt] = [];
								for (var tt = 0; tt < F; tt++) ct[nt][tt] = 0, nt == tt && (ct[nt][tt] = $[nt] / ($[nt] * $[nt] + at / ($[nt] * $[nt])));
							}
							n = i.multMat(i.multMat(k, ct), i.transpose(J));
						}, Y = function() {
							for (var U = void 0, $ = void 0, J = [], k = [], at = [], ct = [], nt = 0; nt < E; nt++) J[nt] = Math.random(), k[nt] = Math.random();
							J = i.normalize(J), k = i.normalize(k);
							for (var tt = m$2, j = m$2, ut = void 0;;) {
								for (var Mt = 0; Mt < E; Mt++) at[Mt] = J[Mt];
								if (J = i.multGamma(i.multL(i.multGamma(at), O, n)), U = i.dotProduct(at, J), J = i.normalize(J), tt = i.dotProduct(at, J), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1) break;
								j = tt;
							}
							for (var pt = 0; pt < E; pt++) at[pt] = J[pt];
							for (j = m$2;;) {
								for (var xt = 0; xt < E; xt++) ct[xt] = k[xt];
								if (ct = i.minusOp(ct, i.multCons(at, i.dotProduct(at, ct))), k = i.multGamma(i.multL(i.multGamma(ct), O, n)), $ = i.dotProduct(ct, k), k = i.normalize(k), tt = i.dotProduct(ct, k), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1) break;
								j = tt;
							}
							for (var lt = 0; lt < E; lt++) ct[lt] = k[lt];
						...
						d.forEach(function(b) {
							for (var U = b.children().intersection(l); U.nodes(":childless").length == 0;) U = U.nodes()[0].children().intersection(l);
						...
						}, vt = !0, it = !1, gt$1 = void 0;
						try {
							for (var Et = v.keys()[Symbol.iterator](), At; !(vt = (At = Et.next()).done); vt = !0) {
								var Ot = At.value;
								Nt(Ot);
							}
						} catch (b) {
						...
						if (E > 2) {
							...
							for (var Dt = 0; Dt < E; Dt++) O[Dt] = [];
							for (var Rt = 0; Rt < F; Rt++) n[Rt] = [];
							return s.quality == "draft" || s.step == "all" ? (Z(R$1), V(), Y(), mt = {
								nodeIndexes: L,
								xCoords: G,
								yCoords: K
							}) : (L.forEach(function(b, U) {
							...
							if (G.push(Pt.x), K.push(Pt.y), E == 2) {
								var Vt = c.getElementById(Ht.next().value).outerWidth();
...
var De = {
...
}, "isArchitectureJunction"), be = /* @__PURE__ */ m((I) => I.data(), "edgeData"), ie = /* @__PURE__ */ m((I) => I.data(), "nodeData"), Ar$1 = Mf.architecture, ne, Pe = (ne = class {
	constructor() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = b5, this.getAccTitle = x5, this.setDiagramTitle = w5, this.getDiagramTitle = _5, this.getAccDescription = k5, this.setAccDescription = y5, this.clear();
	}
	clear() {
	...
	addService({ id: D, icon: A, in: P, title: N, iconText: u }) {
		if (this.registeredIds[D] !== void 0) throw new Error(`The service id [${D}] is already in use by another ${this.registeredIds[D]}`);
		if (P !== void 0) {
			if (D === P) throw new Error(`The service [${D}] cannot be placed within itself`);
			if (this.registeredIds[P] === void 0) throw new Error(`The service [${D}]'s parent does not exist. Please make sure the parent is created before this service`);
	...
	addGroup({ id: D, icon: A, in: P, title: N }) {
		var u, h, a;
		if (((u = this.registeredIds) == null ? void 0 : u[D]) !== void 0) throw new Error(`The group id [${D}] is already in use by another ${this.registeredIds[D]}`);
		if (P !== void 0) {
			if (D === P) throw new Error(`The group [${D}] cannot be placed within itself`);
			if (((h = this.registeredIds) == null ? void 0 : h[P]) === void 0) throw new Error(`The group [${D}]'s parent does not exist. Please make sure the parent is created before this group`);
			if (((a = this.registeredIds) == null ? void 0 : a[P]) === "node") throw new Error(`The group [${D}]'s parent is not a group`);
		}
	...
	addEdge({ lhsId: D, rhsId: A, lhsDir: P, rhsDir: N, lhsInto: u, rhsInto: h, lhsGroup: a, rhsGroup: r, title: e }) {
		if (!Ie(P)) throw new Error(`Invalid direction given for left hand side of edge ${D}--${A}. Expected (L,R,T,B) got ${String(P)}`);
		if (!Ie(N)) throw new Error(`Invalid direction given for right hand side of edge ${D}--${A}. Expected (L,R,T,B) got ${String(N)}`);
		if (this.nodes[D] === void 0 && this.groups[D] === void 0) throw new Error(`The left-hand id [${D}] does not yet exist. Please create the service/group before declaring an edge to it.`);
		if (this.nodes[A] === void 0 && this.groups[A] === void 0) throw new Error(`The right-hand id [${A}] does not yet exist. Please create the service/group before declaring an edge to it.`);
		const f = this.nodes[D].in, i = this.nodes[A].in;
		if (a && f && i && f == i) throw new Error(`The left-hand id [${D}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
		if (r && f && i && f == i) throw new Error(`The right-hand id [${A}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
		const g = {
			lhsId: D,
			lhsDir: P,
			lhsInto: u,
	...
	getDataStructures() {
		if (this.dataStructures === void 0) {
			const D = {}, A = Object.entries(this.nodes).reduce((r, [e, f]) => (r[e] = f.edges.reduce((i, g) => {
				...
				return i;
			}, {}), r), {}), P = Object.keys(A)[0], N = { [P]: 1 }, u = Object.keys(A).reduce((r, e) => e === P ? r : {
				...r,
				[e]: 1
			}, {}), h = /* @__PURE__ */ m((r) => {
				const e = { [r]: [0, 0] }, f = [r];
	...
	m$1(I, D), I.groups.map((A) => D.addGroup(A)), I.services.map((A) => D.addService({
		...A,
		type: "service"
	})), I.junctions.map((A) => D.addJunction({
		...A,
		type: "junction"
	...
	parse: /* @__PURE__ */ m(async (I) => {
		...
		if (!(A instanceof Pe)) throw new Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		Mr(D, A);
	}, "parse")
}, Or = /* @__PURE__ */ m((I) => `
  .edge {
...
`, "getStyles"), re = /* @__PURE__ */ m((I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`, "wrapIcon"), ae = {
	...
	await Promise.all(D.edges().map(async (r) => {
		...
		if (g && (Wt(f) ? T += f === "L" ? -G : G : d += f === "T" ? -G : G + 18), c && (Wt(o) ? S += o === "L" ? -G : G : C += o === "T" ? -G : G + 18), !g && ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" && (Wt(f) ? T += f === "L" ? u : -u : d += f === "T" ? u : -u), !c && ((X = A.getNode(t)) == null ? void 0 : X.type) === "junction" && (Wt(o) ? S += o === "L" ? u : -u : C += o === "T" ? u : -u), r[0]._private.rscratch) {
			const Q = I.insert("g");
			if (Q.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `).attr("class", "edge").attr("id", Cz(e, t, { prefix: "L" })), i) {
			...
			if (l) {
				...
				}, yt()), n.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), O === "X") n.attr("transform", "translate(" + v + ", " + L + ")");
				else if (O === "Y") n.attr("transform", "translate(" + v + ", " + L + ") rotate(-90)");
				else if (O === "XY") {
					const E = pe(f, o);
					if (E && yr(E)) {
						const p = n.node().getBoundingClientRect(), [m$2, y] = Tr(E);
						n.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * m$2 * y * 45})`);
						const R$1 = n.node().getBoundingClientRect();
						n.attr("transform", `
                translate(${v}, ${L - p.height / 2})
                translate(${m$2 * R$1.width / 2}, ${y * R$1.height / 2})
                rotate(${-1 * m$2 * y * 45}, 0, ${p.height / 2})
              `);
					}
				}
			}
	...
	const N = A.getConfigField("padding") * .75, u = A.getConfigField("fontSize"), a = A.getConfigField("iconSize") / 2;
	await Promise.all(D.nodes().map(async (r) => {
		const e = ie(r);
		if (e.type === "group") {
			...
			if (e.icon) {
				const T = s.append("g");
				T.html(`<g>${await aa(e.icon, {
					height: N,
					width: N,
					fallbackPrefix: ae.prefix
				})}</g>`), T.attr("transform", "translate(" + (c + a + 1) + ", " + (l + a + 1) + ")"), c += N, l += u / 2 - 1 - 2;
			}
			if (e.label) {
				const T = s.append("g");
				await Ar(T, e.label, {
					...
					width: i,
					classes: "architecture-service-label"
				}, yt()), T.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), T.attr("transform", "translate(" + (c + a + 4) + ", " + (l + a + 2) + ")");
			}
	...
	for (const N of A) {
		...
		if (N.title) {
			...
			await Ar(f, N.title, {
				...
				width: h * 1.5,
				classes: "architecture-service-label"
			}, P), f.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), f.attr("transform", "translate(" + h / 2 + ", " + h + ")");
		}
		const a = u.append("g");
		if (N.icon) a.html(`<g>${await aa(N.icon, {
			height: h,
			width: h,
			fallbackPrefix: ae.prefix
		})}</g>`);
		else if (N.iconText) {
			a.html(`<g>${await aa("blank", {
				height: h,
				width: h,
				fallbackPrefix: ae.prefix
			})}</g>`);
			const g = a.append("g").append("foreignObject").attr("width", h).attr("height", h).append("div").attr("class", "node-icon-text").attr("style", `height: ${h}px;`).append("div").html(_e(N.iconText, P)), t = parseInt(window.getComputedStyle(g.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
			g.attr("style", `-webkit-line-clamp: ${Math.floor((h - 2) / t)};`);
		} else a.append("path").attr("class", "node-bkg").attr("id", "node-" + N.id).attr("d", `M0 ${h} v${-h} q0,-5 5,-5 h${h} q5,0 5,5 v${h} H0 Z`);
...
m(We, "addEdges");
function Ve(I, D, A) {
	const P = /* @__PURE__ */ m((a, r) => Object.entries(a).reduce((e, [f, i]) => {
		var o;
		let g = 0;
		const t = Object.entries(i);
		if (t.length === 1) return e[f] = t[0][1], e;
		for (let s = 0; s < t.length - 1; s++) for (let c = s + 1; c < t.length; c++) {
			const [l, T] = t[s], [d, v] = t[c];
			if (((o = A[l]) == null ? void 0 : o[d]) === r) e[f] ?? (e[f] = []), e[f] = [
				...e[f],
				...T,
				...v
			];
			else if (l === "default" || d === "default") e[f] ?? (e[f] = []), e[f] = [
				...e[f],
				...T,
				...v
			];
	...
	}).reduce(([a, r], { horiz: e, vert: f }) => [[...a, ...e], [...r, ...f]], [[], []]);
	return {
		horizontal: u,
		vertical: h
	};
...
function ze(I, D) {
	...
	return I.forEach((u) => {
		const h = Object.fromEntries(Object.entries(u).map(([f, i]) => [P(i), f])), a = [P([0, 0])], r = {}, e = {
			L: [-1, 0],
			R: [1, 0],
			T: [0, 1],
			B: [0, -1]
	...
	return new Promise((a) => {
		...
		const f = Ve(N, u, h), i = ze(u, N), g = e.layout({
			...
			idealEdgeLength(t) {
				...
				return c === l ? 1.5 * N.getConfigField("iconSize") : .5 * N.getConfigField("iconSize");
			},
			edgeElasticity(t) {
				const [o, s] = t.connectedNodes(), { parent: c } = ie(o), { parent: l } = ie(s);
				return c === l ? .45 : .001;
		...
		g.one("layoutstop", () => {
			...
			for (const s of Object.values(e.edges())) if ((o = s.data) != null && o.call(s)) {
...
var ha = {
	...
	renderer: { draw: /* @__PURE__ */ m(async (I, D, A, P) => {
