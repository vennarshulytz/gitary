...
import { H as m, ag as _e, O as yt, b1 as Fh, a6 as gt$1, a7 as b5, a8 as x5, aa as y5, a9 as k5, ak as w5, al as _5, ad as zi, ar as m5, K as R, aq as $e, ap as Cz, at as Rz, au as Dz } from "./app-a3875679.js";
var Ve = function() {
...
var Tt = Ve, je = ["#", "+", "~", "-", ""], $, We = ($ = class {
   ...
   */
  addClass(i) {
    const a = zi.sanitizeText(i, yt()), { className: u, type: l2 } = this.splitClassNameAndType(a);
  ...
  addRelation(i) {
    ...
    i.relation.type1 === this.relationType.LOLLIPOP && !a.includes(i.relation.type2) ? (this.addClass(i.id2), this.addInterface(i.id1, i.id2), i.id1 = `interface${this.interfaces.length - 1}`) : i.relation.type2 === this.relationType.LOLLIPOP && !a.includes(i.relation.type1) ? (this.addClass(i.id1), this.addInterface(i.id2, i.id1), i.id2 = `interface${this.interfaces.length - 1}`) : (this.addClass(i.id1), this.addClass(i.id2)), i.id1 = this.splitClassNameAndType(i.id1).className, i.id2 = this.splitClassNameAndType(i.id2).className, i.relationTitle1 = zi.sanitizeText(
      ...
      yt()
    ), i.relationTitle2 = zi.sanitizeText(
...
`, "getStyles"), Dt = At, ft = /* @__PURE__ */ m((s, i = "TB") => {
  ...
  A.type = u.type, A.layoutAlgorithm = Rz(c), A.nodeSpacing = (r == null ? void 0 : r.nodeSpacing) || 50, A.rankSpacing = (r == null ? void 0 : r.rankSpacing) || 50, A.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], A.diagramId = i, await Dz(A, g$1);
  const D = 8;
  $e.insertTitle(
    g$1,
