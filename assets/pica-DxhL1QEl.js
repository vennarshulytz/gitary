import { i as __require, t as __commonJSMin } from "./rolldown-runtime-p26lAE5v.js";
		...
		return (function() {
			...
			16: [function(_dereq_, module$1, exports$1) {
				...
				module$1.exports.worker_offscreen_canvas_support = function worker_offscreen_canvas_support() {
					return new Promise(function(resolve, reject) {
						...
						function workerPayload(self$1) {
							if (typeof createImageBitmap === "undefined") {
								self$1.postMessage(false);
								return;
							}
							Promise.resolve().then(function() {
								...
								return self$1.postMessage(true);
							}, function() {
								return self$1.postMessage(false);
							});
						}
			...
			20: [function(_dereq_, module$1, exports$1) {
				...
				MultiMath.prototype.init = function() {
					...
					var self$1 = this;
					this.__init_promise = Promise.all(Object.keys(self$1.__modules).map(function(name) {
						var module$2 = self$1.__modules[name];
						if (!self$1.options.wasm || !self$1.has_wasm() || !module$2.wasm_fn) return null;
						if (self$1.__wasm[name]) return null;
						return WebAssembly.compile(self$1.__base64decode(module$2.wasm_src)).then(function(m) {
							self$1.__wasm[name] = m;
						});
					})).then(function() {
						return self$1;
					});
