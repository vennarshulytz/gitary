import { ax as Mf, ak as w5, al as _5, a7 as b5, a8 as x5, aa as y5, a9 as k5, H as m, K as R, ar as m5, O as yt$1, ay as lu, aK as iT, aM as cs, ah as If, aN as di, aO as kz, aP as U8 } from "./app-54f05dd6.js";
import { m as m$1 } from "./chunk-4BX2VUAB-df729ba8-78566bc4.js";
import { Y as Yy } from "./mermaid-parser.core-ecfcb38d-97f06785.js";
import { h as hn } from "./arc-55eabd0f-da18627e.js";
...
function ct() {
  ...
  function s(e) {
    var a, l = (e = U8(e)).length, m2, y, h2 = 0, c = new Array(l), o = new Array(l), v = +x.apply(this, arguments), w = Math.min(kz, Math.max(-kz, n.apply(this, arguments) - v)), f, C = Math.min(Math.abs(w) / l, p.apply(this, arguments)), $ = C * (w < 0 ? -1 : 1), g;
    for (a = 0; a < l; ++a)
...
` + t);
  ...
  h$1.attr("viewBox", `0 0 ${O} ${m2}`), If(h$1, m2, O, s.useMaxWidth);
}, "draw"), $t = { draw: Ct }, rr = {
  parser: yt,
  db: _,
  renderer: $t,
