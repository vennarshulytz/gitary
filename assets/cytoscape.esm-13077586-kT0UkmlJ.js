...
rr && rr.document;
var uc = ar(""), ev = ar({}), lc = ar(function() {}), vc = typeof HTMLElement > "u" ? "undefined" : ar(HTMLElement), La = function(e) {
	...
	var f = (/* @__PURE__ */ new RegExp("^" + wc + "$")).exec(e);
	if (f) {
		if (a = parseInt(f[1]), a < 0 ? a = (360 - -1 * a % 360) % 360 : a > 360 && (a = a % 360), a /= 360, n = parseFloat(f[2]), n < 0 || n > 100 || (n = n / 100, i = parseFloat(f[3]), i < 0 || i > 100) || (i = i / 100, s = f[4], s !== void 0 && (s = parseFloat(s), s < 0 || s > 1))) return;
		if (n === 0) o = l = u = Math.round(i * 255);
		else {
			var c = i < .5 ? i * (1 + n) : i + n - i * n, h = 2 * i - c;
	...
	var t, a = (/* @__PURE__ */ new RegExp("^" + mc + "$")).exec(e);
	if (a) {
		t = [];
		for (var n = [], i = 1; i <= 3; i++) {
			var s = a[i];
...
function Ac() {
	if (Do) return jn;
	Do = 1;
	return jn = typeof Ka == "object" && Ka && Ka.Object === Object && Ka, jn;
}
var ei, Bo;
function Ln() {
	if (Bo) return ei;
	Bo = 1;
	var r = Ac(), e = typeof self == "object" && self && self.Object === Object && self;
	return ei = r || e || Function("return this")(), ei;
}
var ri, Po;
function Rc() {
	if (Po) return ri;
...
var Fa = /* @__PURE__ */ Oa(Fc()), ci = rr ? rr.performance : null, lv = ci && ci.now ? function() {
	return ci.now();
} : function() {
	return Date.now();
}, qc = function() {
	if (rr) {
		if (rr.requestAnimationFrame) return function(r) {
			rr.requestAnimationFrame(r);
		};
		if (rr.mozRequestAnimationFrame) return function(r) {
			rr.mozRequestAnimationFrame(r);
		};
		if (rr.webkitRequestAnimationFrame) return function(r) {
			rr.webkitRequestAnimationFrame(r);
		};
		if (rr.msRequestAnimationFrame) return function(r) {
	...
	for (var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Tt, n; n = e.next(), !n.done;) a = a * vv + n.value | 0;
	return a;
}, Ca = function(e) {
	return (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Tt) * vv + e | 0;
}, Ta = function(e) {
...
var _o = !0, Uc = console.warn != null, Kc = console.trace != null, Js = Number.MAX_SAFE_INTEGER || 9007199254740991, dv = function() {
	...
	breadthFirstSearch: Ho({ bfs: !0 }),
	depthFirstSearch: Ho({ dfs: !0 })
};
...
function td() {
	return Wo || (Wo = 1, function(r, e) {
		(function() {
			var t, a, n = Math.floor, i, s, o, l, u, v, f = Math.min, c, h, d, y, g;
			a = function(p, m) {
				return p < m ? -1 : p > m ? 1 : 0;
			}, v = function(p, m, b, w, E) {
				var C;
				if (b ??= 0, E ??= a, b < 0) throw new Error("lo must be non-negative");
				for (w ??= p.length; b < w;) C = n((b + w) / 2), E(m, p[C]) < 0 ? w = C : b = C + 1;
				return [].splice.apply(p, [b, b - b].concat(m)), m;
			}, o = function(p, m, b) {
				return b ??= a, p.push(m), y(p, 0, p.length - 1, b);
			}, s = function(p, m) {
				var b, w;
				return m ??= a, b = p.pop(), p.length ? (w = p[0], p[0] = b, g(p, 0, m)) : w = b, w;
			}, u = function(p, m, b) {
				var w;
				return b ??= a, w = p[0], p[0] = m, g(p, 0, b), w;
			}, l = function(p, m, b) {
				var w;
				return b ??= a, p.length && b(p[0], m) < 0 && (w = [p[0], m], m = w[0], p[0] = w[1], g(p, 0, b)), m;
			}, i = function(p, m) {
				var b, w, E, C, x, T;
				for (m ??= a, C = (function() {
					T = [];
					...
					return T;
				}).apply(this).reverse(), x = [], w = 0, E = C.length; w < E; w++) b = C[w], x.push(g(p, b, m));
				return x;
			}, d = function(p, m, b) {
				var w;
				if (b ??= a, w = p.indexOf(m), w !== -1) return y(p, 0, w, b), g(p, w, b);
			}, c = function(p, m, b) {
				var w, E, C, x, T;
				if (b ??= a, E = p.slice(0, m), !E.length) return E;
				for (i(E, b), T = p.slice(m), C = 0, x = T.length; C < x; C++) w = T[C], l(E, w, b);
				return E.sort(b).reverse();
			}, h = function(p, m, b) {
				var w, E, C, x, T, k, D, B, P;
				if (b ??= a, m * 10 <= p.length) {
					if (C = p.slice(0, m).sort(b), !C.length) return C;
					for (E = C[C.length - 1], D = p.slice(m), x = 0, k = D.length; x < k; x++) w = D[x], b(w, E) < 0 && (v(C, w, 0, null, b), C.pop(), E = C[C.length - 1]);
					return C;
				}
				for (i(p, b), P = [], T = 0, B = f(m, p.length); 0 <= B ? T < B : T > B; 0 <= B ? ++T : --T) P.push(s(p, b));
				return P;
			}, y = function(p, m, b, w) {
				var E, C, x;
				for (w ??= a, E = p[b]; b > m;) {
				...
				var w, E, C, x, T;
				for (b ??= a, E = p.length, T = m, C = p[m], w = 2 * m + 1; w < E;) x = w + 1, x < E && !(b(p[w], p[x]) < 0) && (w = x), p[m] = p[w], m = w, w = 2 * m + 1;
...
var Va = /* @__PURE__ */ Oa(ad()), id = cr({
	root: null,
	weight: function(e) {
		return 1;
	},
	directed: !1
}), sd = { dijkstra: function(e) {
	if (!Le(e)) {
		var t = arguments;
		e = {
			root: t[0],
	...
	for (var g = function(I) {
		...
		var w = d[b];
		v[w.id()] = w.same(u) ? 0 : Infinity, m.push(w);
	}
	for (var E = function(I, M) {
		for (var O = (s ? I.edgesTo(M) : I.edgesWith(M)).intersect(y), V = Infinity, G, N = 0; N < O.length; N++) {
			var F = O[N], U = l(F);
			(U < V || !G) && (V = U, G = F);
		}
		return {
		...
		if (c[T] = x, x !== Infinity) for (var k = C.neighborhood().intersect(d), D = 0; D < k.length; D++) {
	...
	return {
		distanceTo: function(I) {
			return c[(ge(I) ? d.filter(I)[0] : I[0]).id()];
		},
		pathTo: function(I) {
			var M = ge(I) ? d.filter(I)[0] : I[0], O = [], V = M, G = V.id();
			if (M.length > 0) for (O.unshift(M); f[G];) {
				var N = f[G];
...
} }, od = { kruskal: function(e) {
	e = e || function(b) {
		return 1;
	};
	for (var t = this.byGroup(), a = t.nodes, n = t.edges, i = a.length, s = new Array(i), o = a, l = function(w) {
		for (var E = 0; E < s.length; E++) if (s[E].has(w)) return E;
	}, u = 0; u < i; u++) s[u] = this.spawn(a[u]);
	...
	for (var x = 0; d.size() > 0;) {
		if (E(), x++, w === v) {
			for (var T = [], k = i, D = v, B = p[D]; T.unshift(k), B != null && T.unshift(B), k = g[D], k != null;) D = k.id(), B = p[D];
			return {
				found: !0,
				distance: f[w],
				path: this.spawn(T),
	...
	for (var A = 0; A < v; A++) for (var R = 0; R < v; R++) for (var L = R * v + A, I = 0; I < v; I++) {
		var M = R * v + I, O = A * v + I;
	...
	return {
		...
		path: function(U, Q) {
			...
			for (ne.merge(re); K !== j;) J = K, K = m[K * v + j], z = b[J * v + K], ne.merge(z), ne.merge(h(K));
			return ne;
		}
	};
} }, cd = cr({
	...
	for (var p = f.length, m = function(we) {
		...
		var x = c[C], T = m(x);
		x.same(s) ? T.dist = 0 : T.dist = Infinity, T.pred = null, T.edge = null;
	}
	...
	if (k) for (var V = [], G = 0; G < p; G++) {
		var N = f[G], F = N.source(), U = N.target(), Q = o(N), K = m(F).dist, j = m(U).dist;
		if (K + Q < j || !i && j + Q < K) if (y || (Ve("Graph contains a negative weight cycle for Bellman-Ford"), y = !0), e.findNegativeWeightCycles !== !1) {
			var re = [];
			...
			for (var ne = re.length, J = 0; J < ne; J++) {
				...
				for (var Y = q[0].id(), te = 0, ce = 2; ce < q.length; ce += 2) q[ce].id() < Y && (Y = q[ce].id(), te = ce);
	...
	for (; a > n;) t = gd(Math.floor(Math.random() * t.length), e, t), a--;
	return t;
}, pd = { kargerStein: function() {
	...
	for (var c = Infinity, h = [], d = new Array(i), y = new Array(i), g = new Array(i), p = function(V, G) {
...
function Pd(r, e) {
	...
	var t = function(T, k) {
		...
		if (Math.abs(R) < 1e-9) return t(T, n(P, .5));
		return t(T, n(P, i(a(D, T), A) / R));
	}, u = r.map(function(x) {
		return {
			x: x.x,
			y: x.y
...
var wv = function(e, t, a, n, i, s, o) {
	...
	var c = u !== v, h = u !== f, d;
	if (c) {
		var y = a - v + u - o, g = n - f - o;
		if (d = it(e, t, a, n, y, g, a + v - u + o, g, !1), d.length > 0) return d;
	}
	if (h) {
		var b = a + v + o;
		if (d = it(e, t, a, n, b, n - f + u - o, b, n + f - u + o, !1), d.length > 0) return d;
	}
	if (c) {
		var x = a - v + u - o, T = n + f + o;
		if (d = it(e, t, a, n, x, T, a + v - u + o, T, !1), d.length > 0) return d;
	}
	if (h) {
		var B = a - v - o;
		if (d = it(e, t, a, n, B, n - f + u - o, B, n + f - u + o, !1), d.length > 0) return d;
	...
	y.push(1), y.push(0);
	for (var p = -1, m, b, w, E = 0; E < y.length; E++) m = Math.pow(1 - y[E], 2) * a + 2 * (1 - y[E]) * y[E] * i + y[E] * y[E] * o, b = Math.pow(1 - y[E], 2) * n + 2 * (1 - y[E]) * y[E] * s + y[E] * y[E] * l, w = Math.pow(m - e, 2) + Math.pow(b - t, 2), p >= 0 ? w < p && (p = w) : p = w;
	return p;
	...
	for (var n, i, s, o, l, u = 0, v = 0; v < a.length / 2; v++) if (n = a[v * 2], i = a[v * 2 + 1], v + 1 < a.length / 2 ? (s = a[(v + 1) * 2], o = a[(v + 1) * 2 + 1]) : (s = a[(v + 1 - a.length / 2) * 2], o = a[(v + 1 - a.length / 2) * 2 + 1]), !(n == e && s == e)) if (n >= e && e >= s || n <= e && e <= s) l = (e - n) / (s - n) * (o - i) + i, l > t && u++;
	else continue;
	return u % 2 !== 0;
	...
	for (var c = Math.cos(-f), h = Math.sin(-f), d = 0; d < v.length / 2; d++) v[d * 2] = s / 2 * (a[d * 2] * c - a[d * 2 + 1] * h), v[d * 2 + 1] = o / 2 * (a[d * 2 + 1] * c + a[d * 2] * h), v[d * 2] += n, v[d * 2 + 1] += i;
	var y;
	if (u > 0) y = En(Cn(v, -u));
	else y = v;
	return Sr(e, t, y);
	...
	for (var u = new Array(a.length * 2), v = 0; v < l.length; v++) {
		...
		if (Math.pow(f.cx - e, 2) + Math.pow(f.cy - t, 2) <= Math.pow(f.radius, 2)) return !0;
	}
	return Sr(e, t, u);
}, En = function(e) {
	...
	if (m !== 0) {
		var b = g / m, w = p / m, E = .001, C = 0 - E, x = 1 + E;
		return C <= b && b <= x && C <= w && w <= x ? [e + b * f, t + b * d] : u ? [e + b * f, t + b * d] : [];
	} else return g === 0 || p === 0 ? pi(e, a, o) === o ? [o, l] : pi(e, a, i) === i ? [i, s] : pi(i, o, a) === a ? [a, n] : [] : [];
	...
	for (var g, p, m, b, w = 0; w < h.length / 2; w++) g = h[w * 2], p = h[w * 2 + 1], w < h.length / 2 - 1 ? (m = h[(w + 1) * 2], b = h[(w + 1) * 2 + 1]) : (m = h[0], b = h[1]), v = it(e, t, n, i, g, p, m, b), v.length !== 0 && u.push(v[0], v[1]);
	return u;
	...
	for (var h = 0; h < c.length / 4; h++) f = it(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], !1), f.length !== 0 && v.push(f[0], f[1]);
	if (v.length > 2) {
	...
	for (var v = 2 / (o - i), f = 2 / (l - s), c = 0; c < n; c++) t = e[2 * c] = e[2 * c] * v, a = e[2 * c + 1] = e[2 * c + 1] * f, i = Math.min(i, t), o = Math.max(o, t), s = Math.min(s, a), l = Math.max(l, a);
...
function yi(r, e) {
	...
	function a(f, c) {
		var h = Infinity, d = -Infinity, y = kr(f), g;
		try {
			for (y.s(); !(g = y.n()).done;) {
	...
	var s = kr([].concat(mn(t(r)), mn(t(e)))), o;
	try {
		for (s.s(); !(o = s.n()).done;) {
			var l = o.value;
...
var Gd = cr({
	...
	for (var P = 1 / f + g, A = 0; A < f; A++) if (y[A] === 0) for (var R = 0; R < f; R++) {
		var L = R * f + A;
		d[L] = P;
	}
	...
	for (var F = 0; F < i; F++) {
		...
		for (var Q = 0; Q < f; Q++) for (var K = 0; K < f; K++) {
			var j = Q * f + K;
			V[Q] += d[j] * O[K];
		}
		Cd(V), G = O, O = V, V = G;
	...
	degreeCentrality: function(e) {
		...
		if (i = t.collection(i)[0], o) {
			...
			}), g = d.length, p = y.length, m = 0, b = 0, w = 0; w < d.length; w++) m += s(d[w]);
...
var Yo = cr({
	...
	closenessCentralityNormalized: function(e) {
		for (var t = Yo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, l = 0, u = this.nodes(), v = this.floydWarshall({
			...
			for (var c = 0, h = u[f], d = 0; d < u.length; d++) if (f !== d) {
				var y = v.distance(h, u[d]);
				a ? c += 1 / y : c += y;
			}
			a || (c = 1 / c), l < c && (l = c), o[h.id()] = c;
		}
		return { closeness: function(p) {
...
var Wd = cr({
	weight: null,
	directed: !1
}), Rs = { betweennessCentrality: function(e) {
	...
	for (var y = function() {
		for (var b = o[g].id(), w = [], E = {}, C = {}, x = {}, T = new Va(function(Q, K) {
			...
			var D = o[k].id();
			E[D] = [], C[D] = 0, x[D] = Infinity;
		}
		for (C[b] = 1, x[b] = 0, T.push(b); !T.empty();) {
			var B = T.pop();
			if (w.push(B), i) for (var P = 0; P < l[B].length; P++) {
			...
			else for (var M = 0; M < l[B].length; M++) {
				var O = l[B][M].id();
				x[O] == Infinity && (T.push(O), x[O] = x[B] + 1), x[O] == x[B] + 1 && (C[O] = C[O] + C[B], E[O].push(B));
			}
		}
...
var $d = cr({
	...
	for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = Ud(e), s = {}, o = 0; o < t.length; o++) s[t[o].id()] = o;
	...
	for (var m = !0, b = 0; m && b < i.maxIterations;) m = !1, f = Zd(v, l, i.expandFactor), v = Qd(f, l, i.inflateFactor), Jd(v, f, u, 4) || (m = !0), b++;
	var w = jd(v, l, t, n);
	return w = rh(w), w;
}, th = {
	markovClustering: Zo,
	...
	for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ah, o = n, l, u, v = 0; v < e; v++) l = t(v), u = a(v), o = i(o, l, u);
	return s(o);
}, Jt = {
...
var sh = cr({
	...
	if (e.length < 50) for (var n = 0; n < t; n++) {
		for (var i = e[Math.floor(Math.random() * e.length)]; lh(i, a, n);) i = e[Math.floor(Math.random() * e.length)];
		a[n] = i;
	}
	...
	for (var f = !0, c = 0; f && c < i.maxIterations;) {
		...
		for (var d = 0; d < o.length; d++) {
			...
			if (y.length !== 0) {
				...
				for (var g = 0; g < y.length; g++) u = eu(y[g], y, i.attributes), u < v[d] && (v[d] = u, o[d] = y[g], f = !0);
				s[d] = t.collection(y);
			}
		}
		c++;
	...
	for (var v = 0; v < e.length; v++) for (var f = 0; f < i.attributes.length; f++) {
		s = 0, o = 0;
	...
	for (var o, l, u, v = 2 / (i.m - 1), f = 0; f < a.length; f++) for (var c = 0; c < n.length; c++) {
		o = 0;
		for (var h = 0; h < a.length; h++) l = Tn(i.distance, n[c], a[f], i.attributes, "cmeans"), u = Tn(i.distance, n[c], a[h], i.attributes, "cmeans"), o += Math.pow(l / u, v);
		e[c][f] = 1 / o;
	}
}, hh = function(e, t, a, n) {
	...
	var t = this.cy(), a = this.nodes(), n = io(e), i, s, o, l = new Array(a.length), u;
	...
	for (var m = !0, b = 0; m && b < n.maxIterations;) m = !1, ch(s, a, o, u, n), dh(o, l, s, a, n), uh(o, l, n.sensitivityThreshold) || (m = !0), b++;
	return i = hh(a, o, n, t), {
		clusters: i,
	...
	for (var s = 0, o = Infinity, l, u = i.attributes, v = function(k, D) {
	...
	for (var p = 0; p < e.length; p++) {
		var m = e[p];
		d.key === m.key ? l = Infinity : i.linkage === "min" ? (l = a[d.key][m.key], a[d.key][m.key] > a[y.key][m.key] && (l = a[y.key][m.key])) : i.linkage === "max" ? (l = a[d.key][m.key], a[d.key][m.key] < a[y.key][m.key] && (l = a[y.key][m.key])) : i.linkage === "mean" ? l = (a[d.key][m.key] * d.size + a[y.key][m.key] * y.size) / (d.size + y.size) : i.mode === "dendrogram" ? l = v(m.value, d.value) : l = v(m.value[0], d.value[0]), a[d.key][m.key] = a[m.key][d.key] = l;
	}
	...
	for (var h = 0; h < o.length; h++) for (var d = 0; d <= h; d++) {
		var y = void 0;
		n.mode === "dendrogram" ? y = h === d ? Infinity : s(o[h].value, o[d].value) : y = h === d ? Infinity : s(o[h].value[0], o[d].value[0]), l[h][d] = y, l[d][h] = y, y < l[h][u[h]] && (u[h] = d);
	}
	...
	.5 <= t && t < 1 || $e("Damping must range on [0.5, 1).  Got: ".concat(t));
	var n = [
		"median",
		"mean",
		"min",
	...
	for (var n = nu(e, t, a), i = 0; i < a.length; i++) {
		...
		for (var l = -1, u = -Infinity, v = 0; v < s.length; v++) {
	...
	var o = a.length, l = o * o, u = new Array(l), v, f, c;
	for (var h = 0; h < l; h++) u[h] = -Infinity;
	for (var d = 0; d < o; d++) for (var y = 0; y < o; y++) d !== y && (u[d * o + y] = Eh(n.distance, a[d], a[y], n.attributes));
	v = Ch(u, n.preference);
	...
	for (var b = new Array(o), w = new Array(o), E = new Array(o), C = 0; C < o; C++) b[C] = 0, w[C] = 0, E[C] = 0;
	for (var x = new Array(o * n.minIterations), T = 0; T < x.length; T++) x[T] = 0;
	var k;
	for (k = 0; k < n.maxIterations; k++) {
		for (var D = 0; D < o; D++) {
			for (var B = -Infinity, P = -Infinity, A = -1, R = 0, L = 0; L < o; L++) b[L] = f[D * o + L], R = c[D * o + L] + u[D * o + L], R >= B ? (P = B, B = R, A = L) : R > P && (P = R);
	...
	i ? s.forEach(function(m) {
		...
		var b = m.id();
		if (m.isNode()) m.degree(!0) % 2 && (l ? u ? o = !0 : u = b : l = b), f[b] = [], m.connectedEdges().forEach(function(E) {
	...
	var d = function(b) {
		for (var w = b, E = [b], C, x, T; f[w].length;) C = f[w].shift(), x = c[C][0], T = c[C][1], w != T ? (f[T] = f[T].filter(function(k) {
			return k != C;
	...
	for (g = d(v); g.length != 1;) f[g[0]].length == 0 ? (y.unshift(s.getElementById(g.shift())), y.unshift(s.getElementById(g.shift()))) : g = d(g.shift()).concat(g);
	...
	var e = this, t = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function(u) {
		...
		if (e.getElementById(u).connectedEdges().intersection(e).forEach(function(y) {
			var g = y.target().id();
...
var Bv = 0, Pv = 1, Av = 2, Nr = function(e) {
	...
	this.id = "Thenable/1.0.7", this.state = Bv, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = { then: this.then.bind(this) }, typeof e == "function" && e.call(this, this.fulfill.bind(this), this.reject.bind(this));
};
Nr.prototype = {
	fulfill: function(e) {
...
var su = function(e, t, a, n) {
	...
	var a;
	if (ar(t) === "object" && t !== null || typeof t == "function") try {
		a = t.then;
	} catch (i) {
		e.reject(i);
		return;
	...
	if (typeof a == "function") {
		...
		try {
			a.call(t, function(i) {
				n || (n = !0, i === t ? e.reject(/* @__PURE__ */ new TypeError("circular thenable chain")) : Mv(e, i));
			}, function(i) {
				n || (n = !0, e.reject(i));
			});
		} catch (i) {
...
Nr.all = function(r) {
	return new Nr(function(e, t) {
		...
		}, s = 0; s < r.length; s++) (function(o) {
			var l = r[o];
			if (l != null && l.then != null) l.then(function(f) {
				i(o, f);
			}, function(f) {
				t(f);
			});
...
var ta = typeof Promise < "u" ? Promise : Nr, Is = function(e, t, a) {
	var n = Ys(e), i = !n, s = this._private = be({ duration: 1e3 }, t, a);
...
var Rh = {
	...
	animation: function() {
		return function(t, a) {
			...
			var v = o.style();
			t = be({}, t, a);
			if (Object.keys(t).length === 0) return new Is(s[0], t);
			...
			if (u && (t.style = v.getPropsList(t.style || t.css), t.css = void 0), u && t.renderedPosition != null) {
				var c = t.renderedPosition, h = o.pan();
				t.position = yv(c, o.zoom(), h);
			}
			if (l && t.panBy != null) {
	...
	animate: function() {
		return function(t, a) {
			...
			for (var l = 0; l < s.length; l++) {
				var u = s[l], v = u.animated() && (t.queue === void 0 || t.queue);
				u.animation(t, v ? { queue: !0 } : void 0).play();
			}
			return this;
		};
	},
	stop: function() {
		return function(t, a) {
			...
			if (!o.styleEnabled()) return this;
			for (var l = 0; l < s.length; l++) {
				for (var v = s[l]._private, f = v.animation.current, c = 0; c < f.length; c++) {
					var d = f[c]._private;
					a && (d.duration = 0);
				}
...
function Ih() {
	if (cu) return Ei;
	cu = 1;
	return Ei = Ln()["__core-js_shared__"], Ei;
}
var Ci, du;
function Oh() {
	if (du) return Ci;
...
function zh() {
	if (gu) return Si;
	gu = 1;
	var r = Lh(), e = Oh(), t = Na(), a = Nh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, l = s.toString, u = o.hasOwnProperty, v = RegExp("^" + l.call(u).replace(n, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
	function f(c) {
		if (!t(c) || e(c)) return !1;
		return (r(c) ? v : i).test(a(c));
	}
	return Si = f, Si;
}
var ki, pu;
...
function _h() {
	if (xu) return Ri;
	xu = 1;
	var r = Fn(), e = "__lodash_hash_undefined__", a = Object.prototype.hasOwnProperty;
	function n(i) {
		var s = this.__data__;
		if (r) {
			var o = s[i];
...
function Gh() {
	if (Eu) return Mi;
	Eu = 1;
	var r = Fn(), t = Object.prototype.hasOwnProperty;
	function a(n) {
		var i = this.__data__;
...
function Uh() {
	if (Bu) return Fi;
	Bu = 1;
	var r = Vn(), t = Array.prototype.splice;
	function a(n) {
...
function Iv() {
	if (Wu) return es;
	Wu = 1;
	var r = sg(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g;
	return es = r(function(n) {
		var i = [];
...
function hg() {
	if (el) return vs;
	el = 1;
	var r = dg(), e = Lv(), a = Object.prototype.hasOwnProperty;
	function n(i, s, o) {
		var l = i[s];
		...
		return e = be({}, {
			...
			if (ge(n)) {
				...
				for (var x = 0; x < C.length; x++) {
					w = C[x], E = b[w];
					if (!s.immutableKeys[w]) for (var k = 0; k < u.length; k++) {
						var D = u[k];
		...
		return e = be({}, {
			...
			if (ge(n)) {
				for (var u = n.split(/\s+/), v = u.length, f = 0; f < v; f++) {
					var c = u[f];
					if (!ut(c)) {
						if (!i.immutableKeys[c]) for (var d = 0, y = l.length; d < y; d++) l[d]._private[i.field][c] = void 0;
					}
				}
				i.triggerEvent && s[i.triggerFnName](i.event);
			} else if (n === void 0) {
				for (var g = 0, p = l.length; g < p; g++) for (var m = l[g]._private[i.field], b = Object.keys(m), w = 0; w < b.length; w++) {
					var E = b[w];
					!i.immutableKeys[E] && (m[E] = void 0);
				}
				i.triggerEvent && s[i.triggerFnName](i.event);
			}
			return s;
...
var kg = {
	...
	toggleClass: function(e, t) {
		_e(e) || (e = e.match(/\S+/g) || []);
		for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++) for (var l = a[s], u = l._private.classes, v = !1, f = 0; f < e.length; f++) {
...
(function() {
	...
	for (r = Me.comparatorOp.split("|"), t = 0; t < r.length; t++) e = r[t], !(e.indexOf("!") >= 0) && e !== "=" && (Me.comparatorOp += "|\\!" + e);
})();
var qe = function() {
	return { checks: [] };
}, se = {
	...
	},
	{
		...
		populate: function(e, t, a) {
			...
			(/* @__PURE__ */ new RegExp("^" + Me.string + "$")).exec(o) != null ? o = o.substring(1, o.length - 1) : o = parseFloat(o), t.checks.push({
		...
		populate: function(e, t) {
			if (e.currentSubject == null) {
				...
				return s.checks.push({
					...
					right: l,
					subject: u
				}), u.checks = t.checks, t.checks = [{ type: se.TRUE }], f.checks.push({ type: se.TRUE }), l.checks.push({
					type: se.PARENT,
					parent: f,
					child: v
	...
	},
	{
		...
		regex: Me.subject,
		populate: function(e, t) {
			if (e.currentSubject != null && e.currentSubject !== t) return Ve("Redefinition of subject in selector `" + e.toString() + "`"), !1;
			e.currentSubject = t;
...
var Ag = function(e) {
	...
	for (var u = 0; u < t.length; u++) {
		var v = t[u];
		if (v.compoundCount > 0 && v.edgeCount > 0) return Ve("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), !1;
		if (v.edgeCount > 1) return Ve("The selector `" + e + "` is invalid because it uses multiple edge selectors"), !1;
	...
	for (var e = function(v) {
		...
		switch (c) {
			...
			case se.DATA_BOOL:
				...
				return "[" + e(p) + m + "]";
			case se.DATA_EXIST: return "[" + v.field + "]";
			case se.META_COMPARE:
				var w = v.operator;
				return "[[" + v.field + a(e(w)) + t(h) + "]]";
			case se.STATE: return h;
			case se.ID: return "#" + h;
			case se.CLASS: return "." + h;
			case se.PARENT:
			case se.CHILD: return i(v.parent, f) + a(">") + i(v.child, f);
			case se.ANCESTOR:
			case se.DESCENDANT: return i(v.ancestor, f) + " " + i(v.descendant, f);
...
var Fg = function(e) {
	var t = this;
	if (t.length === 1 && t[0].checks.length === 1 && t[0].checks[0].type === se.ID) return e.getElementById(t[0].checks[0].value).collection();
	var a = function(i) {
	...
	this.inputText = e, this.currentSubject = null, this.compoundCount = 0, this.edgeCount = 0, this.length = 0, e == null || ge(e) && e.match(/^\s*$/) || (Dr(e) ? this.addQuery({ checks: [{
		type: se.COLLECTION,
		value: e.collection()
	}] }) : Ue(e) ? this.addQuery({ checks: [{
		type: se.FILTER,
		value: e
...
var Rr = function(e, t) {
	return function(n, i, s, o) {
		...
		if (l == null ? v = "" : Dr(l) && l.length === 1 && (v = l.id()), u.length === 1 && v) {
			var f = u[0]._private, c = f.traversalCache = f.traversalCache || {}, h = c[t] = c[t] || [], d = Dt(v);
			return h[d] || (h[d] = e.call(u, n, i, s, o));
...
function lo(r, e, t, a) {
	for (var n = [], i = new ra(), o = r.cy().hasCompoundNodes(), l = 0; l < r.length; l++) {
		var u = r[l];
...
Or = Gv = {
	...
	renderedPosition: function(e, t) {
		...
		else return o = On(a.position(), i, s), e === void 0 ? o : o[e];
		else if (!l) return;
		return this;
	},
...
pt.updateCompoundBounds = function() {
	...
	function t(s) {
		...
		function d(k, D, B, P) {
			if (B.units === "%") switch (P) {
				case "width": return k > 0 ? B.pfValue * k : 0;
				case "height": return D > 0 ? B.pfValue * D : 0;
				case "average": return k > 0 && D > 0 ? B.pfValue * (k + D) / 2 : 0;
				case "min": return k > 0 && D > 0 ? k > D ? B.pfValue * D : B.pfValue * k : 0;
				case "max": return k > 0 && D > 0 ? k > D ? B.pfValue * k : B.pfValue * D : 0;
				default: return 0;
			}
...
var Ar = function(e) {
	...
	if (!t.cy().headless()) {
		...
		if (t.pstyle(n + "label").strValue) {
			var l = t.pstyle("text-halign"), u = t.pstyle("text-valign"), v = fa(s, "labelWidth", a), f = fa(s, "labelHeight", a), c = fa(s, "labelX", a), h = fa(s, "labelY", a), d = t.pstyle(n + "text-margin-x").pfValue, y = t.pstyle(n + "text-margin-y").pfValue, g = t.isEdge(), p = t.pstyle(n + "text-rotation"), m = t.pstyle("text-outline-width").pfValue, w = t.pstyle("text-border-width").pfValue / 2, E = t.pstyle("text-background-padding").pfValue, C = 2, x = f, T = v, k = T / 2, D = x / 2, B, P, A, R;
	...
	if (!(a === 0 || n <= 0 || i === "inside")) {
		...
		if (u.hasMiterBounds) {
			i === "center" && (n /= 2);
			tt(e, u.miterBounds(f, c, h, d, n));
		} else s != null && s > 0 && ln(e, [
			s,
			s,
			s,
			s
	...
	if (b) {
		...
		if (n && (k = e.pstyle("width").pfValue, D = k / 2), l && t.includeNodes) {
			var B = e.position();
			d = B.x, y = B.y;
			var A = e.outerWidth() / 2, L = e.outerHeight() / 2;
			...
			if (v = Math.min(g.srcX, g.midX, g.tgtX), f = Math.max(g.srcX, g.midX, g.tgtX), c = Math.min(g.srcY, g.midY, g.tgtY), h = Math.max(g.srcY, g.midY, g.tgtY), v -= D, f += D, c -= D, h += D, Ir(s, v, c, f, h), I === "haystack") {
				...
				if (G != null) for (var N = 0; N < G.length; N++) {
					var F = G[N];
					v = F.x - D, f = F.x + D, c = F.y - D, h = F.y + D, Ir(s, v, c, f, h);
				}
			}
		} else {
			var Q = e.source().position(), j = e.target().position();
	...
	var a = e._private, n, i = e.isEdge(), o = (t == null ? ll : $v(t)) === ll;
...
pt.boundingBox = function(r) {
	...
	if (t && this.length === 1 && !a(this[0])) r === void 0 ? r = Pa : r = vl(r), e = ul(this[0], r);
		...
		e = wr(), r = r || Pa;
		var n = vl(r), i = this, o = i.cy().styleEnabled();
...
}, np = be({}, Hg, Ug, Kg, Object.keys(fl).reduce(function(r, e) {
	var t = fl[e], a = tp(e);
	return r[e] = function() {
...
var dt = Gn.prototype, Qv = function(e, t, a, n, i, s, o) {
	...
	for (var l = _e(a) ? a : a.split(/\s+/), u = 0; u < l.length; u++) {
		...
		if (!ut(v)) {
			...
			if (f) {
				var c = f[1];
				if (t(e, v, c, f[2] ? f[2] : null, n, i, s) === !1) break;
			}
		}
	}
}, dl = function(e, t) {
...
dt.removeListener = dt.off = function(r, e, t, a) {
	...
	for (var i = this.listeners, s = function(u) {
		...
		Qv(n, function(f, c, h, d, y, g) {
			if ((v.type === h || r === "*") && (!d && v.namespace !== ".*" || v.namespace === d) && (!y || f.qualifierCompare(v.qualifier, y)) && (!g || v.callback === g)) return i.splice(u, 1), !1;
		}, r, e, t, a);
...
var up = {
	...
	on: function(e, t, a) {
		for (var n = rn(t), i = 0; i < this.length; i++) this[i].emitter().on(e, n, a);
		return this;
	},
	removeListener: function(e, t, a) {
		for (var n = rn(t), i = 0; i < this.length; i++) this[i].emitter().removeListener(e, n, a);
		return this;
	},
	...
	one: function(e, t, a) {
		for (var n = rn(t), i = 0; i < this.length; i++) this[i].emitter().one(e, n, a);
		return this;
	},
	once: function(e, t, a) {
		for (var n = rn(t), i = 0; i < this.length; i++) this[i].emitter().on(e, n, a, {
	...
	xor: function(e) {
		...
		var a = this.spawn(), n = this, i = e, s = function(l, u) {
			for (var v = 0; v < l.length; v++) {
				var f = l[v], c = f._private.data.id;
				u.hasElementWithId(c) || a.push(f);
			}
		};
	...
	diff: function(e) {
		...
		var a = this.spawn(), n = this.spawn(), i = this.spawn(), s = this, o = e, l = function(v, f, c) {
			for (var h = 0; h < v.length; h++) {
				var d = v[h], y = d._private.data.id;
				f.hasElementWithId(y) ? i.merge(d) : c.push(d);
			}
		};
...
var lp = {
	...
	if (s !== 0) return s;
	function o(v) {
		return v.pstyle("z-index-compare").value === "auto" && v.isNode() ? 1 : 0;
	}
	var l = o(e) - o(t);
	if (l !== 0) return l;
	...
	forEach: function(e, t) {
		if (Ue(e)) for (var a = this.length, n = 0; n < a; n++) {
			var i = this[n];
			if ((t ? e.apply(t, [
				i,
				n,
...
var vp = function() {
	var e = "undefined";
	(typeof Symbol > "u" ? "undefined" : ar(Symbol)) != e && ar(Symbol.iterator) != e && (Sn[Symbol.iterator] = function() {
		var a = this, n = {
			value: void 0,
			done: !1
		}, i = 0, s = this.length;
...
vp();
var fp = cr({ nodeDimensionsIncludeLabels: !1 }), fn = {
	...
	layoutPositions: function(e, t, a) {
		...
		var u = function(C, x, T) {
			...
			var x = l(E, C);
			if (v) x = u(Math.abs(t.spacingFactor), c, x);
			return t.transform != null && (x = t.transform(E, x)), x;
		}, o);
		if (t.animate) {
			for (var d = 0; d < n.length; d++) {
				var y = n[d], g = h(y, d);
				if (t.animateFilter == null || t.animateFilter(y, d)) {
					var m = y.animation({
						position: g,
		...
		} else n.positions(h), t.fit && i.fit(t.eles, t.padding), t.zoom != null && i.zoom(t.zoom), t.pan && i.pan(t.pan), e.one("layoutready", t.ready), e.emit({
			type: "layoutready",
			layout: e
		}), e.one("layoutstop", t.stop), e.emit({
			type: "layoutstop",
...
vr.interactive = Wn("interactive", vo({
	ok: Hn("eleInteractive", function(r) {
		return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && aa(r);
	}),
	parentOk: Hn("parentInteractive", function(r) {
...
be(gr, {
	...
	edgesTo: Rr(bl({ thisIsSrc: !0 }), "edgesTo")
});
function bl(r) {
	return function(t) {
		...
		for (var s = 0; s < t.length; s++) for (var o = t[s]._private.edges, l = 0; l < o.length; l++) {
			var u = o[l], v = u._private.data, f = this.hasElementWithId(v.source) && t.hasElementWithId(v.target), c = t.hasElementWithId(v.source) && this.hasElementWithId(v.target);
			(f || c) && ((i.thisIsSrc || i.thisIsTgt) && (i.thisIsSrc && !f || i.thisIsTgt && !c) || a.push(u));
		}
...
function wl(r) {
	return r = be({}, { codirected: !1 }, r), function(a) {
		for (var n = [], i = this.edges(), s = r, o = 0; o < i.length; o++) for (var l = i[o], u = l._private, v = u.source, f = v._private.data.id, c = u.data.target, h = v._private.edges, d = 0; d < h.length; d++) {
		...
		if (Le(r)) {
			if (t.startBatch(), r.data) {
				...
				if (e.isEdge()) {
					...
					u && (v != null || n.parent != null) && v != n.parent && (v === void 0 && (v = null), v != null && (v = "" + v), e = e.move({ parent: v }));
				}
			}
...
He.restore = function() {
	...
	for (var B = 0; B < i.length; B++) {
		...
		var R = A.parent;
		if (R != null || P._private.parent) {
			var I = P._private.parent ? a.collection().merge(P._private.parent) : a.getElementById(R);
			if (I.empty()) A.parent = void 0;
			else if (I[0].removed()) Ve("Node added with missing parent, reference to parent removed"), A.parent = void 0, P._private.parent = null;
			else {
...
He.move = function(r) {
	...
	if (r.source !== void 0 || r.target !== void 0) {
		...
		var v = i(r.parent);
		if (v === null || e.hasElementWithId(v)) {
...
function yp(r, e, t, a) {
	var n = 4, i = .001, s = 1e-7, o = 10, l = 11, u = 1 / (l - 1), v = typeof Float32Array < "u";
...
var mp = function() {
	...
	function t(a, n) {
		var i = {
			dx: a.v,
			dv: r(a)
		}, s = e(a, n * .5, i), o = e(a, n * .5, s), l = e(a, n, o), u = 1 / 6 * (i.dx + 2 * (s.dx + o.dx) + l.dx), v = 1 / 6 * (i.dv + 2 * (s.dv + o.dv) + l.dv);
	...
	ease: Ge(.25, .1, .25, 1),
	"ease-in": Ge(.42, 0, 1, 1),
	"ease-out": Ge(0, 0, .58, 1),
	"ease-in-out": Ge(.42, 0, .58, 1),
	"ease-in-sine": Ge(.47, 0, .745, .715),
	"ease-out-sine": Ge(.39, .575, .565, 1),
	"ease-in-out-sine": Ge(.445, .05, .55, .95),
	"ease-in-quad": Ge(.55, .085, .68, .53),
	"ease-out-quad": Ge(.25, .46, .45, .94),
	"ease-in-out-quad": Ge(.455, .03, .515, .955),
	"ease-in-cubic": Ge(.55, .055, .675, .19),
	"ease-out-cubic": Ge(.215, .61, .355, 1),
	"ease-in-out-cubic": Ge(.645, .045, .355, 1),
	"ease-in-quart": Ge(.895, .03, .685, .22),
	"ease-out-quart": Ge(.165, .84, .44, 1),
	"ease-in-out-quart": Ge(.77, 0, .175, 1),
	"ease-in-quint": Ge(.755, .05, .855, .06),
	"ease-out-quint": Ge(.23, 1, .32, 1),
	"ease-in-out-quint": Ge(.86, 0, .07, 1),
	"ease-in-expo": Ge(.95, .05, .795, .035),
	"ease-out-expo": Ge(.19, 1, .22, 1),
	"ease-in-out-expo": Ge(1, 0, 0, 1),
	"ease-in-circ": Ge(.6, .04, .98, .335),
	"ease-out-circ": Ge(.075, .82, .165, 1),
	"ease-in-out-circ": Ge(.785, .135, .15, .86),
...
function bp(r, e, t, a) {
	var n = !a, i = r._private, s = e._private, o = s.easing, l = s.startTime, v = (a ? r : r.cy()).style();
	if (!s.easingImpl) if (o == null) s.easingImpl = cn.linear;
	else {
		var f;
		if (ge(o)) f = v.parse("transition-timing-function", o).value;
		else f = o;
		var h, d;
		...
		if (c || f && h) {
			...
			for (var y = 0; y < d.length; y++) {
				for (var g = d[y], p = g.name, m = !1, b = l + 1; b < t.length; b++) {
					var w = t[b];
					if (e[b] === wa && (m = w.properties[g.name] != null, m)) break;
				}
...
ur.getContextMeta = function(r) {
	for (var e = this, t = "", a, n = r._private.styleCxtKey || "", i = 0; i < e.length; i++) {
		var s = e[i];
		s.selector && s.selector.matches(r) ? t += wa : t += Sp;
	}
...
ur.getContextStyle = function(r) {
	...
	for (var n = { _private: { key: e } }, i = 0; i < t.length; i++) {
		var s = t[i];
		if (e[i] === wa) for (var l = 0; l < s.properties.length; l++) {
	...
	for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
		...
		if (v !== u) {
			if (u.mapped === s.fn && v != null && v.mapping != null && v.mapping.value === u.value) {
				var f = v.mapping;
				if ((f.fnValue = u.value(t)) === f.prevFnValue) continue;
			}
			var h = i[l] = { prev: v };
...
ur.updateStyleHints = function(r) {
	...
	for (var f = function(H, Y) {
		...
		if (b != null) {
			...
			var T = w.enums == null ? b.value : null, k = x != null, B = k || T != null, P = b.units;
			if (E.number && B && !E.multiple) h(g(k ? x : T), C), !k && P != null && d(P, C);
			else d(b.strValue, C);
		}
	}
	...
	if (o) {
		var F = e.styleKeys, U = F.nodeBody, Q = F.nodeBorder, K = F.nodeOutline, j = F.backgroundImage, re = F.compound, ne = F.pie, J = F.stripe;
		e.nodeKey = et([
			U,
			Q,
			K,
			...
			return q != null;
		}).reduce(Xa, [Tt, Ht])), e.hasPie = ne != null && ne[0] !== Tt && ne[1] !== Ht, e.hasStripe = J != null && J[0] !== Tt && J[1] !== Ht;
	}
	return s !== e.styleKey;
};
...
ur.applyParsedProperty = function(r, e) {
	...
	if (e.name === "curve-style" && r.isEdge() && (e.value !== "bezier" && r.isLoop() || e.value === "haystack" && (r.source().isParent() || r.target().isParent())) && (a = e = this.parse(e.name, "bezier", l)), a.delete) return n[a.name] = void 0, d(), !0;
	...
	switch (a.mapped) {
		case s.mapData:
			...
			} else return Ve("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), !1;
			if (w < 0 ? w = 0 : w > 1 && (w = 1), o.color) {
				var C = a.valueMin[0], x = a.valueMax[0], T = a.valueMin[1], k = a.valueMax[1], D = a.valueMin[2], B = a.valueMax[2], P = a.valueMin[3] == null ? 1 : a.valueMin[3], A = a.valueMax[3] == null ? 1 : a.valueMax[3], R = [
					Math.round(C + (x - C) * w),
					Math.round(T + (k - T) * w),
					Math.round(D + (B - D) * w),
					Math.round(P + (A - P) * w)
		...
		case s.fn:
			...
			if (a.prevFnValue = N, N == null) return Ve("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), !1;
			if (i = this.parse(a.name, N, a.bypass, c), !i) return Ve("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), !1;
			i.mapping = qr(a), a = i;
			break;
		case void 0: break;
		default: return !1;
...
ur.updateTransitions = function(r, e) {
	...
	if (n.length > 0 && i > 0) {
		for (var o = {}, l = !1, u = 0; u < n.length; u++) {
			...
			if (c) {
				var d = c.prev, y = c.next != null ? c.next : f, g = !1, p = void 0, m = 1e-6;
...
_a.applyBypass = function(r, e, t, a) {
	...
	if (e === "*" || e === "**") {
		if (t !== void 0) for (var o = 0; o < n.properties.length; o++) {
			var u = n.properties[o].name, v = this.parse(u, t, !0);
			v && i.push(v);
		}
	} else if (ge(e)) {
...
_a.removeBypasses = function(r, e, t) {
	for (var a = !0, n = 0; n < r.length; n++) {
		for (var i = r[n], s = {}, o = 0; o < e.length; o++) {
			...
			if (!(!v || !v.bypass)) {
				var c = this.parse(l, "", !0), h = s[u.name] = { prev: v };
	...
	if (r = r[0], r) {
		...
		if (s) {
			...
			if (t && i.number && o != null && ae(o)) {
				...
				return (h ? l.every(function(y) {
					return y != null;
				}) : l != null) ? h ? o.map(function(y, g) {
					return c(y, l[g]);
...
_r.getNonDefaultPropertiesHash = function(r, e, t) {
	...
	for (l = 0; l < e.length; l++) if (n = e[l], i = r.pstyle(n, !1), i != null) if (i.pfValue != null) a[0] = Ca(o, a[0]), a[1] = Ta(o, a[1]);
	else for (s = i.strValue, u = 0; u < s.length; u++) o = s.charCodeAt(u), a[0] = Ca(o, a[0]), a[1] = Ta(o, a[1]);
	return a;
};
...
(function() {
	...
	Qe.types = {
		...
		edgeEndpoint: {
			...
			validate: function(q, H) {
				switch (q.length) {
					case 2: return H[0] !== "deg" && H[0] !== "rad" && H[1] !== "deg" && H[1] !== "rad";
					case 1: return ge(q[0]) || H[0] === "deg" || H[0] === "rad";
					default: return !1;
				}
			}
		},
	...
	for (var R = 1; R <= Qe.pieBackgroundN; R++) A.push({
	...
	for (var I = 1; I <= Qe.stripeBackgroundN; I++) L.push({
	...
	(Qe.propertyGroupKeys = Object.keys(G)).forEach(function(z) {
...
Un.parse = function(r, e, t, a) {
	...
	var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = t ? "t" : "f", l = cv(r, "" + e, s, i), u = n.propCache = n.propCache || [], v;
...
Un.parseImpl = function(r, e, t, a) {
	...
	if (!(!l || a || e.length < 7 || e[1] !== "a")) {
		if (e.length >= 7 && e[0] === "d" && (v = new RegExp(o.data.regex).exec(e))) {
			...
			if (d.pfValue === y.pfValue || d.strValue === y.strValue) return Ve("`" + r + ": " + e + "` is not a valid mapper because the output range is zero; converting to `" + r + ": " + d.strValue + "`"), this.parse(r, d.strValue);
			if (u.color) {
				var g = d.value, p = y.value;
				if (g[0] === p[0] && g[1] === p[1] && g[2] === p[2] && (g[3] === p[3] || (g[3] == null || g[3] === 1) && (p[3] == null || p[3] === 1))) return !1;
			}
			return {
				name: r,
				value: f,
	...
	if (u.number) {
		var P, A = "px";
		if (u.units && (P = u.units), u.implicitUnits && (A = u.implicitUnits), !u.unitless) if (l) {
		...
		if (u.integer && !cc(e) || u.min !== void 0 && (e < u.min || u.strictMin && e === u.min) || u.max !== void 0 && (e > u.max || u.strictMax && e === u.max)) return null;
		var I = {
			name: r,
			value: e,
			strValue: "" + e + (P || ""),
...
var kp = {
	...
	selectionType: function(e) {
		var t = this._private;
		if (t.selectionType ??= Dp, e !== void 0) (e === "additive" || e === "single") && (t.selectionType = e);
	...
	getZoomedViewport: function(e) {
		...
		if (t.zoomingEnabled || (o = !0), ae(e) ? s = e : Le(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y))) return null;
		if (i != null) {
			var l = a, u = n, v = s;
			return {
				zoomed: !0,
...
var Ra = function(e) {
	...
	o.layout = be({ name: s ? "grid" : "null" }, o.layout), o.renderer = be({ name: s ? "canvas" : "null" }, o.renderer);
	...
	var v = function(d, y) {
		if (d.some(pc)) return ta.all(d).then(y);
		y(d);
	};
...
be(kn, {
	...
	window: function() {
		if (this._private.container == null) return rr;
	...
	mount: function(e) {
		if (e != null) {
			...
			return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(be({}, n, n.renderer, { name: n.renderer.name === "null" ? "canvas" : n.renderer.name })), t.startAnimationLoop(), t.style(n.style), t.emit("mount"), t;
		}
	},
	unmount: function() {
		var e = this;
...
af.prototype.run = function() {
	...
	if (i && s) {
		...
		for (a.forEach(function(ye) {
			...
			var R = A(), L = k(R, B);
			if (L) R.outgoers().filter(function(ye) {
	...
	var I = 0;
	if (r.avoidOverlap) for (var M = 0; M < a.length; M++) {
		var V = a[M].layoutDimensions(r), G = V.w, N = V.h;
		I = Math.max(I, G, N);
	}
	var F = {}, U = function(ie) {
	...
	var H = {
		...
		w: -1,
		h: -1
	}), te = Math.max(K === 1 ? 0 : o ? (l.h - r.padding * 2 - Y.h) / (K - 1) : (l.h - r.padding * 2 - Y.h) / (K + 1), I), ce = p.reduce(function(ye, ie) {
		...
		if (r.circle) {
			...
			var Oe = p[he].length, Ne = Math.max(Oe === 1 ? 0 : o ? (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) - 1) : (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) + 1), I);
			return {
...
nf.prototype.run = function() {
	...
	for (var s = wr(e.boundingBox ? e.boundingBox : {
		...
		x: s.x1 + s.w / 2,
		y: s.y1 + s.h / 2
	}, u = (e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / i.length : e.sweep) / Math.max(1, i.length - 1), v, f = 0, c = 0; c < i.length; c++) {
		var d = i[c].layoutDimensions(e), y = d.w, g = d.h;
		f = Math.max(f, y, g);
	}
	...
	var w = function(C, x) {
		var T = e.startAngle + x * u * (n ? 1 : -1), k = v * Math.cos(T), D = v * Math.sin(T);
		return {
			x: o.x + k,
			y: o.y + D
		};
...
sf.prototype.run = function() {
	...
	for (var g = e.levelWidth(i), p = [[]], m = p[0], b = 0; b < l.length; b++) {
		var w = l[b];
		if (m.length > 0) Math.abs(m[0].value - w.value) >= g && (m = [], p.push(m));
		m.push(w);
	}
	var C = u + e.minNodeSpacing;
	if (!e.avoidOverlap) {
		var x = p.length > 0 && p[0].length > 1, k = (Math.min(s.w, s.h) / 2 - C) / (p.length + x ? 1 : 0);
		C = Math.min(C, k);
	}
	for (var D = 0, B = 0; B < p.length; B++) {
		var P = p[B], R = P.dTheta = (e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / P.length : e.sweep) / Math.max(1, P.length - 1);
	...
	for (var K = {}, j = 0; j < p.length; j++) for (var re = p[j], ne = re.dTheta, J = re.r, z = 0; z < re.length; z++) {
...
Kn.prototype.run = function() {
	...
	if (r.animate === !0) {
		var v = function() {
			...
			if (!u) kl(a, r), o();
			else Yr() - n >= r.animationThreshold && i(), wn(v);
		};
		v();
	} else {
		for (; u;) u = s(l), l++;
...
var Lp = function(e, t, a) {
	for (var n = a.eles.edges(), i = a.eles.nodes(), s = wr(a.boundingBox ? a.boundingBox : {
		...
		clientHeight: s.h,
		boundingBox: s
	}, l = a.eles.components(), u = {}, v = 0; v < l.length; v++) for (var f = l[v], c = 0; c < f.length; c++) {
		var h = f[c];
		u[h.id()] = v;
	}
	...
	for (var v = 0; v < o.graphSet.length; v++) for (var k = o.graphSet[v], c = 0; c < k.length; c++) {
	...
	for (var v = 0; v < o.edgeSize; v++) {
		...
		var A = Ue(a.idealEdgeLength) ? a.idealEdgeLength(B) : a.idealEdgeLength, R = Ue(a.edgeElasticity) ? a.edgeElasticity(B) : a.edgeElasticity, L = o.idToIndex[P.sourceId], I = o.idToIndex[P.targetId];
		if (o.indexToGraph[L] != o.indexToGraph[I]) {
			for (var V = Ip(P.sourceId, P.targetId, o), G = o.graphSet[V], N = 0, g = o.layoutNodes[L]; G.indexOf(g.id) === -1;) g = o.layoutNodes[o.idToIndex[g.parentId]], N++;
	...
	return t.boundingBox && (a.forEach(function(s) {
		...
		if (t.boundingBox) {
			var u = i.w === 0 ? .5 : (l.positionX - i.x1) / i.w, v = i.h === 0 ? .5 : (l.positionY - i.y1) / i.h;
			return {
				x: n.x1 + u * n.w,
				y: n.y1 + v * n.h
			};
	...
	if (!(e.cmptId !== t.cmptId && !a.isCompound)) {
		...
		var v = _p(e, t, o, l);
		if (v > 0) var f = n.nodeOverlap * v, c = Math.sqrt(o * o + l * l), h = f * o / c, d = f * l / c;
		else var y = Dn(e, o, l), g = Dn(t, -1 * o, -1 * l), p = g.x - y.x, m = g.y - y.y, b = p * p + m * m, c = Math.sqrt(b), f = (e.nodeRepulsion + t.nodeRepulsion) / b, h = f * p / c, d = f * m / c;
	...
	if (t.gravity !== 0) for (var a = 1, n = 0; n < e.graphSet.length; n++) {
		...
		else var u = e.layoutNodes[e.idToIndex[i[0]]], v = e.layoutNodes[e.idToIndex[u.parentId]], o = v.positionX, l = v.positionY;
		for (var f = 0; f < s; f++) {
	...
	if (a != null) {
		...
		if ((n.maxX == null || e.maxX + n.padRight > n.maxX) && (n.maxX = e.maxX + n.padRight, i = !0), (n.minX == null || e.minX - n.padLeft < n.minX) && (n.minX = e.minX - n.padLeft, i = !0), (n.maxY == null || e.maxY + n.padBottom > n.maxY) && (n.maxY = e.maxY + n.padBottom, i = !0), (n.minY == null || e.minY - n.padTop < n.minY) && (n.minY = e.minY - n.padTop, i = !0), i) return lf(n, t);
	}
}, kl = function(e, t) {
	...
	for (var u = 0, i = 0; i < n.length; i++) {
		var v = n[i];
		if (v) {
			v.x1 = Infinity, v.x2 = -Infinity, v.y1 = Infinity, v.y2 = -Infinity;
...
vf.prototype.run = function() {
	...
	if (i.h === 0 || i.w === 0) a.nodes().layoutPositions(this, e, function(U) {
		...
		var s = n.size(), o = Math.sqrt(s * i.h / i.w), l = Math.round(o), u = Math.round(i.w / i.h * o), v = function(Q) {
			...
			Math.min(l, u) == l ? l = Q : u = Q;
		}, f = function(Q) {
			if (Q == null) return Math.max(l, u);
			Math.max(l, u) == l ? l = Q : u = Q;
		...
		var m = i.w / u, b = i.h / l;
		if (e.condense && (m = 0, b = 0), e.avoidOverlap) for (var w = 0; w < n.length; w++) {
...
ff.prototype.run = function() {
	var r = this.options, t = r.eles.nodes(), a = Ue(r.positions);
	function n(i) {
...
var go = {};
go.arrowShapeWidth = .3;
go.registerArrowShapes = function() {
	var r = this.arrowShapes = {}, e = this, t = function(u, v, f, c, h, d, y) {
		var g = h.x - f / 2 - y, p = h.x + f / 2 + y, m = h.y - f / 2 - y, b = h.y + f / 2 + y;
		return g <= u && u <= p && m <= v && v <= b;
	}, a = function(u, v, f, c, h) {
		var d = u * Math.cos(c) - v * Math.sin(c), y = u * Math.sin(c) + v * Math.cos(c), g = d * f, p = y * f;
		return {
			x: g + h.x,
			y: p + h.y
		};
		...
		ge(v) && (v = r[v]), r[u] = be({
			...
			collide: function(c, h, d, y, g, p) {
				return Sr(c, h, i(n(this.points, d + 2 * p, y, g)));
			},
			roughCollide: t,
	...
	o("none", {
		...
		collide: function(u, v, f, c, h, d, y) {
			var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.pointsTee, f + 2 * y, c, h));
			return Sr(u, v, g) || Sr(u, v, p);
		},
		draw: function(u, v, f, c, h) {
		...
		collide: function(u, v, f, c, h, d, y) {
			...
			return Sr(u, v, i(n(this.points, f + 2 * y, c, h))) || p;
		},
		draw: function(u, v, f, c, h) {
		...
		collide: function(u, v, f, c, h, d, y) {
			var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.crossLinePts(f, d), f + 2 * y, c, h));
			return Sr(u, v, g) || Sr(u, v, p);
		},
		draw: function(u, v, f, c, h) {
		...
		collide: function(u, v, f, c, h, d, y) {
			var g = h;
			return Math.pow(g.x - u, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2);
		},
		draw: function(u, v, f, c, h) {
...
Mt.findContainerClientCoords = function() {
	...
	}, s = r.clientWidth, o = r.clientHeight, l = n.left + n.right, u = n.top + n.bottom, v = i.left + i.right, f = e.width / (s + v), c = s - l, h = o - u;
...
Mt.findNearestElements = function(r, e, t, a) {
	var n = this, i = this, s = i.getCachedZSortedEles(), o = [], l = i.cy.zoom(), u = i.cy.hasCompoundNodes(), v = (a ? 24 : 8) / l, f = (a ? 8 : 2) / l, c = (a ? 8 : 2) / l, h = Infinity, d, y;
	t && (s = s.interactive);
	function g(x, T) {
		if (x.isNode()) {
			if (y) return;
		...
		if (x.isEdge() && (T == null || T < h)) if (d) {
			if (d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value && d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value) {
				for (var k = 0; k < o.length; k++) if (o[k].isEdge()) {
					o[k] = x, d = x, h = T ?? h;
					break;
				}
			}
	...
	function p(x) {
		...
		if (P.x - D <= r && r <= P.x + D && P.y - B <= e && e <= P.y + B) {
			if (i.nodeShapes[n.getNodeShape(x)].checkPoint(r, e, 0, T, k, P.x, P.y, A, R)) return g(x, 0), !0;
		}
	}
	function m(x) {
		...
		if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
			for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2) if (Rd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) && A > (L = Nd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3]))) return g(x, L), !0;
		} else if (k.edgeType === "bezier" || k.edgeType === "multibezier" || k.edgeType === "self" || k.edgeType === "compound") {
			for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4) if (Md(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) && A > (L = Od(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5]))) return g(x, L), !0;
		}
	...
	function w(x, T) {
		...
		var P = k.labelBounds[T || "main"], A = x.pstyle(B + "label").value;
		if (!(!(x.pstyle("text-events").strValue === "yes") || !A)) {
			...
			if (M) {
				...
				}, re = j(G, F), ne = j(G, U), J = j(N, F), z = j(N, U);
				if (Sr(r, e, [
					re.x + O,
					re.y + V,
					J.x + O,
...
Mt.getAllInBox = function(r, e, t, a) {
	var n = this.getCachedZSortedEles().interactive, s = 2 / this.cy.zoom(), o = [], l = Math.min(r, t), u = Math.max(r, t), v = Math.min(e, a), f = Math.max(e, a);
	r = l, t = u, e = v, a = f;
	var c = wr({
		x1: r,
		y1: e,
	...
	for (var m = 0; m < n.length; m++) {
		...
		if (b.isNode()) {
			...
			if (O === "none") continue;
			if (O === "contain") {
				if (M.startX != null && M.startY != null && !nt(c, M.startX, M.startY) || M.endX != null && M.endY != null && !nt(c, M.endX, M.endY)) continue;
				if (M.edgeType === "bezier" || M.edgeType === "multibezier" || M.edgeType === "self" || M.edgeType === "compound" || M.edgeType === "segments" || M.edgeType === "haystack") {
					for (var V = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, G = !0, N = 0; N < V.length; N++) if (!Ko(c, V[N])) {
						G = !1;
						break;
					}
					G && o.push(L);
				...
				var F = !1;
				if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (nt(c, M.startX, M.startY) || nt(c, M.endX, M.endY))) o.push(L), F = !0;
				else if (!F && M.edgeType === "haystack") {
					for (var U = I.rstyle.haystackPts, Q = 0; Q < U.length; Q++) if (Ko(c, U[Q])) {
						o.push(L), F = !0;
						break;
					}
				}
...
Bn.calculateArrowAngles = function(r) {
	...
	if (t ? (v = e.haystackPts[0], f = e.haystackPts[1], c = e.haystackPts[2], h = e.haystackPts[3]) : (v = e.arrowStartX, f = e.arrowStartY, c = e.arrowEndX, h = e.arrowEndY), p = e.midX, m = e.midY, i) l = v - e.segpts[0], u = f - e.segpts[1];
	else if (n || s || o || a) {
		var d = e.allpts, y = sr(d[0], d[2], d[4], .1), g = sr(d[1], d[3], d[5], .1);
		l = v - y, u = f - g;
	} else l = v - p, u = f - m;
	...
	if (t && (p = (v + c) / 2, m = (f + h) / 2), l = c - v, u = h - f, i) {
		...
		if (E.length / 2 % 2 === 0) {
			...
			C = sr(d[D], d[B], d[P], .4999), x = sr(d[D + 1], d[B + 1], d[P + 1], .4999), T = sr(d[D], d[B], d[P], .5), k = sr(d[D + 1], d[B + 1], d[P + 1], .5);
		}
		l = T - C, u = k - x;
	}
	...
	if (e.midsrcArrowAngle = Ya(l, u), i) l = c - e.segpts[e.segpts.length - 2], u = h - e.segpts[e.segpts.length - 1];
	else if (n || s || o || a) {
		var d = e.allpts, R = d.length, y = sr(d[R - 6], d[R - 4], d[R - 2], .9), g = sr(d[R - 5], d[R - 3], d[R - 1], .9);
		l = c - y, u = h - g;
	} else l = c - p, u = h - m;
...
var Ma = .01, ey = Math.sqrt(2 * Ma), yr = {};
yr.findMidptPtsEtc = function(r, e) {
	...
	switch (r.pstyle("edge-distances").value) {
		...
		case "endpoints":
			if (l) {
				var c = Je(this.manualEndptToPx(r.source()[0], s), 2), h = c[0], d = c[1], g = Je(this.manualEndptToPx(r.target()[0], o), 2), p = g[0], m = g[1], b = {
					x1: h,
					y1: d,
					x2: p,
					y2: m
				...
				n = u(h, d, p, m), i = b;
			} else Ve("Edge ".concat(r.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
			break;
	}
	return {
		midptPts: i,
...
yr.findHaystackPoints = function(r) {
	for (var e = 0; e < r.length; e++) {
		...
		var s = a.source, o = a.target, l = s.position(), u = o.position(), v = s.width(), f = o.width(), c = s.height(), h = o.height(), y = t.pstyle("haystack-radius").value / 2;
...
yr.findLoopPoints = function(r, e, t, a) {
	...
	c = i[p] === void 0 ? i[p] = 0 : ++i[p], n.ctrlpts = [
...
yr.findCompoundLoopPoints = function(r, e, t, a) {
	...
	var g = 50, p = {
		...
		x: Math.min(p.x, m.x),
		y: Math.min(p.y, m.y)
	}, w = .5, E = Math.max(w, Math.log(o * Ma)), C = Math.max(w, Math.log(u * Ma));
	n.ctrlpts = [
		b.x,
...
yr.findBezierPoints = function(r, e, t, a, n) {
	...
	for (var h = 0; h < u; h++) {
		var d = (.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1), y = void 0, g = to(d);
...
yr.findTaxiPoints = function(r, e) {
	...
	}, K = Q(N), j = Q(Math.abs(M) - Math.abs(N));
	if ((K || j) && !G) if (I) {
...
yr.storeAllpts = function(r) {
	...
	if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
		...
		var a, n;
		e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = .5, e.midX = sr(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = sr(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n));
...
yr.findEdgeControlPoints = function(r) {
	var e = this;
	if (!(!r || r.length === 0)) {
		for (var t = this, n = t.cy.hasCompoundNodes(), i = new Xr(), s = function(k, D) {
			...
			if (!(v.removed() || !v.takesUpSpace())) {
				...
				var h = c === "unbundled-bezier" || at(c, "segments") || c === "straight" || c === "straight-triangle" || at(c, "taxi"), d = c === "unbundled-bezier" || c === "bezier", y = f.source, g = f.target, b = [y.poolIndex(), g.poolIndex()].sort(), w = s(b, h), E = i.get(w);
				E ?? (E = { eles: [] }, o.push({
					pairId: b,
					edgeIsUnbundled: h
...
yr.getSegmentPoints = function(r) {
	...
	if (e.edgeType === "segments") return yf(e.segpts);
};
...
Ga.findEndpoints = function(r) {
	...
	if (C) {
		...
		O = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : Q, V = Q;
	} else if (T) {
		var j = k ? m.segpts.slice(0, 2) : [v.x + F[0], v.y + F[1]];
		O = k ? m.segpts.slice(m.segpts.length - 2) : [u.x + U[0], u.y + U[1]], V = j;
	}
	if (I === "inside-to-node") s = [v.x, v.y];
		...
		if (Ce.length > 0) {
			...
			if (ie < ye && (s = Ce, de = ie), Ce.length > 2) Et(we, {
				x: Ce[2],
				y: Ce[3]
			}) < de && (s = [Ce[2], Ce[3]]);
		}
	...
	if (m.endX = pe[0], m.endY = pe[1], m.arrowEndX = Ee[0], m.arrowEndY = Ee[1], A === "inside-to-node") s = [u.x, u.y];
		...
		if (_.length > 0) {
			...
			if (Z < $ && (s = [_[0], _[1]], oe = Z), _.length > 2) Et(W, {
				x: _[2],
				y: _[3]
			}) < oe && (s = [_[2], _[3]]);
		}
...
function ry(r, e, t) {
	for (var a = function(u, v, f, c) {
		return sr(u, v, f, c);
	}, i = e._private.rstyle.bezierPts, s = 0; s < r.bezierProjPcts.length; s++) {
...
var mf = function(e, t) {
	...
	return mf(t.x - e.x, t.y - e.y);
}, ty = function(e, t, a, n) {
	var i = ka(0, n - .001, 1), s = ka(0, n + .001, 1);
	return bf(Kt(e, t, a, i), Kt(e, t, a, s));
};
Gr.recalculateEdgeLabelProjections = function(r) {
	...
	if (i.mid || i.source || i.target) {
		...
		s("labelAutoAngle", null, mf(a.midDispX, a.midDispY));
		var l = function() {
			...
			for (var b = 0; b < f.length; b++) {
				...
				for (var C = 0; C < p - 1; C++) m(w, g[b * p + C], g[b * p + C + 1], n.bezierProjPcts[C], n.bezierProjPcts[C + 1]);
...
Gr.getLabelText = function(r, e) {
	...
	if (o === "wrap") {
		...
		for (var u = "​", v = n.split(`
`), f = r.pstyle("text-max-width").pfValue, h = r.pstyle("text-overflow-wrap").value === "anywhere", d = [], y = /[\s\u200b]+|$/g, g = 0; g < v.length; g++) {
			var p = v[g], b = this.calculateLabelDimensions(r, p).width;
			if (h) p = p.split("").join(u);
			if (b > f) {
				...
				try {
					for (T.s(); !(k = T.n()).done;) {
						...
						this.calculateLabelDimensions(r, A).width <= f ? C += P + B : (C && d.push(C), C = P + B);
					}
				} catch (F) {
					T.e(F);
				} finally {
...
`)), s("labelWrapKey", l);
		...
		for (var G = 0; G < n.length; G++) {
			if (this.calculateLabelDimensions(r, M + n[G] + O).width > I) break;
...
Gr.calculateLabelDimensions = function(r, e) {
	var n = this.cy.window().document, i = 0, s = r.pstyle("font-style").strValue, o = r.pstyle("font-size").pfValue, l = r.pstyle("font-family").strValue, u = r.pstyle("font-weight").strValue, v = this.labelCalcCanvas, f = this.labelCalcCanvasContext;
	if (!v) {
...
wf.getNodeShape = function(r) {
	...
	if (t === "cutrectangle" && (r.width() < Ll || r.height() < Ll)) return Il || (Ve("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Il = !0), "rectangle";
...
Xn.recalculateRenderedStyle = function(r, e) {
	...
	if (r.length !== 0) {
		...
		if (!this.destroyed) {
			...
			for (var u = 0; u < n.length; u++) {
				var v = n[u], c = v._private.rstyle, h = v.position();
			...
			for (var d = 0; d < a.length; d++) {
				var g = a[d]._private, p = g.rstyle, m = g.rscratch;
...
ia.load = function() {
	var r = this, e = r.cy.window(), t = function(S) {
		...
		var W = !0;
		if (r.cy.hasCompoundNodes() && S && S.pannable()) for (var $ = 0; _ && $ < _.length; $++) {
			var S = _[$];
		...
		var W = _.addToList;
		!W.has(S) && S.grabbable() && !S.locked() && (W.merge(S), o(S));
	}, d = function(S, _) {
		...
		_.inDragLayer && (S.forEach(u), S.neighborhood().stdFilter(function($) {
			...
			h($, _);
		}), d(S, _), m(S, { inDragLayer: _.inDragLayer }), r.updateCachedGrabbedEles();
	}, g = y, p = function(S) {
	...
	w ? (r.removeObserver = new MutationObserver(function(X) {
		for (var S = 0; S < X.length; S++) {
			var W = X[S].removedNodes;
			if (W) {
				for (var $ = 0; $ < W.length; $++) if (W[$] === r.container) {
					r.destroy();
					break;
				}
			}
		}
	}), r.container.parentNode && r.removeObserver.observe(r.container.parentNode, { childList: !0 })) : r.registerBinding(r.container, "DOMNodeRemoved", function(X) {
		r.destroy();
	});
	var C = Fa(function() {
		r.cy.resize();
	}, 100);
	w && (r.styleObserver = new MutationObserver(C), r.styleObserver.observe(r.container, { attributes: !0 })), r.registerBinding(e, "resize", C), E && (r.resizeObserver = new ResizeObserver(C), r.resizeObserver.observe(r.container));
	var x = function(S, _) {
	...
	var k = function() {
		...
		if (!ve) return !1;
		for (var De = r.container, fe = S.target.parentNode, Pe = !1; fe;) {
			if (fe === De) {
				Pe = !0;
				break;
			}
		...
		if (D(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
			...
			if (S.which == 3) {
				...
				if (ee != null && r.nodeIsGrabbable(ee)) {
					...
					if (f(ee), !ee.selected()) ve = r.dragData.possibleDragElements = _.collection(), g(ee, { addToList: ve }), ee.emit(le("grabon")).emit(le("grab"));
					else {
	...
	r.registerBinding([e, B], "mousemove", function(S) {
		if (!(!r.hoverData.capture && !D(S))) {
			...
			if (le) {
				var Ke = oe[0] - le[0], mr = Ke * Ke, Ye = oe[1] - le[1], er = mr + Ye * Ye;
			...
			if (r.hoverData.which === 3) {
				...
				if (je) {
					if (!r.hoverData.dragging && $.boxSelectionEnabled() && (lr || !$.panningEnabled() || !$.userPanningEnabled())) Wr();
					else if (!r.hoverData.selecting && $.panningEnabled() && $.userPanningEnabled()) s(fe, r.hoverData.downs) && (r.hoverData.dragging = !0, r.hoverData.justStartedPan = !0, me[4] = 0, r.data.bgActivePosistion = Wt(ve), r.redrawHint("select", !0), r.redraw());
				...
				if (fe && fe.pannable() && fe.active() && fe.unactivate(), (!fe || !fe.grabbed()) && De != Te && (Te && n(Te, ["mouseout", "tapdragout"], S, {
					...
					x: ee[0],
					y: ee[1]
				}), r.hoverData.last = De), fe) if (je) {
					if ($.boxSelectionEnabled() && lr) fe && fe.grabbed() && (p(Be), fe.emit(Ze("freeon")), Be.emit(Ze("free")), r.dragData.didDrag && (fe.emit(Ze("dragfreeon")), Be.emit(Ze("dragfree")))), Wr();
					else if (fe && fe.grabbed() && r.nodeIsDraggable(fe)) {
						var Er = !r.dragData.didDrag;
						Er && r.redrawHint("eles", !0), r.dragData.didDrag = !0, r.hoverData.draggingEles || y(Be, { inDragLayer: !0 });
						var hr = {
							x: 0,
							y: 0
						};
			...
			if (me[2] = ee[0], me[3] = ee[1], W) return S.stopPropagation && S.stopPropagation(), S.preventDefault && S.preventDefault(), !1;
		}
	}, !1);
	var P, A, R;
			...
			if (r.hoverData.capture) {
				...
				if (r.hoverData.which === 3) {
					...
					if (n(oe, [
						...
						x: $[0],
						y: $[1]
					}), !r.dragData.didDrag && !r.hoverData.dragged && !r.hoverData.selecting && !r.hoverData.isOverThresholdDrag && (n(ve, [
						"click",
						"tap",
						"vclick"
					], S, {
						x: $[0],
						y: $[1]
					}), A = !1, S.timeStamp - R <= W.multiClickDebounceTime() ? (P && clearTimeout(P), A = !0, R = null, n(ve, [
						"dblclick",
						"dbltap",
						"vdblclick"
					], S, {
	...
	var L = [], I = 4, M, O = 1e5, V = function(S, _) {
		...
		var _ = !1, W = S.deltaY;
		if (W ?? (S.wheelDeltaY != null ? W = S.wheelDeltaY / 4 : S.wheelDelta != null && (W = S.wheelDelta / 4)), W !== 0) {
			if (M == null) if (L.length >= I) {
				var $ = L;
				if (M = V($, 5), !M) {
					var Z = Math.abs($[0]);
					M = G($) && Z > 5;
	...
	r.registerBinding(r.container, "touchstart", Ce = function(S) {
		if (r.hasTouchStarted = !0, !!D(S)) {
			...
			if (S.touches[2]) _.boxSelectionEnabled() && S.preventDefault();
				...
				if (S.touches[0]) {
					...
					if (Be != null && (Be.activate(), r.touchData.start = Be, r.touchData.starts = Pe, r.nodeIsGrabbable(Be))) {
						...
						}), y(Ke, { addToList: je })) : g(Be, { addToList: je }), f(Be), Be.emit(oe("grabon")), Ke ? Ke.forEach(function(er) {
							er.emit(oe("grab"));
						}) : Be.emit(oe("grab"));
					}
					n(Be, [
			...
			if (S.touches.length >= 1) {
				for (var mr = r.touchData.startPosition = [
					null,
					null,
					null,
					null,
					null,
					null
				], Ye = 0; Ye < W.length; Ye++) mr[Ye] = $[Ye] = W[Ye];
				var ir = S.touches[0];
	...
	r.registerBinding(e, "touchmove", we = function(S) {
		...
		if (!(!_ && !D(S))) {
			...
			if (_ && S.touches[0] && me) {
				...
				var Pe = S.touches[0].clientX - me[0], Be = Pe * Pe, je = S.touches[0].clientY - me[1];
				De = Be + je * je >= r.touchTapThreshold2;
			}
			if (_ && r.touchData.cxt) {
				S.preventDefault();
				var Ye = S.touches[0].clientX - z, ir = S.touches[0].clientY - q, er = S.touches[1].clientX - z, lr = S.touches[1].clientY - q, jr = Ae(Ye, ir, er, lr), Ze = jr / re, Wr = 150, $r = Wr * Wr, It = 1.5;
				if (Ze >= It * It || jr >= $r) {
			...
			if (_ && r.touchData.cxt) {
				...
				if (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(Z[0], Z[1], !0, !0)), _ && Mr != null && S.preventDefault(), _ && Mr != null && r.nodeIsDraggable(Mr)) if (De) {
				...
				if (n(Mr || Er, [
					...
					x: Z[0],
					y: Z[1]
				}), (!Mr || !Mr.grabbed()) && Er != Qn && (Qn && Qn.emit(le("tapdragout")), Er && Er.emit(le("tapdragover"))), r.touchData.last = Er, _) for (var Cr = 0; Cr < Z.length; Cr++) Z[Cr] && r.touchData.startPosition[Cr] && De && (r.touchData.singleTouchMoved = !0);
				if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
					s(Mr, r.touchData.starts) && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Wt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
						x: Te[0] * ee,
						y: Te[1] * ee
	...
	if (r.registerBinding(e, "touchend", ie = function(S) {
		var _ = r.touchData.start;
		if (r.touchData.capture) S.touches.length === 0 && (r.touchData.capture = !1), S.preventDefault();
		else return;
		var $ = r.selection;
		...
		if (_?.unactivate(), S.touches[2]) r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
		else if (!S.touches[1]) {
			if (!S.touches[0]) {
				if (!S.touches[0]) {
					...
					if (_ != null) {
						...
						p(Be), r.redrawHint("drag", !0), r.redrawHint("eles", !0), je && (_.emit(me("freeon")), Be.emit(me("free")), r.dragData.didDrag && (_.emit(me("dragfreeon")), Be.emit(me("dragfree")))), n(_, [
							"touchend",
							"tapend",
							"vmouseup",
							"tapdragout"
					...
					} else n(r.findNearestElement(ee[0], ee[1], !0, !0), [
						"touchend",
						"tapend",
						"vmouseup",
						"tapdragout"
					...
					var mr = r.touchData.startPosition[0] - ee[0], Ye = mr * mr, ir = r.touchData.startPosition[1] - ee[1], jr = (Ye + ir * ir) * oe * oe;
		...
		r.dragData.didDrag = !1, S.touches.length === 0 && (r.touchData.dragDelta = [], r.touchData.startPosition = [
			null,
			null,
			null,
			null,
			null,
			null
		], r.touchData.startGPosition = null, r.touchData.didSelect = !1), S.touches.length < 2 && (S.touches.length === 1 && (r.touchData.startGPosition = [S.touches[0].clientX, S.touches[0].clientY]), r.pinching = !1, r.redrawHint("eles", !0), r.redraw());
		...
		var pe = [], Se = function(S) {
			...
			for (var _ = 0; _ < pe.length; _++) if (pe[_].event.pointerId === S.pointerId) {
				pe.splice(_, 1);
				return;
			}
		}, ze = function(S) {
...
Qr.generateRoundPolygon = function(r, e) {
	return this.nodeShapes[r] = {
		...
		getOrCreateCorners: function(a, n, i, s, o, l, u) {
			...
			var v = i / 2, f = s / 2;
			o = o === "auto" ? Ev(i, s) : o;
			for (var c = new Array(e.length / 2), h = 0; h < e.length / 2; h++) c[h] = {
				x: a + v * e[h * 2],
				y: n + f * e[h * 2 + 1]
			};
			var d, y, g, p, m = c.length;
			for (y = c[m - 1], d = 0; d < m; d++) g = c[d % m], p = c[(d + 1) % m], l[u][d] = po(y, g, p, o), y = g, g = p;
			return l[u];
		},
...
Qr.generateCutRectangle = function() {
	return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
		...
		checkPoint: function(e, t, a, n, i, s, o, l) {
			...
			if (Zr(e, t, this.points, s, o, n, i - 2 * u, [0, -1], a) || Zr(e, t, this.points, s, o, n - 2 * u, i, [0, -1], a)) return !0;
...
Qr.generateBarrel = function() {
	return this.nodeShapes.barrel = {
		...
		intersectLine: function(e, t, a, n, i, s, o, l) {
			var u = .15, v = .5, f = .85, c = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, t), h = function(g) {
				var p = Kt({
					x: g[0],
					y: g[1]
				}, {
			...
			return Da(i, s, [].concat(h(c.topLeft), h(c.topRight), h(c.bottomRight), h(c.bottomLeft)), e, t);
		},
		...
		checkPoint: function(e, t, a, n, i, s, o, l) {
			...
			if (Zr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) || Zr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a)) return !0;
			for (var c = this.generateBarrelBezierPts(n, i, s, o), h = function(T, k, D) {
				var B = D[4], P = D[2], A = D[0], R = D[5], L = D[1];
				if (Math.min(B, A) <= T && T <= Math.max(B, A) && Math.min(R, L) <= k && k <= Math.max(R, L)) {
					var G = _d(B, P, A), F = Ld(G[0], G[1], G[2], T).filter(function(U) {
						return 0 <= U && U <= 1;
					});
...
Qr.generateBottomRoundrectangle = function() {
	return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
		...
		intersectLine: function(e, t, a, n, i, s, o, l) {
			var u = e - (a / 2 + o), v = t - (n / 2 + o), f = v, h = it(i, s, e, t, u, v, e + (a / 2 + o), f, !1);
			return h.length > 0 ? h : wv(i, s, e, t, a, n, o, l);
		},
		checkPoint: function(e, t, a, n, i, s, o, l) {
			l = l === "auto" ? vt(n, i) : l;
			var u = 2 * l;
			if (Zr(e, t, this.points, s, o, n, i - u, [0, -1], a) || Zr(e, t, this.points, s, o, n - u, i, [0, -1], a)) return !0;
			var v = n / 2 + 2 * a, f = i / 2 + 2 * a;
			return !!(Sr(e, t, [
				s - v,
				o - f,
				s - v,
				...
				s + v,
				o - f
			]) || kt(e, t, u, u, s + n / 2 - l, o + i / 2 - l, a) || kt(e, t, u, u, s - n / 2 + l, o + i / 2 - l, a));
		}
	};
};
Qr.registerNodeShapes = function() {
	...
	var a = new Array(20);
	var n = Ps(5, 0), i = Ps(5, Math.PI / 5), s = .5 * (3 - Math.sqrt(5));
	s *= 1.57;
	...
	a = xv(a), this.generatePolygon("star", a), this.generatePolygon("vee", [
		-1,
		-1,
		0,
		-.333,
...
Ha.beforeRender = function(r, e) {
	if (!this.destroyed) {
		e ?? $e("Priority is not optional for beforeRender");
...
sa.init = function(r) {
	...
	if (a) {
		...
		a.getComputedStyle(t).getPropertyValue("position") === "static" && Ve("A Cytoscape container has style position:static and so can not use UI extensions properly");
	}
	e.selection = [
		void 0,
		void 0,
...
var ws = 1e3 / 60, Tf = { setupDequeueing: function(e) {
	return function() {
	...
	return gt(r, [
		{
			key: "getIdsFor",
			value: function(t) {
				t ?? $e("Can not get id list for null key");
...
}(), Nl = 25, nn = 50, pn = -4, Hs = 3, Sf = 7.99, iy = 8, sy = 1024, oy = 1024, uy = 1024, ly = .2, vy = .8, fy = 10, cy = .15, dy = .1, hy = .9, gy = .9, py = 100, yy = 1, Ut = {
	dequeue: "dequeue",
	downscale: "downscale",
...
nr.getElementQueue = function() {
	var r = this;
	return r.eleCacheQueue = r.eleCacheQueue || new Va(function(t, a) {
...
nr.getElement = function(r, e, t, a, n) {
	...
	if (a ??= Math.ceil(ro(o * t)), a < pn) a = pn;
...
nr.recycleTexture = function(r, e) {
	for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
		var s = n[i];
		if (s.width >= e) return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, eo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), lt(n, s), a.push(s), s;
	}
};
...
nr.setupDequeueing = Tf.setupDequeueing({
	...
	shouldRedraw: function(e, t, a, n) {
		for (var i = 0; i < t.length; i++) for (var s = t[i].eles, o = 0; o < s.length; o++) if (ao(s[o].boundingBox(), n)) return !0;
		return !1;
	},
	priority: function(e) {
...
var by = 1, xa = -4, Pn = 2, wy = 3.99, xy = 50, Ey = 50, Cy = .15, Ty = .1, Sy = .9, ky = .9, Dy = 1, zl = 250, By = 4e3 * 4e3, Fl = 32767, Py = !0, kf = function(e) {
...
dr.updateElementsInLayers = function(r, e) {
	for (var t = this, a = Ia(r[0]), n = 0; n < r.length; n++) for (var i = a ? null : r[n], s = a ? r[n] : r[n].ele, o = s._private.rscratch, l = o.imgLayerCaches = o.imgLayerCaches || {}, u = xa; u <= Pn; u++) {
		var v = l[u];
...
Jr.drawEdge = function(r, e, t) {
	...
	if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
		...
		r.lineJoin = "round";
		if (e.pstyle("ghost").value === "yes") {
			var D = e.pstyle("ghost-offset-x").pfValue, B = e.pstyle("ghost-offset-y").pfValue, A = p * e.pstyle("ghost-opacity").value;
...
var Bf = function(e) {
	...
	return function(t, a) {
		if (a.visible()) {
			...
			if (n !== 0) {
				var i = this, s = i.usePaths(), o = a._private.rscratch, u = 2 * a.pstyle("".concat(e, "-padding")).pfValue, v = a.pstyle("".concat(e, "-color")).value;
...
Jr.drawEdgePath = function(r, e, t, a) {
	...
	if (l) {
		var f = t.join("$");
		n.pathCacheKey && n.pathCacheKey === f ? (s = e = n.pathCache, o = !0) : (s = e = new Path2D(), n.pathCacheKey = f, n.pathCache = s);
	}
...
mo.drawInscribedImage = function(r, e, t, a, n) {
	...
	if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? D = v(t, "background-width", "pfValue", a) * g : D = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? B = v(t, "background-height", "pfValue", a) * p : B = v(t, "background-height", "pfValue", a)), !(D === 0 || B === 0)) {
		...
		if (C === "no" && Q ? (i.setImgSmoothing(r, !1), K = !0) : C === "yes" && !Q && (i.setImgSmoothing(r, !0), K = !0), c === "no-repeat") w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, T, k, A, O, D, B), w && r.restore();
		else r.fillStyle = r.createPattern(e, c), i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.translate(A, O), r.fill(), r.translate(-A, -O);
	...
	if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
		...
		if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
			...
			if (C > 0 || T > 0 && x > 0) {
				...
				if (G && (r.fillStyle = "rgba(".concat(M[0], ",").concat(M[1], ",").concat(M[2], ",").concat(C * o, ")")), N && (r.strokeStyle = "rgba(".concat(O[0], ",").concat(O[1], ",").concat(O[2], ",").concat(x * o, ")"), r.lineWidth = T, r.setLineDash)) switch (V) {
					case "dotted":
						r.setLineDash([1, 1]);
						break;
					case "dashed":
...
yt.drawNode = function(r, e, t) {
	...
	if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
		...
		for (var b = e.pstyle("background-image").value, w = new Array(b.length), E = new Array(b.length), C = 0, x = 0; x < b.length; x++) {
			var T = b[x];
			if (w[x] = T != null && T !== "none") {
		...
		var ce = function() {
			...
			if (P > 0) {
				if (r.lineWidth = P, r.lineCap = M, r.lineJoin = I, r.setLineDash) switch (L) {
					case "dotted":
						r.setLineDash([1, 1]);
						break;
					case "dashed":
			...
			if (F > 0) {
				if (r.lineWidth = F, r.lineCap = "butt", r.setLineDash) switch (Q) {
					case "dotted":
						r.setLineDash([1, 1]);
						break;
					case "dashed":
				...
				if (X === "ellipse") s.drawEllipsePath(ee || r, ue.x, ue.y, $, Z);
					...
					for (var Te = $ / 2, fe = Z / 2, Pe = re + (S + F + j) / 2, Be = new Array(oe.length / 2), je = new Array(oe.length / 2), Ke = 0; Ke < oe.length / 2; Ke++) Be[Ke] = {
						x: ue.x + me + Te * oe[Ke * 2],
						y: ue.y + De + fe * oe[Ke * 2 + 1]
					};
					var mr, Ye, ir, er, lr = Be.length;
					for (Ye = Be[lr - 1], mr = 0; mr < lr; mr++) ir = Be[mr % lr], er = Be[(mr + 1) % lr], je[mr] = po(Ye, ir, er, Pe), Ye = ir, ir = er;
					s.drawRoundPolygonPath(ee || r, ue.x + me, ue.y + De, o * _, l * W, oe, je);
				} else if (["roundrectangle", "round-rectangle"].includes(X)) re = re === "auto" ? vt($, Z) : re, s.drawRoundRectanglePath(ee || r, ue.x, ue.y, $, Z, re + (S + F + j) / 2);
				else if (["cutrectangle", "cut-rectangle"].includes(X)) re = re === "auto" ? no() : re, s.drawCutRectanglePath(ee || r, ue.x, ue.y, $, Z, null, re + (S + F + j) / 4);
				else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(X)) re = re === "auto" ? vt($, Z) : re, s.drawBottomRoundRectanglePath(ee || r, ue.x, ue.y, $, Z, re + (S + F + j) / 2);
				else if (X === "barrel") s.drawBarrelPath(ee || r, ue.x, ue.y, $, Z);
				else if (X.startsWith("polygon") || [
					"rhomboid",
					"right-rhomboid",
					"round-tag",
					"tag",
...
yt.drawPie = function(r, e, t, a) {
	...
	var n = e.cy().style(), i = e.pstyle("pie-size"), s = e.pstyle("pie-hole"), o = e.pstyle("pie-start-angle").pfValue, l = a.x, u = a.y, v = e.width(), f = e.height(), c = Math.min(v, f) / 2, h, d = 0;
	if (this.usePaths() && (l = 0, u = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c)) for (var g = 1; g <= n.pieBackgroundN; g++) {
...
xr.createGradientStyleFor = function(r, e, t, a, n) {
	...
	if (a === "radial-gradient") if (t.isEdge()) {
		...
		var b = s ? {
			x: 0,
			y: 0
		} : t.position(), w = t.paddedWidth(), E = t.paddedHeight(), C = w / 2, x = E / 2;
	...
	if (!i) return null;
	for (var k = l.length === o.length, D = o.length, B = 0; B < D; B++) i.addColorStop(k ? l[B] : B / (D - 1), "rgba(" + o[B][0] + "," + o[B][1] + "," + o[B][2] + "," + n + ")");
	return i;
};
...
xr.matchCanvasSize = function(r) {
	...
	if (!(l === e.canvasWidth && u === e.canvasHeight)) {
		...
		for (var c = 0; c < e.CANVAS_LAYERS; c++) v = t.canvases[c], v.width = l, v.height = u, v.style.width = n + "px", v.style.height = i + "px";
		for (var c = 0; c < e.BUFFER_COUNT; c++) v = t.bufferCanvases[c], v.width = l, v.height = u, v.style.width = n + "px", v.style.height = i + "px";
...
xr.render = function(r) {
	...
	!(T === void 0 || x.zoom !== T.zoom || x.pan.x !== T.pan.x || x.pan.y !== T.pan.y) && !(y && !d) && (e.motionBlurPxRatio = 1), o && (C = o), w *= l, C.x *= l, C.y *= l;
	...
	if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), v[e.NODE] || n || i || N[e.NODE]) {
		var F = c && !N[e.NODE] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : u.contexts[e.NODE]);
		P(R, c && !F ? "motionBlur" : void 0), G ? e.drawCachedNodes(R, D.nondrag, l, O) : e.drawLayeredElements(R, D.nondrag, l, O), e.debug && e.drawDebugPoints(R, D.nondrag), !n && !c && (v[e.NODE] = !1);
	}
...
xr.drawSelectionRectangle = function(r, e) {
	...
	if (t.showFps || !s && l[t.SELECT_BOX] && !o) {
		...
		if (t.showFps && d) {
			...
			if (v.setTransform(1, 0, 0, 1, 0, 0), v.fillStyle = "rgba(255, 0, 0, 0.75)", v.strokeStyle = "rgba(255, 0, 0, 0.75)", v.font = "30px Arial", !ha) ha = v.measureText(g).actualBoundingBoxAscent;
			v.fillText(g, 0, ha);
			v.strokeRect(0, ha + 10, 250, 20), v.fillRect(0, ha + 10, 250 * Math.min(y / 60, 1), 20);
		}
		o || (l[t.SELECT_BOX] = !1);
	}
};
...
function Qy(r, e, t, a) {
	var i = Je(Af(r, e), 2), s = i[0], o = i[1], l = Rf(r, o, a), u = r.createBuffer();
...
function Fr(r, e, t, a) {
	var i = Je(Af(r, t), 3), s = i[0], o = i[1], l = i[2], u = Rf(r, o, e * s), v = s * l, f = r.createBuffer();
	...
	return gt(r, [
		...
		},
		{
			...
			value: function() {
				if (!this.scratch) {
					var t = this.r, a = this.texSize, n = this.texRows, i = this.createTextureCanvas;
					this.scratch = i(t, a, Math.floor(a / n), "scratch");
				}
				return this.scratch;
			}
		},
			...
			value: function() {
				...
				try {
					var u = function() {
						...
						if (h.size === 0) return n.push(f), c.forEach(function(E) {
							return i.set(E, f);
						}), 1;
						...
						try {
							for (d.s(); !(y = d.n()).done;) {
								var g = y.value;
								if (!h.has(g)) {
									var m = Je(f.getOffsets(g), 2), b = m[0], w = m[1];
									s.canFit({
										w: b.w + w.w,
										h: b.h
		...
		},
		{
			...
			value: function(t, a, n) {
				...
				if (l.w === 0) n.draw(t, o, function(c) {
	...
	return gt(r, [
		...
		},
		{
			...
			value: function(t, a) {
				...
				return (Array.isArray(s) ? s : [s]).map(function(l) {
					var u = i.getBoundingBox(t, l), v = n.getOrCreateAtlas(t, a, u, l), c = Je(v.getOffsets(l), 2), h = c[0];
					return {
						atlas: v,
						tex: h,
						tex1: h,
		...
		},
		{
			...
			value: function() {
				...
				try {
					for (a.s(); !(n = a.n()).done;) {
						var i = Je(n.value, 2), s = i[0], l = i[1].getCounts(), u = l.keyCount, v = l.atlasCount;
						t.push({
							type: s,
							keyCount: u,
							atlasCount: v
...
`, Ea = {
    ...
    `), i = this.batchManager.getIndexArray(), o = Gy(a, n, `#version 300 es
      precision highp float;
    ...
    `));
						...
						for (v.s(); !(f = v.n()).done;) {
							...
							for (var g = s.getAtlasIndexForBatch(h), p = 0, m = [[d, !0], [y, !1]]; p < m.length; p++) {
								...
								if (w.w != 0) {
									...
									qt(a, this.indexBuffer.getView(C));
		...
		},
		{
			...
			value: function(t, a, n) {
				...
				qt(a, this.indexBuffer.getView(s));
				xt([
					0,
					0,
					0
		...
		},
		{
			...
			value: function(t, a, n) {
				...
				if (this._isVisible(t, i)) {
					...
					qt(a, this.indexBuffer.getView(l));
					var h = t.pstyle(s.color).value, d = t.pstyle(s.opacity).value;
					xt(h, d, this.colorBuffer.getView(l));
					var g = this.lineWidthBuffer.getView(l);
					if (g[0] = 0, g[1] = 0, s.border) {
						var p = t.pstyle("border-width").value;
						if (p > 0) {
							var m = t.pstyle("border-color").value, b = t.pstyle("border-opacity").value;
							xt(m, b, this.borderColorBuffer.getView(l));
		...
		},
		{
			...
			value: function(t, a) {
				switch (t.pstyle(a).value) {
					case "rectangle": return _t;
					case "ellipse": return pa;
					case "roundrectangle":
					case "round-rectangle": return sn;
					case "bottom-round-rectangle": return ga;
					default: return;
				}
			}
		},
				...
				if (t.visible()) {
					...
					if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, l = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, l = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(l) || l == null)) {
						if (t.pstyle(n + "-arrow-shape").value !== "none") {
							var v = t.pstyle(n + "-arrow-color").value, h = t.pstyle("opacity").value * t.pstyle("line-opacity").value, d = t.pstyle("width").pfValue, y = t.pstyle("arrow-scale").value, g = this.r.getArrowWidth(d, y), p = this.instanceCount, m = this.transformBuffer.getMatrixView(p);
							$l(m), yn(m, m, [s, o]), Ws(m, m, [g, g]), Ul(m, m, l), this.vertTypeBuffer.getView(p)[0] = Ts;
							qt(a, this.indexBuffer.getView(p));
							xt(v, h, this.colorBuffer.getView(p)), this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
						}
					}
				}
			}
				...
				if (t.visible()) {
					...
					if (n) {
						...
						if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
							...
							qt(a, this.indexBuffer.getView(v));
							xt(l, u, this.colorBuffer.getView(v));
						...
						} else for (var y = 0; y < n.length - 2; y += 2) {
							var g = this.instanceCount;
							this.vertTypeBuffer.getView(g)[0] = Xl;
							qt(a, this.indexBuffer.getView(g));
							xt(l, u, this.colorBuffer.getView(g));
							var b = this.lineWidthBuffer.getView(g);
							b[0] = o;
							var w = n[y - 2], E = n[y - 1], C = n[y], x = n[y + 1], T = n[y + 2], k = n[y + 3], D = n[y + 4], B = n[y + 5];
							y == 0 && (w = 2 * C - T + .001, E = 2 * x - k + .001), y == n.length - 4 && (D = 2 * T - C + .001, B = 2 * k - x + .001);
		...
		},
		{
			...
			value: function() {
				...
				if (i !== 0) {
					...
					for (var c = 0; c < v.length; c++) t.activeTexture(t.TEXTURE0 + c), t.bindTexture(t.TEXTURE_2D, v[c].texture), t.uniform1i(s.uTextures[c], c);
...
Mf.initWebgl = function(r, e) {
	...
	var n = function(f) {
		...
		return f.pstyle("text-events").strValue === "yes" ? An.USE_BB : An.IGNORE;
	}, l = function(f) {
...
function cm(r) {
	...
	return iv(e && e.style && e.style.backgroundColor || "white");
}
function Lf(r, e) {
	var t = r._private.rscratch;
...
function bm(r) {
	var e = function(n, i, s) {
		for (var o = n.atlasManager.getAtlasCollection(i), l = r.data.contexts[r.NODE], u = o.atlases, v = 0; v < u.length; v++) {
			var c = u[v].canvas;
			if (c) {
				var h = c.width, d = c.height, y = h * v, g = c.height * s, p = .4;
...
function wm(r, e, t, a, n) {
	...
	var h = Je($y(r, v, f, e, t), 2), d = h[0], y = h[1], g = 6;
...
function Of(r, e, t) {
	...
	if (r.webglDebug) {
		var c = performance.now(), h = !1, d = Math.ceil(c - a), y = n.getDebugInfo(), g = [
			"".concat(i, " elements"),
...
mt.drawEllipsePath = function(r, e, t, a, n) {
	...
	else for (var i, s, o = a / 2, l = n / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Nf) i = e - o * $s[u] * Yl + o * Us[u] * Zl, s = t + l * Us[u] * Yl + l * $s[u] * Zl, u === 0 ? r.moveTo(i, s) : r.lineTo(i, s);
	r.closePath();
};
var Wa = {};
...
Wa.bufferCanvasImage = function(r) {
	var e = this.cy, a = e.mutableElements().boundingBox(), n = this.findContainerClientCoords(), i = r.full ? Math.ceil(a.w) : n[2], s = r.full ? Math.ceil(a.h) : n[3], o = ae(r.maxWidth) || ae(r.maxHeight), l = this.getPixelRatio(), u = 1;
	if (r.scale !== void 0) i *= r.scale, s *= r.scale, u = r.scale;
	else if (o) {
		var v = Infinity, f = Infinity;
	...
	if (i > 0 && s > 0) {
		...
		if (r.full) h.translate(-a.x1 * u, -a.y1 * u), h.scale(u, u), this.drawElements(h, d), h.scale(1 / u, 1 / u), h.translate(a.x1 * u, a.y1 * u);
		else {
			var y = e.pan(), g = {
				x: y.x * u,
				y: y.y * u
...
function zf(r, e, t) {
	...
	switch (r.output) {
		case "blob-promise": return new ta(function(n, i) {
			try {
				e.toBlob(function(s) {
		...
		case "blob": return Em(Ql(a()), t);
		case "base64": return Ql(a());
		case "base64uri":
		default: return a();
	}
}
...
function Vf(r) {
	...
	var c = wr(), h = function(z) {
		...
		var q = z[0]._private;
		return !(q.oldBackgroundTimestamp === q.backgroundTimestamp);
	}, g = function(z) {
...
function Gf(r, e, t) {
	...
	} else if (r === "__proto__" || r === "constructor" || r === "prototype") return $e(r + " is an illegal type to be registered, possibly lead to prototype pollutions");
	return sv({
		map: qf,
		keys: [r, e],
		value: a
...
Rt.css = function(r, e) {
	var t = this.length - 1;
	if (ge(r)) this[t].properties.push({
		name: r,
		value: e
	});
	else if (Le(r)) for (var a = r, n = Object.keys(a), i = 0; i < n.length; i++) {
		var s = n[i], o = a[s];
		if (o != null) {
