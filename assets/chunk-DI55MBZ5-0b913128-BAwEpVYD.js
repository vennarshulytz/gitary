import { Gn as yt, Ln as w5, Ot as b5, Vn as x5, Wn as y5, Xn as zi, dn as m5, et as R, g as Dz, nn as k5, rn as kM, t as $e, un as m, xt as _5 } from "./app-BiKdazfq.js";
...
var vt = function() {
	var e = /* @__PURE__ */ m(function(V, o, h, n) {
		...
		return h;
	}, "o"), t = [1, 2], s = [1, 3], a = [1, 4], i = [2, 4], l = [1, 9], d$1 = [1, 11], S = [1, 16], p = [1, 17], T = [1, 18], _ = [1, 19], m$1 = [1, 33], k = [1, 20], A = [1, 21], $ = [1, 22], x = [1, 23], R$1 = [1, 24], u = [1, 26], L = [1, 27], I = [1, 28], N = [1, 29], G = [1, 30], P = [1, 31], B = [1, 32], at = [1, 35], nt = [1, 36], ot = [1, 37], lt = [1, 38], W = [1, 34], y = [
		1,
		4,
		5,
		16,
		...
		performAction: /* @__PURE__ */ m(function(o, h, n, g$1, E, r, Z) {
			var c = r.length - 1;
			switch (E) {
				case 3: return g$1.setRootDoc(r[c]), r[c];
				case 4:
					this.$ = [];
					break;
				case 5:
				...
				case 13:
					const tt = r[c - 1];
					tt.description = g$1.trimColon(r[c]), this.$ = tt;
					break;
				case 14:
					this.$ = {
						stmt: "relation",
				...
				case 26:
					...
					break;
				case 29:
					this.$ = r[c].trim(), g$1.setAccTitle(this.$);
					break;
				case 30:
				case 31:
					this.$ = r[c].trim(), g$1.setAccDescription(this.$);
					break;
				case 32:
					this.$ = {
						stmt: "click",
				...
				case 37:
					...
					break;
				case 38:
					g$1.setDirection("TB"), this.$ = {
						stmt: "dir",
						value: "TB"
					};
					break;
				case 39:
					g$1.setDirection("BT"), this.$ = {
						stmt: "dir",
						value: "BT"
					};
					break;
				case 40:
					g$1.setDirection("RL"), this.$ = {
						stmt: "dir",
						value: "RL"
					};
					break;
				case 41:
					g$1.setDirection("LR"), this.$ = {
						stmt: "dir",
						value: "LR"
					};
					break;
		...
		parse: /* @__PURE__ */ m(function(o) {
			var h = this, n = [0], g$1 = [], E = [null], r = [], Z = this.table, c = "", U = 0, K = 0, ut = 2, tt = 1, Tt = r.slice.call(arguments, 1), b = Object.create(this.lexer), j = { yy: {} };
			...
			function Lt() {
				var O;
				return O = g$1.pop() || b.lex() || tt, typeof O != "number" && (O instanceof Array && (g$1 = O, O = g$1.pop()), O = h.symbols_[O] || O), O;
			}
			m(Lt, "lex");
...
Expecting ` + ft.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : Dt = "Parse error on line " + (U + 1) + ": Unexpected " + (C == tt ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(Dt, {
				...
				switch (w[0]) {
					...
					case 2:
						if (Y = this.productions_[w[1]][1], X.$ = E[E.length - Y], X._$ = {
						...
						}, Qt && (X._$.range = [r[r.length - (Y || 1)].range[0], r[r.length - 1].range[1]]), mt = this.performAction.apply(X, [
							c,
							K,
							U,
							j.yy,
							...
							E,
							r
						].concat(Tt)), typeof mt < "u") return mt;
		...
		return {
			...
			unput: /* @__PURE__ */ m(function(o) {
				...
				return this.yylloc = {
					...
					last_column: n ? (n.length === g$1.length ? this.yylloc.first_column : 0) + g$1[g$1.length - n.length].length - n[0].length : this.yylloc.first_column - h
...
` + h + "^";
			...
			test_match: /* @__PURE__ */ m(function(o, h) {
				...
				}, this.options.ranges && (E.yylloc.range = this.yylloc.range.slice(0))), g$1 = o[0].match(/(?:\r\n?|\n).*/g), g$1 && (this.yylineno += g$1.length), this.yylloc = {
			...
			next: /* @__PURE__ */ m(function() {
				...
				for (var E = this._currentRules(), r = 0; r < E.length; r++) if (n = this._input.match(this.rules[E[r]]), n && (!h || n[0].length > h[0].length)) {
					if (h = n, g$1 = r, this.options.backtrack_lexer) {
				...
				return h ? (o = this.test_match(h, E[g$1]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
					text: "",
					token: null,
					line: this.yylineno
			...
			performAction: /* @__PURE__ */ m(function(h, n, g$1, E) {
				switch (g$1) {
					case 0: return 38;
					case 1: return 40;
					case 2: return 39;
					...
					case 38:
						...
						break;
					case 39: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 25;
					case 40: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 26;
					case 41: return this.popState(), n.yytext = n.yytext.slice(0, -10).trim(), 27;
					case 42: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 25;
					case 43: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 26;
					case 44: return this.popState(), n.yytext = n.yytext.slice(0, -10).trim(), 27;
					case 45: return 51;
					case 46: return 52;
					case 47: return 53;
					case 48: return 54;
					...
					case 69: return this.popState(), n.yytext = n.yytext.substr(2).trim(), 31;
					case 70: return this.popState(), n.yytext = n.yytext.slice(0, -8).trim(), 31;
					case 71: return 6;
					case 72: return 6;
					case 73: return 16;
					case 74: return 57;
					case 75: return 24;
					case 76: return n.yytext = n.yytext.trim(), 14;
					case 77: return 15;
					case 78: return 28;
					case 79: return 58;
					case 80: return 5;
...
vt.parser = vt;
var Be = vt, de = "TB", Yt = "TB", Rt = "dir", q = "state", J = "root", Ct = "relation", fe = "classDef", pe = "style", Se = "applyClass", it = "default", Gt = "divider", Bt = "fill:none", Vt = "fill: #333", Mt = "c", Ut = "text", jt = "normal", bt = "rect", kt = "rectWithTitle", ye = "stateStart", ge = "stateEnd", It = "divider", Nt = "roundedWithTitle", Te = "note", Ee = "noteGroup", rt = "statediagram", me = `${rt}-state`, Ht = "transition", De = "note", ke = `${Ht} note-edge`, ve = `${rt}-${De}`, Ae = `${rt}-cluster`, Le = `${rt}-cluster-alt`, zt = "parent", Wt = "note", Oe = "state", At = "----", Re = `${At}${Wt}`, wt = `${At}${zt}`, Kt = /* @__PURE__ */ m((e, t = Yt) => {
	if (!e.doc) return t;
	let s = t;
	...
	draw: /* @__PURE__ */ m(async function(e, t, s, a) {
		R.info("REF0:"), R.info("Drawing state diagram (v2)", t);
		const { securityLevel: i, state: l, layout: d$1 } = yt();
		a.db.extract(a.db.getRootDocV2());
		const S = a.db.getData(), p = g(t, i);
		S.type = a.type, S.layoutAlgorithm = d$1, S.nodeSpacing = (l == null ? void 0 : l.nodeSpacing) || 50, S.rankSpacing = (l == null ? void 0 : l.rankSpacing) || 50, S.markers = ["barb"], S.diagramId = t, await Dz(S, p);
		const T = 8;
		try {
			(typeof a.db.getLinks == "function" ? a.db.getLinks() : /* @__PURE__ */ new Map()).forEach((m$1, k) => {
				var I;
				...
				const u = document.createElementNS("http://www.w3.org/2000/svg", "a"), L = m$1.url.replace(/^"+|"+$/g, "");
				if (u.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", L), u.setAttribute("target", "_blank"), m$1.tooltip) {
					const N = m$1.tooltip.replace(/^"+|"+$/g, "");
					u.setAttribute("title", N);
				}
				R$1.replaceChild(u, x), u.appendChild(x), R.info("🔗 Wrapped node in <a> tag for:", A, m$1.url);
			});
		} catch (_) {
			R.error("❌ Error injecting clickable links:", _);
		}
		$e.insertTitle(p, "statediagramTitleText", (l == null ? void 0 : l.titleTopMargin) ?? 25, a.db.getDiagramTitle()), d(p, T, rt, (l == null ? void 0 : l.useMaxWidth) ?? !0);
	}, "draw"),
	getDir: Kt
}, St = /* @__PURE__ */ new Map(), M = 0;
function yt$1(e = "", t = 0, s = "", a = At) {
	return `${Oe}-${e}${s !== null && s.length > 0 ? `${a}${s}` : ""}-${t}`;
}
m(yt$1, "stateDomId");
var we = /* @__PURE__ */ m((e, t, s, a, i, l, d$1, S) => {
	R.trace("items", t), t.forEach((p) => {
		switch (p.stmt) {
			case q:
				st(e, p, s, a, i, l, d$1, S);
				break;
			case it:
				st(e, p, s, a, i, l, d$1, S);
				break;
			case Ct:
				{
					st(e, p.state1, s, a, i, l, d$1, S), st(e, p.state2, s, a, i, l, d$1, S);
					const T = {
						id: "edge" + M,
						start: p.state1.id,
						end: p.state2.id,
						...
						style: Bt,
						labelStyle: "",
						label: zi.sanitizeText(p.description ?? "", yt()),
						arrowheadStyle: Vt,
						labelpos: Mt,
						labelType: Ut,
						thickness: jt,
...
var st = /* @__PURE__ */ m((e, t, s, a, i, l, d$1, S) => {
	var A, $, x;
	const p = t.id, T = s.get(p), _ = Xt(T), m$1 = Jt(T), k = yt();
	if (R.info("dataFetcher parsedItem", t, T, m$1), p !== "root") {
		let R$1 = bt;
		t.start === !0 ? R$1 = ye : t.start === !1 && (R$1 = ge), t.type !== it && (R$1 = t.type), St.get(p) || St.set(p, {
			id: p,
			shape: R$1,
			description: zi.sanitizeText(p, k),
			cssClasses: `${_} ${me}`,
			cssStyles: m$1
		});
		const u = St.get(p);
		t.description && (Array.isArray(u.description) ? (u.shape = kt, u.description.push(t.description)) : (A = u.description) != null && A.length && u.description.length > 0 ? (u.shape = kt, u.description === p ? u.description = [t.description] : u.description = [u.description, t.description]) : (u.shape = bt, u.description = t.description), u.description = zi.sanitizeTextOrArray(u.description, k)), (($ = u.description) == null ? void 0 : $.length) === 1 && u.shape === kt && (u.type === "group" ? u.shape = Nt : u.shape = bt), !u.type && t.doc && (R.info("Setting cluster for XCX", p, $t(t)), u.type = "group", u.isGroup = !0, u.dir = $t(t), u.shape = t.type === Gt ? It : Nt, u.cssClasses = `${u.cssClasses} ${Ae} ${l ? Le : ""}`);
		const L = {
			labelStyle: "",
			shape: u.shape,
			label: u.description,
		...
		if (L.shape === It && (L.label = ""), e && e.id !== "root" && (R.trace("Setting node ", p, " to be child of its parent ", e.id), L.parentId = e.id), L.centerLabel = !0, t.note) {
			const I = {
				labelStyle: "",
				shape: Te,
				label: t.note.text,
	...
	t.doc && (R.trace("Adding nodes children "), we(t, t.doc, s, a, i, !l, d$1, S));
}, "dataFetcher"), $e$1 = /* @__PURE__ */ m(() => {
	St.clear(), M = 0;
}, "reset"), v = {
	START_NODE: "[*]",
	START_TYPE: "start",
	...
	constructor(t) {
		this.version = t, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = Pt(), this.documents = { root: Ft() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.getAccTitle = x5, this.setAccTitle = b5, this.getAccDescription = k5, this.setAccDescription = y5, this.setDiagramTitle = w5, this.getDiagramTitle = _5, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this);
	}
	extract(t) {
		this.clear(!0);
		for (const i of Array.isArray(t) ? t : t.doc) switch (i.stmt) {
			case q:
		...
		const s = this.getStates(), a = yt();
		$e$1(), st(void 0, this.getRootDocV2(), s, this.nodes, this.edges, !0, a.look, this.classes);
		for (const i of this.nodes) if (Array.isArray(i.label)) {
	...
	handleStyleDef(t) {
		...
		for (const i of s) {
			...
			if (!l) {
				const d$1 = i.trim();
				this.addState(d$1), l = this.getState(d$1);
			}
			l && (l.styles = a.map((d$1) => {
				var S;
				return (S = d$1.replace(/;/g, "")) == null ? void 0 : S.trim();
			}));
		}
	}
	setRootDoc(t) {
	...
	docTranslator(t, s, a) {
		...
		if (s.stmt === q && (s.id === v.START_NODE ? (s.id = t.id + (a ? "_start" : "_end"), s.start = a) : s.id = s.id.trim()), s.stmt !== J && s.stmt !== q || !s.doc) return;
		const i = [];
		let l = [];
		for (const d$1 of s.doc) if (d$1.type === Gt) {
			const S = pt(d$1);
		...
		if (i.length > 0 && l.length > 0) {
			...
			i.push(pt(d$1)), s.doc = i;
		}
		s.doc.forEach((d$1) => this.docTranslator(s, d$1, !0));
	}
	getRootDocV2() {
	...
	addState(t, s = it, a = void 0, i = void 0, l = void 0, d$1 = void 0, S = void 0, p = void 0) {
		const T = t == null ? void 0 : t.trim();
		if (!this.currentDocument.states.has(T)) R.info("Adding state ", T, i), this.currentDocument.states.set(T, {
			stmt: q,
			id: T,
			descriptions: [],
			type: s,
		...
		if (i && (R.info("Setting state description", T, i), (Array.isArray(i) ? i : [i]).forEach((m$1) => this.addDescription(T, m$1.trim()))), l) {
			const _ = this.currentDocument.states.get(T);
			if (!_) throw new Error(`State not found: ${T}`);
			_.note = l, _.note.text = zi.sanitizeText(_.note.text, yt());
		}
		d$1 && (R.info("Setting state classes", T, d$1), (Array.isArray(d$1) ? d$1 : [d$1]).forEach((m$1) => this.setCssClass(T, m$1.trim()))), S && (R.info("Setting state styles", T, S), (Array.isArray(S) ? S : [S]).forEach((m$1) => this.setStyle(T, m$1.trim()))), p && (R.info("Setting state styles", T, S), (Array.isArray(p) ? p : [p]).forEach((m$1) => this.setTextStyle(T, m$1.trim())));
	}
	clear(t) {
	...
	addRelationObjs(t, s, a = "") {
		const i = this.startIdIfNeeded(t.id.trim()), l = this.startTypeIfNeeded(t.id.trim(), t.type), d$1 = this.startIdIfNeeded(s.id.trim()), S = this.startTypeIfNeeded(s.id.trim(), s.type);
		this.addState(i, l, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.addState(d$1, S, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
			id1: i,
			id2: d$1,
			relationTitle: zi.sanitizeText(a, yt())
		});
	}
	addRelation(t, s, a) {
		if (typeof t == "object" && typeof s == "object") this.addRelationObjs(t, s, a);
		else if (typeof t == "string" && typeof s == "string") {
			const i = this.startIdIfNeeded(t.trim()), l = this.startTypeIfNeeded(t), d$1 = this.endIdIfNeeded(s.trim()), S = this.endTypeIfNeeded(s);
			this.addState(i, l), this.addState(d$1, S), this.currentDocument.relations.push({
				id1: i,
				id2: d$1,
				relationTitle: a ? zi.sanitizeText(a, yt()) : void 0
			});
		}
	}
	addDescription(t, s) {
		...
		(l = a == null ? void 0 : a.descriptions) == null || l.push(zi.sanitizeText(i, yt()));
	}
	cleanupLabel(t) {
	...
	setCssClass(t, s) {
		t.split(",").forEach((a) => {
			...
			if (!i) {
				const d$1 = a.trim();
				this.addState(d$1), i = this.getState(d$1);
			}
...
`, "getStyles");
export { Ve as i, Me as n, Ue as r, Be as t };
