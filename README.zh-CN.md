...
- ✅ **AI 智能画图**：用自然语言描述，AI 自动生成图表
- ✅ **全局 AI 助手**：智能助手集成工具，上下文感知
...
- **自然语言生成图表**：用自然语言描述，AI 自动生成 Excalidraw 图表
- **智能图表生成**：支持流程图、架构图、系统图等多种图表类型
- **智能图表编辑**：AI 可以分析现有图表、添加节点、连接箭头、重命名、删除等
- **上下文感知**：AI 自动感知当前 Excalidraw 画布内容，提供相关建议
- **两种生成方式**：
  - 通过专门的 AI 模型生成（适合复杂图表）
  - 主 Agent 直接生成（适合简单图表，更快）

### 💬 全局 AI 助手

- **跨页面 AI 助手**：全局侧边栏 AI 助手，随时可用
- **工具集成**：AI 可以操作文件系统、Excalidraw、工作区等
- **上下文感知**：
  - 自动感知当前编辑的文件内容
  - 自动感知当前 Excalidraw 画布内容
  - 自动感知浏览器标签页信息
- **多工具协作**：文件操作、图表操作、工作区管理
...
- 👨‍💻 **开发者**：像管理代码一样管理技术笔记，利用 Git 版本控制，使用 AI 生成架构图
- 📚 **技术写作者**：将文档直接存储在代码仓库，使用 AI 根据描述创建图表
- 🎓 **学习者**：通过 Git 历史追踪学习进度，使用 AI 助手获得学习指导
- 🏢 **团队协作**：通过 Git 协作，使用 AI 生成和编辑团队图表
