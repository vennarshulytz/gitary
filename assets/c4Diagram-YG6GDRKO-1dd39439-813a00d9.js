import { o, y } from "./chunk-TZMSLE5B-d1425621-fa1ff8e3.js";
import { H as m, a7 as b5, a8 as x5, a9 as k5, aa as y5, O as yt, ab as Dt, ac as vM, ad as zi, ae as Pm, af as ur, ag as _e$1, a6 as gt, K as R, ah as If, ai as bm } from "./app-a3875679.js";
...
var Ue = Ft, V = [], _t = [""], B = "global", F = "", X = [
  ...
  function t(l, i, n, r, a, u, d, p) {
    const { fontSize: y2, fontFamily: E, fontWeight: O } = p, S = l.split(zi.lineBreakRegex);
...
function j(e, t, s, o2, l) {
  if (!t[e].width)
    if (s)
      t[e].text = vM(t[e].text, l, o2), t[e].textLines = t[e].text.split(zi.lineBreakRegex).length, t[e].width = l, t[e].height = Pm(t[e].text, o2);
    else {
      ...
      for (const r of i)
        t[e].width = Math.max(
          ur(r, o2),
          t[e].width
        ), n = Pm(r, o2), t[e].height = t[e].height + n;
    }
}
...
var S0 = /* @__PURE__ */ m(function(e, t, s, o2) {
  ...
  d && a.append("text").text(d).attr("x", (y2.stopx - y2.startx) / 2 - 4 * b.diagramMarginX).attr("y", y2.starty + b.diagramMarginY), If(a, O, P, b.useMaxWidth);
  const M = d ? 60 : 0;
  a.attr(
    "viewBox",
