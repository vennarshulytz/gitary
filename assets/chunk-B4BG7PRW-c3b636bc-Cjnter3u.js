import { Ct as _e, Gn as yt, Ln as w5, Ot as b5, Vn as x5, Wn as y5, Xn as zi, dn as m5, et as R, g as Dz, it as Rz, l as Cz, nn as k5, qt as gt, t as $e, un as m, x as Fh, xt as _5 } from "./app-BiKdazfq.js";
...
var Ve = function() {
	var s = /* @__PURE__ */ m(function(I, o, h, p) {
		...
		return h;
	}, "o"), i = [1, 18], a = [1, 19], u = [1, 20], l$1 = [1, 41], r = [1, 42], c = [1, 26], A = [1, 24], g$1 = [1, 25], D = [1, 32], L = [1, 33], Ae = [1, 34], m$1 = [1, 45], fe = [1, 35], ge = [1, 36], Ce = [1, 37], me = [1, 38], be = [1, 27], Ee = [1, 28], ye = [1, 29], Te = [1, 30], ke = [1, 31], b = [1, 44], E = [1, 46], y = [1, 43], T = [1, 47], De = [1, 9], d$1 = [
		1,
		8,
		9
	], te = [1, 58], se = [1, 59], ie = [1, 60], ae = [1, 61], ne = [1, 62], Fe = [1, 63], Be = [1, 64], G = [
		1,
		8,
		9,
		41
		...
		102,
		103
	], _e$1 = [1, 100], z = [1, 117], K = [1, 113], Y = [1, 109], Q = [1, 115], j = [1, 110], W = [1, 111], X = [1, 112], H = [1, 114], q = [1, 116], Re = [
		22,
		48,
		60,
		61,
		...
		parse: /* @__PURE__ */ m(function(o) {
			...
			for (var B, w, S, ve, M = {}, he, x, Qe, de;;) {
				if (w = p[p.length - 1], this.defaultActions[w] ? S = this.defaultActions[w] : ((B === null || typeof B > "u") && (B = Ye()), S = J[w] && J[w][B]), typeof S > "u" || !S.length || !S[0]) {
					var Ie = "";
					de = [];
					for (he in J[w]) this.terminals_[he] && he > qe && de.push("'" + this.terminals_[he] + "'");
...
Expecting ` + de.join(", ") + ", got '" + (this.terminals_[B] || B) + "'" : Ie = "Parse error on line " + (ce + 1) + ": Unexpected " + (B == Ke ? "end of input" : "'" + (this.terminals_[B] || B) + "'"), this.parseError(Ie, {
				...
				if (S[0] instanceof Array && S.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + w + ", token: " + B);
				switch (S[0]) {
					case 1:
					...
					case 2:
						if (x = this.productions_[S[1]][1], M.$ = C[C.length - x], M._$ = {
						...
						}, Ze && (M._$.range = [e[e.length - (x || 1)].range[0], e[e.length - 1].range[1]]), ve = this.performAction.apply(M, [
							t,
							ze,
							ce,
							O.yy,
							...
							C,
							e
						].concat(Je)), typeof ve < "u") return ve;
...
` + h + "^";
			...
			test_match: /* @__PURE__ */ m(function(o, h) {
				...
				}, this.yytext += o[0], this.match += o[0], this.matches = o, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(o[0].length), this.matched += o[0], p = this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), p) return p;
				if (this._backtrack) {
			...
			next: /* @__PURE__ */ m(function() {
				...
				for (var C = this._currentRules(), e = 0; e < C.length; e++) if (p = this._input.match(this.rules[C[e]]), p && (!h || p[0].length > h[0].length)) {
...
var Tt = Ve, je = [
	...
	parseMember(i) {
		...
		if (this.memberType === "method") {
			...
			const l$1 = i.length, r = i.substring(0, 1), c = i.substring(l$1 - 1);
			je.includes(r) && (this.visibility = r), /[$*]/.exec(c) && (a = c), this.id = i.substring(this.visibility === "" ? 0 : 1, a === "" ? l$1 : l$1 - 1);
		}
		this.classifier = a, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
		this.text = `${this.visibility ? "\\" + this.visibility : ""}${Fh(this.id)}${this.memberType === "method" ? `(${Fh(this.parameters)})${this.returnType ? " : " + Fh(this.returnType) : ""}` : ""}`.replaceAll("<", "&lt;").replaceAll(">", "&gt;"), this.text.startsWith("\\&lt;") && (this.text = this.text.replace("\\&lt;", "~"));
	}
	parseClassifier() {
...
}, m($, "ClassMember"), $), pe = "classId-", Xe = 0, V = /* @__PURE__ */ m((s) => zi.sanitizeText(s, yt()), "sanitizeText"), ee, kt = (ee = class {
	constructor() {
	...
	setClassLabel(i, a) {
		const u = zi.sanitizeText(i, yt());
		a && (a = V(a));
		const { className: l$1 } = this.splitClassNameAndType(u);
		this.classes.get(l$1).label = a, this.classes.get(l$1).text = `${a}${this.classes.get(l$1).type ? `<${this.classes.get(l$1).type}>` : ""}`;
	}
	addClass(i) {
		const a = zi.sanitizeText(i, yt()), { className: u, type: l$1 } = this.splitClassNameAndType(a);
		if (this.classes.has(u)) return;
		const r = zi.sanitizeText(u, yt());
		this.classes.set(r, {
			id: r,
			type: l$1,
			label: r,
	...
	addMember(i, a) {
		this.addClass(i);
		const u = this.splitClassNameAndType(i).className, l$1 = this.classes.get(u);
		if (typeof a == "string") {
			const r = a.trim();
			r.startsWith("<<") && r.endsWith(">>") ? l$1.annotations.push(V(r.substring(2, r.length - 2))) : r.indexOf(")") > 0 ? l$1.methods.push(new We(r, "method")) : r && l$1.members.push(new We(r, "attribute"));
		}
	}
	addMembers(i, a) {
	...
	setCssClass(i, a) {
		i.split(",").forEach((u) => {
			let l$1 = u;
			/\d/.exec(u[0]) && (l$1 = pe + l$1);
			const r = this.classes.get(l$1);
			r && (r.cssClasses += " " + a);
		});
	}
	defineClass(i, a) {
		for (const u of i) {
			let l$1 = this.styleClasses.get(u);
			l$1 === void 0 && (l$1 = {
				id: u,
				styles: [],
				textStyles: []
			}, this.styleClasses.set(u, l$1)), a && a.forEach((r) => {
				if (/color/.exec(r)) {
					const c = r.replace("fill", "bgFill");
					l$1.textStyles.push(c);
				}
				l$1.styles.push(r);
	...
	setLink(i, a, u) {
		...
		i.split(",").forEach((r) => {
			...
			A && (A.link = $e.formatUrl(a, l$1), l$1.securityLevel === "sandbox" ? A.linkTarget = "_top" : typeof u == "string" ? A.linkTarget = V(u) : A.linkTarget = "_blank");
		}), this.setCssClass(i, "clickable");
	}
	setClickEvent(i, a, u) {
		i.split(",").forEach((l$1) => {
			this.setClickFunc(l$1, a, u), this.classes.get(l$1).haveCallback = !0;
		}), this.setCssClass(i, "clickable");
	}
	setClickFunc(i, a, u) {
		const l$1 = zi.sanitizeText(i, yt());
		...
		if (this.classes.has(c)) {
			...
			if (typeof u == "string") {
				g$1 = u.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
				for (let D = 0; D < g$1.length; D++) {
					let L = g$1[D].trim();
					L.startsWith("\"") && L.endsWith("\"") && (L = L.substr(1, L.length - 2)), g$1[D] = L;
				}
			}
			g$1.length === 0 && g$1.push(A), this.functions.push(() => {
	...
	addClassesToNamespace(i, a) {
		if (this.namespaces.has(i)) for (const u of a) {
			const { className: l$1 } = this.splitClassNameAndType(u);
			this.classes.get(l$1).parent = i, this.namespaces.get(i).classes.set(l$1, this.classes.get(l$1));
		}
	}
	setCssStyle(i, a) {
		const u = this.classes.get(i);
		if (!(!a || !u)) for (const l$1 of a) l$1.includes(",") ? u.styles.push(...l$1.split(",")) : u.styles.push(l$1);
	}
	getArrowMarker(i) {
		let a;
		switch (i) {
	...
	getData() {
		...
		for (const c of this.classes.keys()) {
			...
			if (A) {
				const g$1 = A;
				g$1.parentId = A.parent, g$1.look = u.look, i.push(g$1);
			}
		}
		let l$1 = 0;
		for (const c of this.notes) {
			...
			i.push(A);
			const g$1 = ((r = this.classes.get(c.class)) == null ? void 0 : r.id) ?? "";
			if (g$1) {
				const D = {
					id: `edgeNote${l$1}`,
					start: c.id,
...
}, m(ee, "ClassDB"), ee), Dt = /* @__PURE__ */ m((s) => `g.classGroup text {
...
`, "getStyles"), Ft = {
	...
	draw: /* @__PURE__ */ m(async function(s, i, a, u) {
		R.info("REF0:"), R.info("Drawing class diagram (v3)", i);
		const { securityLevel: l$1, state: r, layout: c } = yt(), A = u.db.getData(), g$1 = g(i, l$1);
		A.type = u.type, A.layoutAlgorithm = Rz(c), A.nodeSpacing = (r == null ? void 0 : r.nodeSpacing) || 50, A.rankSpacing = (r == null ? void 0 : r.rankSpacing) || 50, A.markers = [
			"aggregation",
			"extension",
			"composition",
			"dependency",
			"lollipop"
		], A.diagramId = i, await Dz(A, g$1);
		$e.insertTitle(g$1, "classDiagramTitleText", (r == null ? void 0 : r.titleTopMargin) ?? 25, u.db.getDiagramTitle()), d(g$1, 8, "classDiagram", (r == null ? void 0 : r.useMaxWidth) ?? !0);
	}, "draw"),
	getDir: /* @__PURE__ */ m((s, i = "TB") => {
		if (!s.doc) return i;
		let a = i;
...
export { kt as i, Ft as n, Tt as r, Dt as t };
