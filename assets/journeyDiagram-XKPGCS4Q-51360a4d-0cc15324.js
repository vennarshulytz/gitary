import { o, g, y, d } from "./chunk-TZMSLE5B-d1425621-81e00d63.js";
import { l } from "./chunk-FMBD7UC4-5875f4cd-6ec6f02f.js";
import { H as m, O as yt, ak as w5, al as _5, a7 as b5, a8 as x5, aa as y5, a9 as k5, ar as m5, a6 as gt, ah as If } from "./app-32980687.js";
...
var $ = yt().journey, P = 0, Gt = /* @__PURE__ */ m(function(t, e, s, c) {
  ...
  If(h, l2, b, $.useMaxWidth), h.append("line").attr("x1", P).attr("y1", $.height * 4).attr("x2", b - P - 4).attr("y2", $.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const k = a ? 70 : 0;
