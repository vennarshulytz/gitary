...
import { H as m, K as R, O as yt, ax as Mf, ag as _e$1, bB as lz, at as Rz, au as Dz, bl as Kn, bm as Y$1, bn as et } from "./app-a3875679.js";
...
var De = q, x = {
   ...
   */
  getData() {
    const e = this.getMindmap(), i = yt(), g2 = lz().layout !== void 0, l = i;
...
` + t);
  ...
  l.type = c.type, l.layoutAlgorithm = Rz(l.config.layout, {
