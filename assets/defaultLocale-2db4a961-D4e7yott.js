...
function K(n, t) {
	return function(e, i) {
		for (var o = e.length, f = [], c = 0, u = n[0], p = 0; o > 0 && u > 0 && (p + u + 1 > i && (u = Math.max(1, i - p)), f.push(e.substring(o -= u, o + u)), !((p += u + 1) > i));) u = n[c = (c + 1) % n.length];
...
function W(n) {
	n: for (var t = n.length, e = 1, i = -1, o; e < t; ++e) switch (n[e]) {
		case ".":
			i = o = e;
			break;
		case "0":
		...
		function C(r) {
			...
			if (d === "c") h = T(r) + h, r = "";
				...
				if (r = isNaN(r) ? p : T(Math.abs(r), g), L && (r = W(r)), P && +r == 0 && m !== "+" && (P = !1), y = (P ? m === "(" ? m : u : m === "-" || m === "(" ? "" : m) + y, h = (d === "s" ? R[8 + U / 3] : "") + h + (P && m === "(" ? ")" : ""), B) {
					for (b = -1, D = r.length; ++b < D;) if (k = r.charCodeAt(b), 48 > k || k > 57) {
			...
			switch (E && l && (r = t(s + r, s.length ? S - h.length : Infinity), s = ""), M) {
				case "<":
					r = y + r + h + s;
					break;
				case "=":
...
export { tn as i, N as n, nn as r, J as t };
