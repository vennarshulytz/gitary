import{ft as e}from"./app-XwEThvRn.js";const t=new class{async generateDiagram(t){let n=`请根据以下描述生成 Excalidraw 图表元素：${t}

请直接返回 JSON 数组，不要包含任何其他文字。`;try{let t=(await e.chat({model:`dashscope/qwen3-max`,messages:[{role:`system`,content:`你是一个专业的图表生成助手。根据用户的描述，生成 Excalidraw 格式的图表元素。
