import { $ as Qn, kt as bm, un as m } from "./app-DQCpdmdF.js";
var o = /* @__PURE__ */ m((a, t) => {
...
}, "drawBackgroundRect"), g = /* @__PURE__ */ m((a, t) => {
...
}, "drawText"), m$1 = /* @__PURE__ */ m((a, t, e, r) => {
	const s = a.append("image");
	s.attr("x", t), s.attr("y", e);
	const i = bm(r);
	s.attr("xlink:href", i);
}, "drawImage"), h = /* @__PURE__ */ m((a, t, e, r) => {
	const s = a.append("use");
	s.attr("x", t), s.attr("y", e);
	const i = bm(r);
	s.attr("xlink:href", `#${i}`);
}, "drawEmbeddedImage"), y = /* @__PURE__ */ m(() => ({
	x: 0,
	y: 0,
	width: 100,
	height: 100,
...
export { o as a, m$1 as i, g as n, p as o, h as r, y as s, d as t };
