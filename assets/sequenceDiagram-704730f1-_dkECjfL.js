...
import { B as utils, C as hasKatex, E as log$1, F as setAccTitle, L as setDiagramTitle, M as sanitizeText$2, O as parseFontSize, P as setAccDescription, Pt as require_purify, Xt as require_dayjs_min, _ as getAccTitle, b as getDiagramTitle, c as common$1, g as getAccDescription, j as renderKatex, n as assignWithDepth$1, r as calculateMathMLDimensions, s as clear, t as ZERO_WIDTH_SPACE, u as configureSvgSize, v as getConfig, y as getConfig$1 } from "./mermaid-b5860b54-_wCtya72.js";
import { i as drawRect, n as drawEmbeddedImage, o as getNoteRect, r as drawImage, s as getTextObj, t as drawBackgroundRect } from "./svgDrawCommon-08f97a94-MLm5sKYd.js";
...
var drawKatex = async function(elem, textData, msgModel = null) {
	...
	const dim = textElem.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(lines).node().getBoundingClientRect();
...
var drawActorTypeParticipant = async function(elem, actor, conf2, isFooter) {
	...
	const rectElem = drawRect$1(g, rect);
	actor.rectData = rect;
...
function adjustCreatedDestroyedData(msg, msgModel, lineStartY, index, actors, createdActors, destroyedActors) {
	...
	if (createdActors[msg.to] == index) {
		...
		receiverAdjustment(actor, actor.type == "actor" ? ACTOR_TYPE_WIDTH / 2 + 3 : actor.width / 2 + 3);
		...
		const actor = actors[msg.to];
		if (conf.mirrorActors) receiverAdjustment(actor, actor.type == "actor" ? ACTOR_TYPE_WIDTH / 2 + 3 : actor.width / 2 + 3);
		actor.stopy = lineStartY - actor.height / 2;
		bounds.bumpVerticalPos(actor.height / 2);
	}
}
