import { g } from "./chunk-55IACEB6-b2733bca-cd33c0db.js";
import { d } from "./chunk-QN33PNHL-d51d5666-4db5cb76.js";
import { H as m, a8 as x5, a7 as b5, a9 as k5, aa as y5, ak as w5, al as _5, O as yt$1, K as R, bh as kM, ad as zi, ar as m5, au as Dz, aq as $e$1 } from "./app-a3875679.js";
var vt = function() {
      ...
      case Ct:
        {
          ...
          const T = {
            ...
            style: Bt,
            labelStyle: "",
            label: zi.sanitizeText(p.description ?? "", yt$1()),
            arrowheadStyle: Vt,
            labelpos: Mt,
            labelType: Ut,
            thickness: jt,
...
var st = /* @__PURE__ */ m((e, t, s, a, i, l, d2, S) => {
  ...
  addState(t, s = it, a = void 0, i = void 0, l = void 0, d2 = void 0, S = void 0, p = void 0) {
    ...
    if (i && (R.info("Setting state description", T, i), (Array.isArray(i) ? i : [i]).forEach((m2) => this.addDescription(T, m2.trim()))), l) {
      ...
      if (!_)
        throw new Error(`State not found: ${T}`);
      _.note = l, _.note.text = zi.sanitizeText(_.note.text, yt$1());
    }
  ...
  addRelationObjs(t, s, a = "") {
    ...
    this.addState(
      ...
      id1: i,
      id2: d2,
      relationTitle: zi.sanitizeText(a, yt$1())
    });
  }
  /**
  ...
  addRelation(t, s, a) {
    if (typeof t == "object" && typeof s == "object")
      ...
      this.addState(i, l), this.addState(d2, S), this.currentDocument.relations.push({
        id1: i,
        id2: d2,
        relationTitle: a ? zi.sanitizeText(a, yt$1()) : void 0
      });
    }
  }
  addDescription(t, s) {
    ...
    (l = a == null ? void 0 : a.descriptions) == null || l.push(zi.sanitizeText(i, yt$1()));
  }
  cleanupLabel(t) {
