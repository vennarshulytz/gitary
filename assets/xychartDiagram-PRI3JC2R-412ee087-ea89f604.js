import { H as m, aQ as P6, az as Xt, ay as lu, ax as Mf, aR as zL, K as R, aS as V8, ag as _e, al as _5, a7 as b5, a8 as x5, ak as w5, a9 as k5, aa as y5, ar as m5, aK as iT, ah as If } from "./app-32980687.js";
import { t } from "./init-f9637058-7f0fc388.js";
import { h } from "./ordinal-980380c7-3546a010.js";
import { c as cn } from "./linear-955cbded-15363596.js";
...
var J, Ht = (J = class {
  ...
  getMaxDimension(t2, i) {
    ...
    for (const r of t2) {
      const g = zL(n, 1, r), m2 = g ? g.width : r.length * i, f = g ? g.height : i;
...
` + e);
  ...
  If(C, g.height, g.width, true), C.attr("viewBox", `0 0 ${g.width} ${g.height}`), E.attr("fill", r.backgroundColor), n.setTmpSVGG(C.append("g").attr("class", "mermaid-tmp-group"));
