import { m as m$2 } from "./chunk-4BX2VUAB-df729ba8-78566bc4.js";
import { e } from "./chunk-QZHKN3VN-69ca95fd-84ea3276.js";
import { ax as Mf, H as m$1, O as yt, ay as lu, az as Xt, aA as wM, K as R$1, a7 as b5, a8 as x5, a9 as k5, aa as y5, ak as w5, al as _5, ad as zi, ar as m5, a6 as gt, aq as $e, aB as v5 } from "./app-54f05dd6.js";
...
var yr = /* @__PURE__ */ m$1(function(t) {
  ...
  const n = z();
  a = zi.sanitizeText(a, n), r = zi.sanitizeText(r, n), e2 = e2 == null ? void 0 : e2.map((o) => zi.sanitizeText(o, n));
  const c = {
  ...
  let r = t.name;
  const a = t.order;
  if (r = zi.sanitizeText(r, z()), i.records.branches.has(r))
    throw new Error(
  ...
  const n = z();
  if (r = zi.sanitizeText(r, n), a = zi.sanitizeText(a, n), s = s == null ? void 0 : s.map(($) => zi.sanitizeText($, n)), e2 = zi.sanitizeText(e2, n), !r || !i.records.commits.has(r)) {
    const $ = new Error(
